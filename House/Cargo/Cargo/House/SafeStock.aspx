        ...
        $(document).ready(function () {
            $('#dg').datagrid({
                ...
                columns: [[
                    ...
                    {
                        title: '规格', field: 'Specs', width: '100px'
                    },
                    {
    ...
    <div id="saPanel" name="SelectDiv1" class="easyui-panel" title="" data-options="iconCls:'icon-search'" style="width: 100%">
        <table id="saPanelTab">
            ...
            <tr>
                ...
                <td>
                    <input id="AreaID" class="easyui-combobox" style="width: 100px;" data-options="multiple:true,valueField:'AreaID',textField:'Name',editable:false" />
                </td>
...
<td style="text-align: right;">产品名称:
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="MinStockDay" id="MinStockDay_ipt" class="easyui-numberbox" style="width: 250px;" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right;">最大库存数:
                        </td>
                        <td>
                    ...
                    <tr>
                        <td style="text-align: right;">月均销量:
                        </td>
                        <td>
    ...
    <script type="text/javascript">
        ...
        function maxStockDayChange(){
            ...
            // 计算最小库存和最大库存
            var maxStock = Math.round(avgSaleNum / 30 * maxDay);
            // 更新到表单
        ...
        function minStockDayChange(){
            ...
            // 计算最小库存和最大库存
            var minStock = Math.round(avgSaleNum / 30 * minDay);
