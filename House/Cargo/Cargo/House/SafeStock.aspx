...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="toolbar">
        ...
        <a href="#" class="easyui-linkbutton" iconcls="icon-cut" plain="false" onclick="DelItem()">&nbsp;删&nbsp;除&nbsp;</a>&nbsp;&nbsp;
         ...
         <a href="#" class="easyui-linkbutton" iconcls="icon-application_get" plain="false" onclick="AwbImport()">&nbsp;导&nbsp;入&nbsp;</a>&nbsp;&nbsp;
    </div>
    ...
    <div id="dlgImport" class="easyui-dialog" style="width: 1000px; height: 530px; padding: 2px 2px" closed="true" buttons="#dlgImport-buttons">
        ...
        <div id="dginporttoolbar">
           ...
           <a href="../upload/sFile/云仓安全库存模板250722.xls" id="dowload" class="easyui-linkbutton" iconcls="icon-application_put" plain="false">&nbsp;下载模板&nbsp;</a>&nbsp;&nbsp;
    ...
    <script type="text/javascript">
        ...
        function showData() {
            ...
            columns.push({ title: '载重', field: 'LoadIndex', width: '65px' });
            columns.push({ title: '速度', field: 'SpeedLevel', width: '65px' });
            columns.push({ title: '最小库存', field: 'MinStock', width: '85px' });
            columns.push({ title: '最大库存', field: 'MaxStock', width: '85px' });
            columns.push({ title: '安全库存', field: 'StockNum', width: '85px' });
