...
{
    public partial class InhouseManager : BasePage
    {
        /// <summary>
        /// 库存数据导出实体
        /// </summary>
        ...
        {
            IsModifyInNum = UserInfor.IsModifyInNum;
        }
        /// <summary>
        /// 导出
        /// </summary>
        ...
        protected void btnDerived_Click(object sender, EventArgs e)
        {
            ...
            foreach (var it in StatisData)
            {
                ...
                newRows["序号"] = i;
                newRows["分类名称"] = it.TypeName.Trim();
                newRows["规格"] = it.Specs.Trim();
                newRows["型号"] = it.Model.Trim();
                newRows["花纹"] = it.Figure;
                newRows["货位数"] = it.ContainerNum;
                newRows["库存数"] = it.InPiece;
                table.Rows.Add(newRows);
            }
            ToExcel.DataTableToExcel(table, "", "库存产品所占货位数统计表");
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void btnStockDerived_Click(object sender, EventArgs e)
        {
            ...
            if (!RoleName.Contains("汕头科矿"))
            {
                ...
                table.Columns.Add("供应商公司", typeof(string));
            ...
            foreach (var it in StockData)
            {
                ...
                if (!RoleName.Contains("汕头科矿"))
                {
                    ...
                    newRows["供应商公司"] = it.UpClientShortName;
