<%@ Page Title="盘点管理" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StockTakeManager.aspx.cs" Inherits="Cargo.House.StockTakeManager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="saPanel" name="SelectDiv1" class="easyui-panel" title="" data-options="iconCls:'icon-search'" style="width: 100%">
        <table>
            <tr>
                ...
                <td style="width: 10%">
                    <input id="ACreateName" class="easyui-textbox" data-options="prompt:'请输入创建人'" style="width: 100%">
                </td>
    ...
    <div id="toolbar">
        ...
        &nbsp;&nbsp;
        <a href="#" class="easyui-linkbutton" iconcls="icon-application_put" plain="false" onclick="">&nbsp;生成今日动态盘点单&nbsp;</a>
        <a href="#" class="easyui-linkbutton" iconcls="icon-application_put" plain="false" onclick="">&nbsp;上传盘点单据&nbsp;</a>  
        <form runat="server" id="fm1">
            <asp:Button ID="btnDerived" runat="server" Style="display: none;" Text="导出" OnClick="btnDerived_Click" />
        </form>
    </div>
    <div id="dlg" class="easyui-dialog" style="width: 500px; height: 300px; padding: 0px"
        ...
        <form id="fm" class="easyui-form" method="post">
            <table>
                <tr>
                    ...
                    <td>
                        <input id="HouseID" name="HouseID" class="easyui-combobox" style="width: 200px;" data-options="required:true" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: right;">盘点仓库:
                    ...
                    <td>
                        <input id="HeadHouseID" name="HeadHouseID" class="easyui-combobox" style="width: 200px;" data-options="valueField:'AreaID',textField:'Name'" panelheight="auto" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input id="AreaID" name="AreaID" class="easyui-combobox" style="width: 200px;" data-options="valueField:'AreaID',textField:'Name'"
                            panelheight="auto" />
                    </td>
                </tr>
                <tr>
    ...
    <div id="productTag" class="easyui-dialog" style="width: 800px; height: 540px; padding: 0px"
    ...
    <div id="divStockTag" class="easyui-dialog" style="width: 950px; height: 540px; padding: 0px"
        closed="true" buttons="#divStockTag-buttons">
        <table id="dgStockTag" class="easyui-datagrid">
        </table>
        <div id="divStockTag-buttons">
            <a href="#" class="easyui-linkbutton" iconcls="icon-cancel" onclick="javascript:$('#divStockTag').dialog('close')">&nbsp;关&nbsp;闭&nbsp;</a>
        </div>
    </div>
