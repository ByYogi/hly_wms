...
{
    public partial class StockSnap : BasePage
    {
        /// <summary>
        /// 库存数据导出实体
        /// </summary>
        ...
        protected void btnDerived_Click(object sender, EventArgs e)
        {
            ...
            if (StockDataType == "47")
            {
                ...
                table.Columns.Add("快照时间", typeof(string));
                int i = 0;
                ...
                foreach (var it in StockData)
                {
                    ...
                    newRows["快照时间"] = it.OP_DATE.ToString("yyyy-MM-dd") == "0001-01-01" || it.OP_DATE.ToString("yyyy-MM-dd") == "1900-01-01" ? "" : it.OP_DATE.ToString("yyyy-MM-dd HH:mm:ss");
                    table.Rows.Add(newRows);
                    house = it.HouseName;
                }
                ToExcel.DataTableToExcel(table, "", house + "库存快照表");
            }
            else
            {
