<%@ Page Title="库存查询" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="OuthouseManager.aspx.cs" Inherits="Cargo.House.OuthouseManager" %>

    <asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
        <script src="../JS/easy/js/datagrid-scrollview.js" type="text/javascript"></script>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <table>
                <tr>
                    ...
                    <td class="AProductName">
                        <input id="AProductName" class="easyui-textbox" data-options="prompt:'请输入产品名称'"
                            style="width: 80px">
                    </td>
                    <td id="AGoodsCodeTd" style="text-align: right;">货品代码:
                    </td>
                    <td>
                        <input id="AGoodsCode" class="easyui-textbox" data-options="prompt:'请输入货品代码'"
                            style="width: 100px">
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input id="ASID" class="easyui-combobox" style="width: 100px;"
                            data-options="valueField:'TypeID',textField:'TypeName',editable:true" />
                    </td>
                    ...
                    <td>
                        <input id="SettleClient" class="easyui-combobox" style="width: 100px;"
                            data-options="valueField:'AreaID',textField:'Name'" panelheight="auto" />
                    </td>
                </tr>
                <tr>
                    ...
                    <%--<td class="ASalePrice" style="text-align: right;">销售价格:</td>
                        ...
                        <td class="ASpecsType">
                            <select class="easyui-combobox" id="SpecsType" name="SpecsType" style="width: 80px;"
                        ...
                        <td class="ABelongDepartTd">
                            <input id="ABelongDepart" class="easyui-combobox" style="width: 100px;"
                                data-options="valueField:'ID',textField:'DepName',editable:false" />
                            <%--<select class="easyui-combobox" id="ABelongDepart" style="width: 100px;"
                                panelheight="auto" editable="false">
                                <option value="-1">全部</option>
                        ...
                        <td class="AHSID">
                            <input id="HSID" class="easyui-combobox" style="width: 100px;"
                                data-options="valueField:'AreaID',textField:'Name'" panelheight="auto" />
                        </td>
                </tr>
            </table>
        ...
        <%-- <table id="outDg" class="easyui-datagrid">
            ...
            <div id="toolbar">
                ...
                <a href="#" class="easyui-linkbutton" iconcls="icon-clock_red" plain="false" onclick="queryWarn()"
                    id="queryWarn">&nbsp;查询预警库存&nbsp;</a>&nbsp;&nbsp;
                <%--<a href="#" class="easyui-linkbutton" iconcls="icon-out_cargo" plain="false"
                    onclick="plOutCargo()">&nbsp;出&nbsp;库&nbsp;</a>&nbsp;&nbsp;
                    ...
                    <a href="#" class="easyui-linkbutton" iconcls="icon-edit" plain="false"
                        onclick="saveOutCargo()">&nbsp;保&nbsp;存&nbsp;</a>&nbsp;&nbsp;
                    <a href="#" class="easyui-linkbutton" iconcls="icon-print" plain="false"
                        onclick="printOutCargoAwb()">&nbsp;打印出库单&nbsp;</a>&nbsp;&nbsp;--%>
                    <a href="#" class="easyui-linkbutton" iconcls="icon-application_put" plain="false"
                        onclick="AwbExport()">&nbsp;导&nbsp;出&nbsp;</a>&nbsp;&nbsp;
                    <a href="#" class="easyui-linkbutton" iconcls="icon-tag_blue" plain="false" onclick="queryTag()"
                        id="queryTag">&nbsp;查看标签&nbsp;</a>&nbsp;&nbsp;<a href="#" class="easyui-linkbutton"
                        iconcls="icon-lock_add" plain="false" onclick="lockStock()"
                        id="IsLockStock">&nbsp;锁定库存&nbsp;</a>
            ...
            <div id="dlg" class="easyui-dialog" style="width: 350px; height: 150px; padding: 5px 5px" closed="true"
                buttons="#dlg-buttons">
                <form id="fm" class="easyui-form" method="post">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <input name="Numbers" id="Numbers" class="easyui-numberbox"
                                    data-options="min:0,precision:0" style="width: 200px;">
                            </td>
                        </tr>
                    </table>
                </form>
            ...
            <!--Begin 查询产品标签列表-->
            <div id="productTag" class="easyui-dialog" style="width: 1200px; height: 520px; padding: 0px" closed="true"
