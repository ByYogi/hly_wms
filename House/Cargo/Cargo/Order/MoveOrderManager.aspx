<%@ Page Title="移库订单管理" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MoveOrderManager.aspx.cs" Inherits="Cargo.Order.MoveOrderManager" %>
        ...
        $(document).ready(function () {
            $('#dg').datagrid({
                ...
                columns: [[
                    ...
                    {
                        title: '移库单号', field: 'MoveNo', width: '80px', formatter: function (value) {
