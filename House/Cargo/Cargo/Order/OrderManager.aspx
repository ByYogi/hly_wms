        ...
        $(document).ready(function () {
            ...
            $('#dg').datagrid({
                ...
                onClickRow: function (index, row) {
                    ...
                    if (RoleCName.indexOf("安泰路斯") < 0) {
                        $('#postpone').show();
                        //if (row.PostponeShip == 1 || row.TrafficType == "2" || row.HouseID == 120) {
                        //    if (row.ThrowGood == 21 && row.CheckStatus != 1) {
                        //        $('#postpone').hide();
                        //    } else {
                        //        $('#postpone').show();
                        //    }
            ...
            <div id="saPanel">
                <table style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="CreateAwb" id="CreateAwb" class="easyui-textbox" readonly="readonly" style="width: 70px;" />
                        </td>
                        <td style="text-align: right;">开单时间:
                        </td>
                        <td colspan="1">
                            <input name="CreateDate" id="CreateDate" class="easyui-datetimebox" data-options="formatter:AllDateTime" readonly="readonly" style="width: 125px;" />
                        </td>
                        <td class="SaleManID" style="text-align: right;">业务人员:
                        </td>
                        <td class="SaleManID">
                            <input name="SaleManID" id="SaleManID" class="easyui-combobox" style="width: 80px;" data-options="url: 'orderApi.aspx?method=QueryUserByDepCode',valueField: 'LoginName',textField: 'UserName', onSelect: onSaleManIDChanged," />
                        </td>
            ...
            //LODOP.PRINT_INITA(0, 0, 800, 320, "广通公司");
                ...
                //var saleName = $('#SaleManName').val();
                        ...
                        switch (parseInt(hous)) {
                            case 1: sendUnit = '湖南狄乐汽服'; sendPhone = '13319570206'; break;
                            case 3: sendUnit = '湖北迪乐泰'; sendPhone = '17771479223;83092268'; break;
                            ...
                            case 100: sendUnit = '湖南狄乐汽服公司'; sendPhone = '13319578676'; break;
                        }
