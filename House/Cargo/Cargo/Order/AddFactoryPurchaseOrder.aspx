<%@ Page Title="新增工厂进货单" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddFactoryPurchaseOrder.aspx.cs" Inherits="Cargo.Order.AddFactoryPurchaseOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="saPanel" name="SelectDiv1" class="easyui-panel" title="" data-options="iconCls:'icon-search'" style="width: 100%">
        <table>
            <tr>
                ...
                <td>
                    <input id="ASID" class="easyui-combobox" style="width: 95px;" data-options="valueField:'TypeID',textField:'TypeName',required:true" />
                </td>
   ...
   <%--                 <td style="text-align: right;">进货单号：</td>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <textarea name="Remark" id="ARemark" placeholder="请输入订单备注" style="width: 95%; resize: none"></textarea>
                    </td>
                </tr>
            </table>
        </div>
        ...
        function saveOutCargo() {
            ...
            $.messager.confirm('<%= Cargo.Common.GetSystemNameAndVersion()%>', '确定保存？', function (r) {
                if (r) {
                    ...
                    $('#fmDep').form('submit', {
                        url: 'orderApi.aspx?method=AddFactoryPurchaseOrderInfo',
