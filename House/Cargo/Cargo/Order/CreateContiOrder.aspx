...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            columns.push({
                title: '订单区域', field: 'warehouseProvince', width: '120px',
                formatter: function (val, row, index) {
                    // //7715822 广州 7720988 湖北
                    if (val == "广东省") { return "广州马牌"; }
                    else if (val == "湖北省") { return "湖北马牌"; }
                    else { return ""; }
                } });
        ...
        function dosearch() {
            ...
            $('#dg').datagrid('load', {
                ...
                OrderHouse: $("#OrderHouse").combobox('getValue'),//线路ID
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="saPanel" name="SelectDiv1" class="easyui-panel" title="" data-options="iconCls:'icon-search'"
        ...
        <table>
            <tr>
                <td style="text-align: right;">订单区域:
                </td>
                <td>
                    <%--     <input id="AHouseID" class="easyui-combobox" style="width: 100px;" />   //7715822 广州 7720988 湖北--%>
                    <select class="easyui-combobox" id="OrderHouse" style="width: 80px;" panelheight="auto">
                        <option value="-1">全部</option>
                        <option value="广东省">广州马牌</option>
                        <option value="湖北省">湖北马牌</option>
                    </select>
                </td>
        ...
        <div id="saPanel">
            <form id="fm" class="easyui-form" method="post">
                ...
                <table>
                    ...
                    <tr>
                        <td style="text-align: right;">周期年:
                        </td>
                        <td>
                            <input name="BatchYear" id="BatchYear" class="easyui-combobox" style="width: 250px;" />
                        </td>
                    </tr>
                    <tr>
    ...
    <script type="text/javascript">
        ...
        function getRecentYears(n = 3) {
            ...
            return Array.from({ length: n }, (_, i) => ({ value: currentYear - i, text: currentYear - i }));
        }
        //生成仓库订单
        function addItem() {
            isLoad = true;
            ...
            //console.log(row.ClientNum,row)
            $('#ClientNum').combobox('setValue', row[0].ClientNum);
            //$('#ClientNum').combobox('setValue', row[0].consigneeName);
            var strArr = [
                {
                    title: '杭州小拇指',
                    name: '574522',
                ...
                },
                {
                    title: '北京千哩',
                    name: '615437',
                    remark: '麻烦打包，带PDF，带北京千哩白色标签(手写上DOT),安排发急送',
                    orderLabel: null
                },
            ...
            var yearArr = getRecentYears();
            //$("#BatchYear").combobox('loadData', yearArr)
            $('#BatchYear').combobox({
                data: yearArr,
                valueField: 'value',
                textField: 'text',
