    ...
    border-width: 0 1px 1px 0;
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                columns.push({
                    title: '补货时间', field: 'RplDate', width: '120px', formatter: DateTimeFormatter,
                });
                columns.push({
                ...
                },
                {
                    ...
                    onLoadSuccess: function(){
                        ...
                        // 让第一个输入框聚焦
                        var ed = $(this).datagrid('getEditor', {index:0,field:'productname'});
                        if (ed) $(ed.target).focus();
                    }
                ...
                columns =[
                    ...
                    {
                        title: '缺货数量', field: 'Piece', width: '75px'
                    },
                    {
