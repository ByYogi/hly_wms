<%@ Page Title="按报销单付款" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="financeByExpensePay.aspx.cs" Inherits="Cargo.Finance.financeByExpensePay" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        if (rl == "粤信广通客服角色") {
            window.location.href = "../Finance/financeByPurchasePay.aspx";
        }
            ...
            $('#dg').datagrid({
                ...
                columns: [[
                    ...
                    },
                    {
                        ...
                        formatter: function (val, row, index) { if (val == "0") { return "<span title='现金'>现金</span>"; } else if (val == "1") { return "<span title='银行卡'>银行卡</span>"; } else if (val == "2") { return "<span title='油卡'>油卡</span>"; } else { return ""; } }
                    },
                    {
        ...
        function dosearch() {
            ...
            $('#dg').datagrid('load', {
                ...
                //ClientName: $("#ClientID").combobox('getText'),
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div name="SelectDiv3" style="background: linear-gradient(to bottom, #eff5ff 0px, #e0ecff 100%) repeat-x scroll 0 0; border-color: #95b8e7; border-style: solid; border-width: 1px 1px 0px 1px;">
        <table>
            <tr>
                <td>
                    <a class="easyui-linkbutton" iconcls="icon-coins_delete" plain="false" style="color: Red;" href="../Finance/financeByExpensePay.aspx" target="_self">&nbsp;按报销单付款&nbsp;</a>
    ...
    <div id="saPanel" name="SelectDiv1" class="easyui-panel" title="" data-options="iconCls:'icon-search'" style="width: 100%">
        <table>
            <tr>
                ...
                <td>
                    <input id="ExID" class="easyui-textbox" data-options="prompt:'请输入报销单号，多个用逗号,隔开'" style="width: 250px">
                </td>

                <td style="text-align: right;">报销人:
                </td>
                <td>
                    <input id="ExName" class="easyui-textbox" data-options="prompt:'报销人'" style="width: 80px;" />
                </td>

                <td style="text-align: right;">客户名称:
                </td>
                <td>
                    <input id="ClientID" class="easyui-combobox" style="width: 80px;" />
                </td>
