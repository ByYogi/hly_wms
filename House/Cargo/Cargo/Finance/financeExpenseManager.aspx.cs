...
{
    public partial class financeExpenseManager : BasePage
    {
        /// <summary>
        /// 导出实体
        /// </summary>
        ...
        protected void btnDerived_Click(object sender, EventArgs e)
        {
            ...
            table.Columns.Add("申请仓库", typeof(string));
            table.Columns.Add("报销部门", typeof(string));
            ...
            table.Columns.Add("报销备注", typeof(string));
            ...
            foreach (var it in Financelist)
            {
                ...
                newRows["申请仓库"] = it.HouseName;
                newRows["报销部门"] = it.ExDepart;
                newRows["报销人"] = it.ExName;
                newRows["受款人"] = it.ReceiveName;
