...
{
    public partial class financeExpensePayMonitor : BasePage
    {
        ...
        protected void btnDerived_Click(object sender, EventArgs e)
        {
            ...
            table.Columns.Add("应付", typeof(decimal));
            table.Columns.Add("已付", typeof(decimal));
            table.Columns.Add("未付", typeof(decimal));
            ...
            foreach (var it in expenseReceiveMonitor)
            {
                ...
                newRows["应付"] = it.ExCharge;
                newRows["已付"] = it.ReceivedMoney;
                newRows["未付"] = it.UncollectMoney;
            ...
            ToExcel.DataTableToExcel(table, "", "按报销单付款监督数据表");
        }
