<%@ Page Title="按账单收款" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="financeByAccountNoReceive.aspx.cs" Inherits="Cargo.Finance.financeByAccountNoReceive" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#dg').datagrid({
                ...
                columns: [[
                  ...
                  { title: '账单金额', field: 'Total', width: '70px', align: 'right' },
                  {
                   ...
                   {
                       title: '返利余额', field: 'RebateMoney', width: '70px', align: 'right', formatter: function (value) {
                           if (value != null && value != "") {
        ...
        function checkRow() {
            ...
            for (var i = 0, l = rows.length; i < l; i++) {
                ...
                if (Number(row.Total - row.ReceivedMoney) > 0) {
                    sum += Number(row.Total - row.ReceivedMoney);
                }
        ...
        function dosearch() {
            ...
            gridOpts.url = '../Finance/financeApi.aspx?method=QueryAccountForCash';
            $('#dg').datagrid('load', {
                AccountID: $('#AAccountID').val(),
                StartDate: $('#StartDate').datebox('getValue'),
                EndDate: $('#EndDate').datebox('getValue'),
                ClientID: $("#PayClientNum").combobox('getValue'),
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div name="SelectDiv3" style="background: linear-gradient(to bottom, #eff5ff 0px, #e0ecff 100%) repeat-x scroll 0 0; border-color: #95b8e7; border-style: solid; border-width: 1px 1px 0px 1px;">
        <table>
            <tr>
                <td>
                    <a class="easyui-linkbutton" iconcls="icon-coins_add" plain="false" href="../Finance/financeByOrderReceive.aspx" target="_self">&nbsp;按订单收款&nbsp;</a>&nbsp;&nbsp;
                    ...
                    <a class="easyui-linkbutton" iconcls="icon-coins_add" plain="false" style="color: Red;" href="../Finance/financeByAccountNoReceive.aspx" target="_self">&nbsp;按账单收款&nbsp;</a>&nbsp;&nbsp;
    ...
    <div id="saPanel" name="SelectDiv1" class="easyui-panel" title="" data-options="iconCls:'icon-search'" style="width: 100%">
        <table>
            <tr>
                ...
                <td>
                    <input id="AAccountID" class="easyui-textbox" data-options="prompt:'请输入账单号，多个用逗号,隔开'" style="width: 350px">
                </td>
                ...
                <td>
                    <input id="PayClientNum" style="width: 90px;" class="easyui-combobox" />
                </td>
