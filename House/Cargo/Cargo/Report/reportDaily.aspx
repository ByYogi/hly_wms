...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function adjustment() {
            var height = Number($(window).height()) - $("div[name='SelectDiv1']").outerHeight(true) - $("div[name='SelectDiv2']").outerHeight(true) + 30;
        ...
        $(document).ready(function () {
            ...
            if (HID == "47") {
                ...
                if (HID == "64") {
                    ...
                    columns.push({
                        title: '采购供应商', field: 'PurchaseSupplier', width: '100px', formatter: function (value) {
                            if (value != null && value != "") {
                                return "<span title='" + value + "'>" + value + "</span>";
                            }
                        }
                    ...
                    columns.push({
                        title: '云仓供应商', field: 'Supplier', width: '100px', formatter: function (value) {
                            if (value != null && value != "") {
                                return "<span title='" + value + "'>" + value + "</span>";
                            }
                        }
            ...
            if ($('#AHouseID').combobox('getValue') != $('#HiddenHouseID').val()) {
                ...
                if ($('#AHouseID').combobox('getValue') == "47") {
                    ...
                    if ($('#AHouseID').combobox('getValue') == 64 || RoleCName.indexOf("汕头科矿") >= 0) {
                        ...
                        columns.push({
                            title: '采购供应商', field: 'PurchaseSupplier', width: '8%', formatter: function (value) {
                                return "<span title='" + value + "'>" + value + "</span>";
                            }
                        });
                        columns.push({
                            title: '云仓供应商', field: 'Supplier', width: '8%', formatter: function (value) {
                                return "<span title='" + value + "'>" + value + "</span>";
                            }
                        });
                        columns.push({
        ...
        <table>
            <tr>
                <td>
                    ...
                    <a class="easyui-linkbutton" iconcls="icon-chart_bar" plain="false" href="../Report/outboundLabelReport.aspx" id="outboundLabelReport" target="_self">&nbsp;出库标签报表&nbsp;</a>
                </td>
            </tr>
        </table>
    </div>
        ...
        <table>
            <tr>
                ...
                <td class="BelongDepart">
                    <input id="BelongDepart" class="easyui-combobox" style="width: 120px;" data-options="valueField:'ID',textField:'DepName',editable:false" />
                ...
                <td class="ASpecsType">
                    <select class="easyui-combobox" id="SpecsType" name="SpecsType" style="width: 80px;" panelheight="auto" editable="false">
                        ...
                        <option value="4">极速达</option>
                        <option value="5">次日达</option>
                    </select>
                </td>
            </tr>
            <tr>
