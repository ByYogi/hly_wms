...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function click_request_aspx() {
            logRequest("3s async aspx", "Api/ClientApi.aspx?method=getasync");
        }
        function click_request2_aspx() {
            logRequest("3s sync aspx", "Api/ClientApi.aspx?method=getsync");
        }
        function click_request10_aspx() {
            logRequest("req test aspx", "Api/ClientApi.aspx?method=gettest");
        }
    </script>
</head>
<body>
