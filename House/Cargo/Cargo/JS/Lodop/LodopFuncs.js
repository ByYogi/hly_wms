...
if (needCLodop()) {
    var src1 = "../CLodopfuncs.js?priority=1";
    var src2 = "../CLodopfuncs.js?priority=0";
...
function getLodop(oOBJECT, oEMBED) {
    ...
    try {
        ...
        LODOP.SET_LICENSES("", "780101871115550100112112561289", "688858710010010811411756128900", "947425255495357625563605612890");
        //=======================================================
        return LODOP;
    } catch (err) {
