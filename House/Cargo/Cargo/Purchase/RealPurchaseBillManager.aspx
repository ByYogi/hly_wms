<%@ Page Title="采购账单管理" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RealPurchaseBillManager.aspx.cs" Inherits="Cargo.Client.RealPurchaseBillManager" %>
        ...
        $(document).ready(function () {
            $('#dg').datagrid({
                ...
                columns: [[
                    ...
                    {
                        title: '供应商名称', field: 'PurchaserName', width: '100px', formatter: function (value) {
                            if (value != null && value != "") {
                                return "<span title='" + value + "'>" + value + "</span>";
                            }
                        }
            ...
            $('#APurchaserName').combobox({ url: '../Client/clientApi.aspx?method=AutoCompletePurchaser', valueField: 'PurchaserID', textField: 'PurchaserName' });
            $('#APurchaserName').combobox('textbox').bind('focus', function () { $('#APurchaserName').combobox('showPanel'); });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="saPanel" name="SelectDiv1" class="easyui-panel" title="" data-options="iconCls:'icon-search'" style="width: 100%">
        <table>
            <tr>
                ...
                <td>
                    <input id="APurchaserName" style="width: 200px;" data-options="valueField: 'PurchaserID', textField: 'PurchaserName'" class="easyui-combobox" />
                </td>
    ...
    <div id="dlg" class="easyui-dialog" style="width: 1000px; height: 600px; padding: 0px"
        ...
        <div id="saPanel">
            <table>
                <tr>
                    ...
                    <td>
                        <input id="APurOrderNo" class="easyui-textbox" data-options="prompt:'请输入订单号'" style="width: 120px">
                    </td>
                    <td style="text-align: right;">供应商名称:
                    </td>
                    <td>
                        <input id="PurchaserName" style="width: 200px;" data-options="valueField: 'PurchaserID', textField: 'PurchaserName'" class="easyui-combobox" />
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                        <a href="#" class="easyui-linkbutton" iconcls="icon-search" plain="false" onclick="QueryPurchaseAccount()">&nbsp;查&nbsp;询&nbsp;</a>&nbsp;&nbsp;
                    </td>
        ...
        <div id="saPanel5">
            <form id="fm" class="easyui-form" method="post">
                ...
                <input type="hidden" name="PurchaserID" id="APurchaserID" />
    ...
    <div id="dlg-buttons">
        <a href="#" class="easyui-linkbutton" iconcls="icon-ok" onclick="savePurchaseAccount()">&nbsp;&nbsp;保&nbsp;存&nbsp;&nbsp;</a>
    ...
    <script type="text/javascript">
        ...
        function savePurchaseAccount() {
            ...
            $.ajax({
                async: false,
                url: "purchaseApi.aspx?method=savePurchaseBillAccount&" + formjson,
        ...
        function addItem() {
            ...
            $('#PurchaserName').combobox('reload', '../Client/clientApi.aspx?method=AutoCompletePurchaser');
        }
        //修改账单信息
        ...
        function showGridAdd() {
            $('#dgSave').datagrid({
                ...
                url: null,
                columns: [[
                    { title: '采购订单ID', field: 'PurOrderID', checkbox: true, width: '30px' },
                    {
                    ...
                    {
                        title: '采购订单号', field: 'PurOrderNo', width: '90px', formatter: function (value) {
                            if (value != null && value != "") {
                                return "<span title='" + value + "'>" + value + "</span>";
                            }
                        }
                    ...
                    {
                        title: '采购单类型', field: 'PurchaseType', width: '60px', formatter: function (val, row, index) {
                            if (val == "0") { return "<span title='工厂采购单'>工厂采购单</span>"; }
                            else if (val == "1") { return "<span title='工厂采购单'>工厂采购单</span>"; }
                            else { return ""; }
                        }
                    },
                    {
                        title: '入库类型', field: 'PurchaseInStoreType', width: '60px', formatter: function (val, row, index) {
                    ...
                    {
                        title: '采购数量', field: 'Piece', width: '50px', formatter: function (value) {
                            if (value != null && value != "") {
                                return "<span title='" + value + "'>" + value + "</span>";
                            }
                        }
                    ...
                    {
                        title: '回告数量', field: 'ReplyNum', width: '50px', formatter: function (value) {
                            if (value != null && value != "") {
                                return "<span title='" + value + "'>" + value + "</span>";
                            }
                        }
                    },
                    { title: '采购费用', field: 'TransportFee', align: 'right' },
                    { title: '合计费用', field: 'TotalCharge', align: 'right' },
                    {
                    ...
                    {
                        title: '供应商名称', field: 'PurchaserName', width: '60px', formatter: function (value) {
                            if (value != null && value != "") {
                                return "<span title='" + value + "'>" + value + "</span>";
                            }
                        }
                    },
                    { title: '需求部门', field: 'PurDepart', width: '130px' },
                ]],
        ...
        function showGrid(row) {
            ...
            $('#dgAccountV2').datagrid({
                ...
                columns: [[
                    ...
                    { title: '平台费', field: 'OtherFee', width: '80px' },
