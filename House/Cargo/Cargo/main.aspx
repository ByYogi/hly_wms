...
<body class="easyui-layout">
    <div data-options="region:'north',border:false" class="header" style="height: 40px; display: flex; flex-wrap: wrap; justify-content: space-between;">
        ...
        <div style="display: inline; padding-top: 10px; text-align: right; padding-right: 10px; font-size: 14px; display: flex;">
            <div style="display: flex; justify-content: space-around; padding-top: 4px;">
                <asp:Literal ID="welcome" runat="server"></asp:Literal>
            </div>
            <div style="width: 30px; height: 25px; display: flex; justify-content: space-around; position: relative;">
                <a href="#" class="easyui-linkbutton" iconcls="icon-email" plain="true" style="line-height: 24px;" onclick="notice()" title="消息通知"></a>
                <div id="isNoticeView" style="position: absolute; top: 3px; right: 1px; width: 10px; height: 10px; background-color: brown; border-radius: 50%;"></div>
            </div>
                ...
                <div id="saPanelNotice">
                    <table>
                        <tr>
                            ...
                            <td style="width: 10%">
                                <select class="easyui-combobox" id="ANoticeType" style="width: 100px;" panelheight="auto">
                            ...
                            <td><a href="#" class="easyui-linkbutton" iconcls="icon-search" plain="false" onclick="QueryNoticeView()">&nbsp;查&nbsp;询&nbsp;</a></td>
                        </tr>

                    </table>
                </div>
                <div id="saDailyReports">
                    <a href="#" class="easyui-linkbutton" iconcls="icon-search" plain="false" onclick="QueryDailyReports()">&nbsp;查&nbsp;询&nbsp;</a>
                    </div>
    ...
    <div id="dlgNotice" class="easyui-dialog" style="width: 900px; height: 600px; padding: 0px"
        closed="true" buttons="#dlg-buttonsNotice">
        <div id="saPanel">
            <form id="fmNotice" class="easyui-form" method="post">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <input name="Title" class="easyui-textbox" data-options="prompt:'请输入公告标题',required:true" style="width: 400px;" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <textarea id="Memo" name="Memo" cols="100" rows="8" style="width: 800px; height: 400px; visibility: hidden;"></textarea>
                        </td>
                    </tr>
                </table>
            </form>
    ...
    <div id="dlg-buttonsNotice">
        <a href="#" class="easyui-linkbutton" iconcls="icon-cancel" onclick="javascript:$('#dlgNotice').dialog('close')">&nbsp;取&nbsp;消&nbsp;</a>
    </div>


     <div id="dlgReport" class="easyui-dialog" style="width: 800px; height: 600px; padding: 0px;"
     closed="true" buttons="#dlgReport-buttons">
     <div id="saPanel">
         <form id="fm" class="easyui-form" method="post">
             ...
             <table id="satable">
                 <tr>
                     ...
                     <td>
                         <input name="Title" id="Title" class="easyui-textbox" data-options="prompt:'请输入公告标题',required:true"
                             style="width: 400px;">
                     </td>
                 </tr>
