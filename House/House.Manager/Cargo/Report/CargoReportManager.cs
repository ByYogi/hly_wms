...
namespace House.Manager.Cargo
{
	...
	WHERE";
        ...
        public CargoDLTDataStatisEntity HCYC_User_StatisticsData(CargoDLTDataStatisEntity entity)
        {
            ...
            string strSQL = $@"
            SELECT
                COUNT(DISTINCT CASE WHEN OP_DATE BETWEEN  '{entity.StartDate.ToString("yyyy-MM-dd")}' AND '{entity.EndDate.ToString("yyyy-MM-dd")}' THEN (a.ClientNum) END) AS ClientCount,
                COUNT(DISTINCT a.ClientNum) AS RegisterStoresCount,
                COUNT(DISTINCT CASE WHEN OP_DATE BETWEEN  '{entity.StartDate.ToString("yyyy-MM-dd")}' AND '{entity.EndDate.ToString("yyyy-MM-dd")}' THEN (a.ID) END) AS UserCount,
        ...
        {
            List<CargoDLTDataStatisEntity> result = new List<CargoDLTDataStatisEntity>();
            string strSQL = " SELECT T.TypeID,T.TypeName,SUM(b.Piece) as TotalPiece,SUM(b.Piece*b.ActSalePrice) as TotalCharge,CONVERT(DECIMAL(10,2), SUM(b.Piece*b.ActSalePrice)/SUM(b.Piece)) as UnitCharge  FROM  Tbl_Cargo_Order a join Tbl_Cargo_OrderGoods b on a.OrderNo=b.OrderNo and a.HouseID=b.HouseID join  Tbl_Cargo_Product d on b.ProductID=d.ProductID and b.HouseID=d.HouseID LEFT JOIN Tbl_Cargo_ProductType T ON T.TypeID=d.TypeID where 1=1 and a.OrderType=4 ";
            if (entity.HouseID != 0)
            {
                strSQL += " and a.HouseID =" + entity.HouseID;
            }
        ...
        {
            List<CargoDLTDataStatisEntity> result = new List<CargoDLTDataStatisEntity>();
            string strSQL = "SELECT top 100 T.TypeID,T.TypeName,d.Specs,d.Figure,SUM(b.Piece) as TotalPiece,CONVERT(DECIMAL(10,2), SUM(b.Piece*b.ActSalePrice)/SUM(b.Piece)) as UnitCharge  FROM  Tbl_Cargo_Order a join Tbl_Cargo_OrderGoods b on a.OrderNo=b.OrderNo and a.HouseID=b.HouseID join  Tbl_Cargo_Product d on b.ProductID=d.ProductID and b.HouseID=d.HouseID LEFT JOIN Tbl_Cargo_ProductType T ON T.TypeID=d.TypeID where a.OrderType=4 ";
            if (entity.HouseID != 0)
            {
                strSQL += " and a.HouseID =" + entity.HouseID;
            }
        ...
        {
            List<CargoDLTDataStatisEntity> result = new List<CargoDLTDataStatisEntity>();
            string strSQL = "select a.TypeName,a.BrowseNum,ISNULL(b.SalePiece,0) as SalePiece from (select c.TypeName,COUNT(*) as BrowseNum from Tbl_Cargo_ProductAccessDetails as a inner join Tbl_Cargo_ProductSpec as b on a.ProductCode=b.ProductCode inner join Tbl_Cargo_ProductType as c on b.TypeID=c.TypeID inner join Tbl_WX_Client as d on a.wxOpenID=d.wxOpenID where (1=1) ";
            if (entity.HouseID != 0) { strSQL += " and a.HouseID =" + entity.HouseID; }
            if ((entity.StartDate.ToString("yyyy-MM-dd") != "0001-01-01" && entity.StartDate.ToString("yyyy-MM-dd") != "1900-01-01"))
            {
                strSQL += " and a.AccessTime>='" + entity.StartDate.ToString("yyyy-MM-dd") + "'";
            ...
            strSQL += " group by c.TypeName ) as a left join ( SELECT T.TypeName,SUM(b.Piece)AS SalePiece FROM  Tbl_Cargo_Order a join Tbl_Cargo_OrderGoods b on a.OrderNo=b.OrderNo and a.HouseID=b.HouseID  join  Tbl_Cargo_Product d on b.ProductID=d.ProductID and b.HouseID=d.HouseID LEFT JOIN Tbl_Cargo_ProductType T ON T.TypeID=D.TypeID where a.OrderType=4";
            if (entity.HouseID != 0) { strSQL += " and a.HouseID =" + entity.HouseID; }
            if ((entity.StartDate.ToString("yyyy-MM-dd") != "0001-01-01" && entity.StartDate.ToString("yyyy-MM-dd") != "1900-01-01"))
            {
                strSQL += " and a.CreateDate>='" + entity.StartDate.ToString("yyyy-MM-dd") + "'";
                ...
                using (DataTable dt = conn.ExecuteDataTable(cmd))
                {
                    foreach (DataRow idrCount in dt.Rows)
                    {
                        result.Add(new CargoDLTDataStatisEntity
                        {
                            ...
                            OrderNum = Convert.ToInt32(idrCount["SalePiece"]).Equals(0) ? 0 : (int)Math.Floor(Convert.ToDecimal(idrCount["BrowseNum"]) / Convert.ToDecimal(idrCount["SalePiece"])),//转化率
                        });
                    }
                }
            }
        ...
        {
            List<CargoDLTDataStatisEntity> result = new List<CargoDLTDataStatisEntity>();
            string strSQL = "select a.ClientNum,c.ClientName,a.BrowseNum,ISNULL(b.SalePiece,0) as SalePiece from (select d.ClientNum,COUNT(*) as BrowseNum from Tbl_Cargo_ProductAccessDetails as a inner join Tbl_Cargo_ProductSpec as b on a.ProductCode=b.ProductCode inner join Tbl_Cargo_ProductType as c on b.TypeID=c.TypeID inner join Tbl_WX_Client as d on a.wxOpenID=d.wxOpenID where (1=1) ";
            if (entity.HouseID != 0) { strSQL += " and a.HouseID =" + entity.HouseID; }
            if ((entity.StartDate.ToString("yyyy-MM-dd") != "0001-01-01" && entity.StartDate.ToString("yyyy-MM-dd") != "1900-01-01"))
            {
                strSQL += " and a.AccessTime>='" + entity.StartDate.ToString("yyyy-MM-dd") + "'";
            ...
            strSQL += " group by d.ClientNum ) as a left join ( SELECT a.ClientNum,SUM(b.Piece)AS SalePiece FROM  Tbl_Cargo_Order a join Tbl_Cargo_OrderGoods b on a.OrderNo=b.OrderNo and a.HouseID=b.HouseID  join  Tbl_Cargo_Product d on b.ProductID=d.ProductID and b.HouseID=d.HouseID LEFT JOIN Tbl_Cargo_ProductType T ON T.TypeID=D.TypeID where a.OrderType=4";
            if (entity.HouseID != 0) { strSQL += " and a.HouseID =" + entity.HouseID; }
            if ((entity.StartDate.ToString("yyyy-MM-dd") != "0001-01-01" && entity.StartDate.ToString("yyyy-MM-dd") != "1900-01-01"))
            {
                strSQL += " and a.CreateDate>='" + entity.StartDate.ToString("yyyy-MM-dd") + "'";
        ...
        public List<CargoDLTDataStatisEntity> QueryHCYC_BrandSKUData(CargoDLTDataStatisEntity entity)
        {
            ...
            strSQL += " inner join Tbl_Cargo_ProductType as c on b.TypeID=c.TypeID  ) as a ) as a where a.RN=1  ) as a left join (  select * from ( select a.TypeName,COUNT(a.ProductCode) over (partition by a.TypeName) as SKUTotalNum,ROW_NUMBER() over (partition by a.TypeName order by a.ProductCode) as RN from  ( select distinct b.ProductCode,a.TypeID,c.TypeName from Tbl_Cargo_ContainerGoods as a inner join Tbl_Cargo_Product as b on a.ProductID=b.ProductID ";
            if (entity.HouseID != 0) { strSQL += " and b.HouseID =" + entity.HouseID; }
            strSQL += "inner join Tbl_Cargo_ProductType as c on b.TypeID=c.TypeID  and a.Piece>0 ) as a ) as a where a.RN=1 ) as  b on a.TypeName=b.TypeName ";
            ...
            if (entity.HouseID != 0) { strSQL += " and b.HouseID =" + entity.HouseID; }
            strSQL += " inner join Tbl_Cargo_ProductType as c on b.TypeID=c.TypeID  and a.Piece>0 )as a ) as a where a.RN=1) as d on a.TypeName=d.TypeName";
            strSQL += " left join (select d.TypeName,COUNT(distinct c.ProductCode) as SaledSKUNum From Tbl_Cargo_Order as a inner join Tbl_Cargo_OrderGoods as b on a.OrderNo=b.OrderNo and a.HouseID=b.HouseID inner join Tbl_Cargo_Product as c on b.ProductID=c.ProductID and a.HouseID=c.HouseID inner join Tbl_Cargo_ProductType as d on c.TypeID=d.TypeID  ";
            if (!string.IsNullOrEmpty(entity.OrderType))
            {
            ...
            strSQL += " group by d.TypeName ) as c on a.TypeName=c.TypeName  order by a.SKUTotalNum desc";
            using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
            {
                using (DataTable dt = conn.ExecuteDataTable(cmd))
                {
                    foreach (DataRow idrCount in dt.Rows)
                    {
                        result.Add(new CargoDLTDataStatisEntity
                        {
                            ...
                            SaledRatio = Convert.ToInt32(idrCount["SaledSKUNum"]).Equals(0) ? "0" : Math.Round((Convert.ToDouble(idrCount["SaledSKUNum"]) / Convert.ToDouble(idrCount["SKUTotalNum"])) * 100, 2) + "%",
                            TypeName = Convert.ToString(idrCount["TypeName"]),
...
FROM Tbl_WX_Client AS a INNER JOIN Tbl_WX_Order AS c ON a.ID = c.WXID WHERE convert(varchar(10),c.CreateDate,23) >= '{entity.StartDate.ToString("yyyy-MM-dd")}' AND convert(varchar(10),c.CreateDate,23) <= '{entity.EndDate.ToString("yyyy-MM-dd")}'
              ) as a1
    inner join (
...
";
        ...
        public List<CargoOrderDayStatisticsEntity> QueryHCYC_BrandData(CargoHouseAimEntity entity)
        {
            List<CargoOrderDayStatisticsEntity> result = new List<CargoOrderDayStatisticsEntity>();
            string strSQL = $@"
      select a2.*, isnull(d.StockNum, 0) as StockNum, isnull(ProCount, 0) AS ProCount, isnull(ProPiece, 0) AS ProPiece,isnull(dd.UniqueClientCount,0) UniqueClientCount,isnull(dd.UniqueClientNum,0) UniqueClientNum
          ,isnull(clickCount,0) as clickCount
          from (select a.TypeID, a.HouseID, sum(case when OrderModel=0 then Piece else -Piece end) Piece, count(distinct ProductCode) as Count, b.TypeName, c.Name HouseName
                from Tbl_Cargo_OrderDayStatistics as a
                         inner join Tbl_Cargo_ProductType as b on a.TypeID = b.TypeID
                         inner join Tbl_Cargo_House as c on a.HouseID = c.HouseID
                where 1=1 {(entity.TypeID==0? "": " and a.TypeID = @TypeID")} 
                  ...
                  and convert(varchar(10),DayStatisticsTime,23) >= @StartDate and convert(varchar(10),DayStatisticsTime,23)<=@EndDate
                group by a.TypeID, a.HouseID, b.TypeName, c.Name) as a2
                  ...
                  left join (select b.TypeID, e.HouseID, count(distinct a.ProductCode) as ProCount, sum(b.Piece) as ProPiece
                              ...
                              where a.InCargoStatus in (1, 2) and b.Piece <> 0  and ProductCode is not null
                                AND A.SpecsType IN (4) 
                              group by b.TypeID, e.HouseID) as c on a2.TypeID = c.TypeID and a2.HouseID = c.HouseID
                  left join (
                  SELECT
              h.TypeID,c.HouseID,COUNT(DISTINCT c.ID) AS UniqueClientCount,sum(case when OrderModel=1 then -orderGoods.Piece else orderGoods.Piece end) UniqueClientNum
          FROM Tbl_WX_Order AS c
              inner join Tbl_Cargo_Order as d on c.OrderNo=d.WXOrderNo
          ...
          WHERE
              convert(varchar(10),c.CreateDate,23) >= @StartDate
              AND  convert(varchar(10),c.CreateDate,23) <= @EndDate --and PayStatus=1 
{(entity.TypeID == 0 ? "" : " and h.TypeID = @TypeID")} 
{(entity.HouseID == 0 ? "" : "and c.HouseID = @HouseID")} 
          group by h.TypeID, c.HouseID
          ...
          where (1 = 1)
            and  convert(varchar(10),a.AccessTime,23) >= @StartDate
            and convert(varchar(10),a.AccessTime,23) <= @EndDate 
...
{(entity.HouseID == 0 ? "" : "and a.HouseID = @HouseID")} 
      ...
      ";
            ...
            using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
            {
                ...
                conn.AddInParameter(cmd, "@EndDate", DbType.DateTime, (entity.EndDate.ToString("yyyy-MM-dd")));
      ...
      ";
        ...
        public List<CargoOrderDayStatisticsEntity> GetClickConversionRateDetail(CargoHouseAimEntity entity)
        {
            List<CargoOrderDayStatisticsEntity> result = new List<CargoOrderDayStatisticsEntity>();
            string strSQL = $@"
                            select a1.*, isnull(a2.UniqueClientCount, 0) as UniqueClientCount, isnull(a2.UniqueClientNum, 0) as UniqueClientNum
                                from (select a.HouseID, c.TypeID, count(1) clickCount, a.ProductCode,c.ProductName,d.TypeName,c.Specs,e.Name HouseName
                                      from Tbl_Cargo_ProductAccessDetails as a
                                               inner join Tbl_WX_Client as b on a.wxOpenID = b.wxOpenID
                                               inner join Tbl_Cargo_ProductSpec as c on a.ProductCode = c.ProductCode
                                      ...
                                      group by a.HouseID, c.TypeID, a.ProductCode,c.ProductName,d.TypeName,c.Specs,e.Name) as a1
                                         left join (select h.TypeID,c.HouseID,COUNT(DISTINCT c.ID) AS UniqueClientCount,sum(case when OrderModel= 1 then -orderGoods.Piece else orderGoods.Piece end) UniqueClientNum,ProductCode
                                                    FROM Tbl_WX_Client AS a
                                                             INNER JOIN Tbl_WX_Order AS c ON a.ID = c.WXID
                                                             inner join Tbl_Cargo_Order as d on c.OrderNo = d.WXOrderNo
                                                             inner join Tbl_Cargo_OrderGoods orderGoods on d.OrderNo = orderGoods.OrderNo
                                                             inner join Tbl_Cargo_Product as h on h.ProductID = orderGoods.ProductID
                                                    WHERE convert(varchar(10), c.CreateDate, 23) >= @StartDate
                                                      AND convert(varchar(10), c.CreateDate, 23) <= @EndDate
                                                      and TypeID = @TypeID
                                                      and c.HouseID = @HouseID
                                                    group by h.TypeID, c.HouseID, ProductCode) a2
                                                   on a1.TypeID = a2.TypeID and a1.HouseID = a2.HouseID and
                                                      a1.ProductCode = a2.ProductCode
                                order by UniqueClientCount desc,clickCount  desc
      ";
