...
namespace House.Manager.Cargo
{
	...
	WHERE";
        ...
        public List<CargoDailyReportEntity> QueryInDailyReport(CargoDailyReportEntity entity)
        {
            ...
            if (!string.IsNullOrEmpty(entity.InHouseType)) { strSQL += " and a.InHouseType ='" + entity.InHouseType + "'"; }
            if (!string.IsNullOrEmpty(entity.TyreModel)) { strSQL += " and e.TyreModel ='" + entity.TyreModel + "'"; }
                    ...
                    using (DataTable dt = conn.ExecuteDataTable(cmd))
                    {
                        foreach (DataRow idrCount in dt.Rows)
                        {
                            ...
                            result.Add(new CargoDailyReportEntity
                            {
                                ...
                                TyreModel = Convert.ToString(idrCount["TyreModel"]),
                                QalityRemark = Convert.ToString(idrCount["QalityRemark"]),
                                PurchaseSupplier = Convert.ToString(idrCount["PurchaseSupplier"]),
                            });
                        }
                    }
                        ...
                        foreach (DataRow idrCount in dt.Rows)
                        {
                            ...
                            if (entity.CargoPermisID == "47")
                            {
                                result.Add(new CargoDailyReportEntity
                                {
                                    ...
                                    FirstAreaID = string.IsNullOrEmpty(Convert.ToString(idrCount["FirstAreaID"])) ? 0 : Convert.ToInt32(idrCount["FirstAreaID"]),
                                    FirstAreaName = Convert.ToString(idrCount["FirstAreaName"]),
                                    ParentAreaID = string.IsNullOrEmpty(Convert.ToString(idrCount["ParentAreaID"])) ? 0 : Convert.ToInt32(idrCount["ParentAreaID"]),
                                    ParentAreaName = Convert.ToString(idrCount["ParentAreaName"]),
        ...
        public Hashtable QuerySaleManDailyReport(int pIndex, int pNum, SaleManReportEntity entity)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(entity.OpenOrderSource)) { strSQL += " and b.OpenOrderSource ='" + entity.OpenOrderSource + "'"; }
                ...
                if (!string.IsNullOrEmpty(entity.IsPriceAlert) && entity.IsPriceAlert == "1")
                {
                    strSQL += " AND ISNULL( a.ActSalePrice, 0 ) < ISNULL( e.NextDayPrice, 0 ) AND ISNULL( e.NextDayPrice, 0 ) !=0 ";
                }
                ...
                using (DbCommand command = conn.GetSqlStringCommond(strSQL))
                {
                    using (DataTable dd = conn.ExecuteDataTable(command))
                    {
                        ...
                        foreach (DataRow idr in dd.Rows)
                        {
                            var dataItem = new SaleManReportEntity
                            {
                                ...
                                FirstAreaID = string.IsNullOrEmpty(Convert.ToString(idr["FirstAreaID"])) ? 0 : Convert.ToInt32(idr["FirstAreaID"]),
                ...
                if (!string.IsNullOrEmpty(entity.OpenOrderSource)) { strCount += " and b.OpenOrderSource ='" + entity.OpenOrderSource + "'"; }
...
ORDER BY a.HouseID DESC, YearMonth;";
        ...
        public List<CargoDLTDataStatisEntity> HCYC_Order_Statistics(CargoDLTDataStatisEntity entity)
        {
            ...
            //strSQL += $@" (SELECT HouseID,COUNT(*) as sale_total_num,SUM(Piece) AS sale_total_quantity,SUM(TotalCharge) AS sale_total_amount FROM Tbl_Cargo_Order WHERE OrderType=4 and HouseID=" + entity.HouseID + $@" and OrderModel=0 {(string.IsNullOrEmpty(entity.ThrowGood)||entity.ThrowGood=="0"? $@" and ThrowGood in(22,23)" : $@" and ThrowGood={entity.ThrowGood}")} group by HouseID) as a left join  ";
            //strSQL += $@" (SELECT HouseID,COUNT(*) as sale_daily_num,SUM(Piece) AS sale_daily_quantity,SUM(TotalCharge) AS sale_daily_amount FROM Tbl_Cargo_Order WHERE OrderType=4  and HouseID=" + entity.HouseID + $@" and OrderModel=0 {(string.IsNullOrEmpty(entity.ThrowGood) || entity.ThrowGood == "0" ? $@" and ThrowGood in(22,23)" : $@" and ThrowGood={entity.ThrowGood}")} and CreateDate>='" + entity.StartDate.ToString("yyyy-MM-dd") + "' group by HouseID) as b on a.HouseID=b.HouseID left join ";
            //strSQL += $@" (SELECT HouseID,COUNT(*) as sale_monthly_num,SUM(Piece) AS sale_monthly_quantity,SUM(TotalCharge) AS sale_monthly_amount FROM Tbl_Cargo_Order WHERE OrderType=4  and HouseID=" + entity.HouseID + $@" and OrderModel=0 {(string.IsNullOrEmpty(entity.ThrowGood) || entity.ThrowGood == "0" ? $@" and ThrowGood in(22,23)" : $@" and ThrowGood={entity.ThrowGood}")} and CreateDate>='" + entity.StartDate.ToString("yyyy-MM-dd") + "' and CreateDate<'" + entity.EndDate.AddDays(1).ToString("yyyy-MM-dd") + "' group by HouseID) as c on a.HouseID=c.HouseID left join ";
            //strSQL += $@"(SELECT HouseID,COUNT(*) as retu_monthly_num,SUM(Piece) AS retu_monthly_quantity,SUM(TotalCharge) AS retu_monthly_amount FROM Tbl_Cargo_Order WHERE OrderType=4  and HouseID=" + entity.HouseID + " and OrderModel=1 and ThrowGood=5 and CreateDate>='" + entity.StartDate.ToString("yyyy-MM-dd") + "' and CreateDate<'" + entity.EndDate.AddDays(1).ToString("yyyy-MM-dd") + "'group by HouseID) as d on a.HouseID=d.HouseID left join ";
            //strSQL += $@"(SELECT HouseID,COUNT(*) as retu_daily_num,SUM(Piece) AS retu_daily_quantity,SUM(TotalCharge) AS retu_daily_amount FROM Tbl_Cargo_Order WHERE OrderType=4  and HouseID=" + entity.HouseID + " and OrderModel=1 and ThrowGood=5 and CreateDate>='" + entity.StartDate.ToString("yyyy-MM-dd") + "'group by HouseID) as e on a.HouseID=e.HouseID left join ";
            //strSQL += $@"(SELECT HouseID,COUNT(*) as OES_sale_daily_num,SUM(Piece) AS OES_sale_daily_quantity,SUM(TotalCharge) AS OES_sale_daily_amount FROM Tbl_Cargo_Order WHERE OrderType=4  and HouseID=" + entity.HouseID + " and OrderModel=0 and ThrowGood=12 and CreateDate>='" + entity.StartDate.ToString("yyyy-MM-dd") + "' group by HouseID) as f on a.HouseID=f.HouseID left join ";
            //strSQL += $@"(SELECT HouseID,COUNT(*) as OES_sale_monthly_num,SUM(Piece) AS OES_sale_monthly_quantity,SUM(TotalCharge) AS OES_sale_monthly_amount FROM Tbl_Cargo_Order WHERE OrderType=4  and HouseID=" + entity.HouseID + " and OrderModel=0 and ThrowGood=12 and CreateDate>='" + entity.StartDate.ToString("yyyy-MM-dd") + "' and CreateDate<'" + entity.EndDate.AddDays(1).ToString("yyyy-MM-dd") + "' group by HouseID) as g on a.HouseID=g.HouseID";

            string strSQL = "select ISNULL(a.sale_total_num,0) as SaleOrderTotalNum,ISNULL(a.sale_total_quantity,0) as SaleOrderTotalPiece,ISNULL(a.sale_total_amount,0) as SaleOrderTotalCharge,ISNULL(b.sale_daily_num,0) as SaleOrderDayNum,ISNULL(b.sale_daily_quantity,0) as SaleOrderDayPiece,ISNULL(b.sale_daily_amount,0) as SaleOrderDayCharge,ISNULL(c.sale_monthly_num,0) as SaleOrderMonthNum,ISNULL(c.sale_monthly_quantity,0) as SaleOrderMonthPiece,ISNULL(c.sale_monthly_amount,0) as SaleOrderMonthCharge,ISNULL(d.retu_monthly_num,0) as ReturnOrderMonthNum,ISNULL(d.retu_monthly_quantity,0) as ReturnOrderMonthPiece,ISNULL(d.retu_monthly_amount,0) as ReturnOrderMonthCharge,ISNULL(e.retu_daily_num,0) as ReturnOrderDayNum,ISNULL(e.retu_daily_quantity,0) as ReturnOrderDayPiece,ISNULL(e.retu_daily_amount,0) as ReturnOrderDayCharge,ISNULL(f.OES_sale_daily_num,0) as OESSaleOrderDayNum,ISNULL(f.OES_sale_daily_quantity,0) as OESSaleOrderDayPiece,ISNULL(f.OES_sale_daily_amount,0) as OESSaleOrderDayCharge,ISNULL(g.OES_sale_monthly_num,0) as OESSaleOrderMonthNum,ISNULL(g.OES_sale_monthly_quantity,0) as OESSaleOrderMonthPiece,ISNULL(g.OES_sale_monthly_amount,0) as OESSaleOrderMonthCharge from";
            strSQL += " (SELECT HouseID,COUNT(*) as sale_total_num,SUM(Piece) AS sale_total_quantity,SUM(TotalCharge) AS sale_total_amount FROM Tbl_Cargo_Order WHERE OrderType=4  and HouseID=" + entity.HouseID + $@" and OrderModel=0 and ThrowGood in({(entity.ThrowGood=="0"?"22,23,27": (entity.ThrowGood == "22" ? entity.ThrowGood : "23,27"))}) group by HouseID) as a left join  ";
            strSQL += " (SELECT HouseID,COUNT(*) as sale_daily_num,SUM(Piece) AS sale_daily_quantity,SUM(TotalCharge) AS sale_daily_amount FROM Tbl_Cargo_Order WHERE OrderType=4  and HouseID=" + entity.HouseID + $@" and OrderModel=0 and ThrowGood in({(entity.ThrowGood == "0" ? "22,23,27" : (entity.ThrowGood == "22" ? entity.ThrowGood : "23,27"))}) and CreateDate>='" + DateTime.Now.ToString("yyyy-MM-dd") + "' group by HouseID) as b on a.HouseID=b.HouseID left join ";
            strSQL += " (SELECT HouseID,COUNT(*) as sale_monthly_num,SUM(Piece) AS sale_monthly_quantity,SUM(TotalCharge) AS sale_monthly_amount FROM Tbl_Cargo_Order WHERE OrderType=4  and HouseID=" + entity.HouseID + $@" and OrderModel=0 and ThrowGood in({(entity.ThrowGood == "0" ? "22,23,27" : (entity.ThrowGood == "22" ? entity.ThrowGood : "23,27"))}) and CreateDate>='" + DateTime.Now.AddDays(1 - DateTime.Now.Day).ToString("yyyy-MM-dd") + "' and CreateDate<'" + DateTime.Now.AddDays(1).ToString("yyyy-MM-dd") + "' group by HouseID) as c on a.HouseID=c.HouseID left join ";
        ...
        {
            List<CargoDLTDataStatisEntity> result = new List<CargoDLTDataStatisEntity>();
            string strSQL = " SELECT T.TypeID,T.TypeName,SUM(case when OrderModel = 1 then -b.Piece else b.Piece end) as TotalPiece,SUM((case when OrderModel = 1 then -b.Piece else b.Piece end)*b.ActSalePrice) as TotalCharge,   (case when SUM((case when OrderModel = 1 then -b.Piece else b.Piece end))>0 then CONVERT(DECIMAL(10, 2), SUM((case when OrderModel = 1 then -b.Piece else b.Piece end) * b.ActSalePrice) / SUM((case when OrderModel = 1 then -b.Piece else b.Piece end))) else 0 end) as UnitCharge  FROM  Tbl_Cargo_Order a join Tbl_Cargo_OrderGoods b on a.OrderNo=b.OrderNo and a.HouseID=b.HouseID join  Tbl_Cargo_Product d on b.ProductID=d.ProductID and b.HouseID=d.HouseID LEFT JOIN Tbl_Cargo_ProductType T ON T.TypeID=d.TypeID where 1=1 and a.OrderType=4 ";
            if (entity.HouseID != 0)
            {
                strSQL += " and a.HouseID =" + entity.HouseID;
            }
            ...
            if (!string.IsNullOrEmpty(entity.ThrowGood) && entity.ThrowGood != "0")
            {
                //strSQL += $@" and a.ThrowGood in({entity.ThrowGood})";
                strSQL += $@" and a.ThrowGood in({(entity.ThrowGood == "0" ? "22,23,27" : (entity.ThrowGood == "22" ? entity.ThrowGood : "23,27"))})";
            }
        ...
        {
            List<CargoDLTDataStatisEntity> result = new List<CargoDLTDataStatisEntity>();
            string strSQL = "select a.ClientNum,c.ClientName,a.BrowseNum,Cellphone,Boss,ISNULL(b.SalePiece,0) as SalePiece, ISNULL(b.SaleCount, 0) as SaleCount from (select d.ClientNum,COUNT(*) as BrowseNum from Tbl_Cargo_ProductAccessDetails as a inner join Tbl_Cargo_ProductSpec as b on a.ProductCode=b.ProductCode inner join Tbl_Cargo_ProductType as c on b.TypeID=c.TypeID inner join Tbl_WX_Client as d on a.wxOpenID=d.wxOpenID where (1=1) ";
            if (entity.HouseID != 0) { strSQL += " and a.HouseID =" + entity.HouseID; }
            if ((entity.StartDate.ToString("yyyy-MM-dd") != "0001-01-01" && entity.StartDate.ToString("yyyy-MM-dd") != "1900-01-01"))
            {
                strSQL += " and a.AccessTime>='" + entity.StartDate.ToString("yyyy-MM-dd") + "'";
                ...
                using (DataTable dt = conn.ExecuteDataTable(cmd))
                {
                    foreach (DataRow idrCount in dt.Rows)
                    {
                        ...
                        result.Add(new CargoDLTDataStatisEntity
                        {
                            ...
                            OrderCount = Convert.ToInt32(idrCount["SaleCount"]),
                            ClientName = Convert.ToString(idrCount["ClientName"]),
                            Boss = Convert.ToString(idrCount["Boss"]),
                            Cellphone = Convert.ToString(idrCount["Cellphone"]),
                            BrowseNum = Convert.ToInt32(idrCount["BrowseNum"]),
                            OrderNumRate = OrderNum,//转化率
                        });
        ...
        public List<CargoReportAgeingEntity> QueryReportAgeingList(CargoReportAgeingEntity entity)
        {
            ...
            #region 组装查询SQL语句
            string strSQL = @"select a.OrderNo,a.Piece,a.HAwbNo,a.LogisAwbNo,a.AcceptUnit,a.CreateAwb,a.CreateDate,a.OutCargoTime,a.SendCarTime,a.TakeOrderTime,a.AwbStatus,a.HouseID,a.OutHouseName,a.PayClientNum,a.PayClientName,a.LineID,a.LineName,a.ShopCode,b.Product,b.Province,b.City,a.OrderType,a.AbSignStatus,c.SignImage,c.Signer,c.SignTime,a.Dep,a.Dest,ISNULL(d.ArriveAgeHour,0) as ArriveAgeHour,ISNULL(d.SignAgeHour,0) as SignAgeHour From Tbl_Cargo_Order as a inner join Tbl_Cargo_Client as b on a.PayClientNum=b.ClientNum left join (select OrderID,OrderNo,Signer,SignTime,SignImage from Tbl_Cargo_OrderStatus where OrderStatus=5 ";
            if ((entity.StartDate.ToString("yyyy-MM-dd") != "0001-01-01" && entity.StartDate.ToString("yyyy-MM-dd") != "1900-01-01"))
            {
                strSQL += " and OP_DATE>='" + entity.StartDate.ToString("yyyy-MM-dd") + "'";
            }
            strSQL += ") as c on a.OrderID=c.OrderID and a.OrderNo=c.OrderNo Left Join Tbl_Cargo_CityAgeing as d on a.Dep=d.DepCity and a.Dest=d.DestCity Where (1=1) and a.OrderModel=0 ";
                ...
                using (DataTable dt = conn.ExecuteDataTable(command))
                {
                    foreach (DataRow idr in dt.Rows)
                    {
                        result.Add(new CargoReportAgeingEntity
                        {
                            ...
                            Dep = Convert.ToString(idr["Dep"]),
                            Dest = Convert.ToString(idr["Dest"]),
                            ArriveAgeHour = Convert.ToDecimal(idr["ArriveAgeHour"]),
                            SignAgeHour = Convert.ToDecimal(idr["SignAgeHour"]),
        ...
        /// <returns></returns>
        /// <exception cref="ApplicationException"></exception>
        public Hashtable QueryReportCityAgeingSet(int pIndex, int pNum, CargoReportCityAgeingSetEntity entity)
        {
            List<CargoReportCityAgeingSetEntity> result = new List<CargoReportCityAgeingSetEntity>();
            Hashtable resHT = new Hashtable();
            try
            {
                #region 组装查询SQL语句
                string strSQL = @" SELECT TOP " + pNum + " *  FROM ";
                strSQL += "(select DISTINCT ROW_NUMBER() OVER (ORDER BY OPDate DESC) AS RowNumber,* from Tbl_Cargo_CityAgeing where (1=1) ";
                if (!string.IsNullOrEmpty(entity.DepProvince)) { strSQL += " and DepProvince = '" + entity.DepProvince + "'"; }
                if (!string.IsNullOrEmpty(entity.DepCity)) { strSQL += " and DepCity = '" + entity.DepCity + "'"; }
                if (!string.IsNullOrEmpty(entity.DestProvince)) { strSQL += " and DestProvince = '" + entity.DestProvince + "'"; }
                if (!string.IsNullOrEmpty(entity.DestCity)) { strSQL += " and DestCity = '" + entity.DestCity + "'"; }
                ...
                using (DbCommand command = conn.GetSqlStringCommond(strSQL))
                {
                    using (DataTable dt = conn.ExecuteDataTable(command))
                    {
                        foreach (DataRow idr in dt.Rows)
                        {
                            ...
                            result.Add(new CargoReportCityAgeingSetEntity
                            {
                                MID = Convert.ToInt64(idr["MID"]),
                                DepProvince = Convert.ToString(idr["DepProvince"]),
                                DepCity = Convert.ToString(idr["DepCity"]),
                                DestProvince = Convert.ToString(idr["DestProvince"]),
                                DestCity = Convert.ToString(idr["DestCity"]),
                                ArriveAgeHour = Convert.ToDecimal(idr["ArriveAgeHour"]),
                                SignAgeHour = Convert.ToDecimal(idr["SignAgeHour"]),
                ...
                resHT["rows"] = result;
                #region 总数目
                string strCount = @"select  Count(*) as TotalCount from Tbl_Cargo_CityAgeing where (1=1)";
                if (!string.IsNullOrEmpty(entity.DepProvince)) { strCount += " and DepProvince = '" + entity.DepProvince + "'"; }
                if (!string.IsNullOrEmpty(entity.DepCity)) { strCount += " and DepCity = '" + entity.DepCity + "'"; }
                if (!string.IsNullOrEmpty(entity.DestProvince)) { strCount += " and DestProvince = '" + entity.DestProvince + "'"; }
                if (!string.IsNullOrEmpty(entity.DestCity)) { strCount += " and DestCity = '" + entity.DestCity + "'"; }
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void DelReportCityAgeingSet(List<CargoReportCityAgeingSetEntity> entity)
        {
            foreach (var it in entity)
            {
                string strSQL = @"UPDATE Tbl_Cargo_CityAgeing SET DelFlag='1' WHERE MID=@MID";
                if (it.DelFlag.Equals("1"))//彻底删除
                {
                    strSQL = @"Delete from Tbl_Cargo_CityAgeing where MID=@MID ";
                }
                using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
                {
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void AddReportCityAgeingSet(CargoReportCityAgeingSetEntity entity)
        {
            string strSQL = @"INSERT INTO Tbl_Cargo_CityAgeing(DepProvince,DepCity,DestProvince,DestCity,ArriveAgeHour,DelFlag,SignAgeHour,OPID) VALUES (@DepProvince,@DepCity,@DestProvince,@DestCity,@ArriveAgeHour,@DelFlag,@SignAgeHour,@OPID)";
            using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
            {
                conn.AddInParameter(cmd, "@DepProvince", DbType.String, entity.DepProvince);
                conn.AddInParameter(cmd, "@DepCity", DbType.String, entity.DepCity);
                conn.AddInParameter(cmd, "@DestProvince", DbType.String, entity.DestProvince);
                conn.AddInParameter(cmd, "@DestCity", DbType.String, entity.DestCity);
                conn.AddInParameter(cmd, "@DelFlag", DbType.String, entity.DelFlag);
                conn.AddInParameter(cmd, "@ArriveAgeHour", DbType.Decimal, entity.ArriveAgeHour);
                conn.AddInParameter(cmd, "@SignAgeHour", DbType.Decimal, entity.SignAgeHour);
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void UpdateReportCityAgeingSet(CargoReportCityAgeingSetEntity entity)
        {
            string strSQL = @"UPDATE Tbl_Cargo_CityAgeing SET DepProvince=@DepProvince,DepCity=@DepCity,DestProvince=@DestProvince,DestCity=@DestCity,DelFlag=@DelFlag,ArriveAgeHour=@ArriveAgeHour,SignAgeHour=@SignAgeHour,OPID=@OPID WHERE MID=@MID";
        ...
        {
            List<CargoDLTDataStatisEntity> result = new List<CargoDLTDataStatisEntity>();
            entity.ThrowGood = entity.ThrowGood == "23" ? "23,27" : entity.ThrowGood;
...
from (
    select
    sum(case when isnull(OrderModel,0)=0 then a.Piece else -a.Piece end) as SalesPiece,sum(case when isnull(OrderModel,0)=1 then a.Piece else 0 end) as ReturnPiece
     ,sum(case when isnull(OrderModel,0)=0 then a.TotalCharge else -a.TotalCharge end) as SalesTotalCharge
...
where DayStatisticsTime>='{entity.StartDate.ToString("yyyy-MM-dd")}'
  and DayStatisticsTime<='{entity.EndDate.ToString("yyyy-MM-dd")} 23:59:59' 
{(!string.IsNullOrEmpty(entity.ThrowGood) && entity.ThrowGood != "0" ? $@" and a.ThrowGood in({entity.ThrowGood})" : "")}
...
";
        ...
        public List<CargoHouseAimEntity> QueryHCYC_House(CargoHouseAimEntity entity)
        {
            ...
            var OrderType = entity.OrderType == 23 ? $@"23,27" : entity.OrderType.ToString();
            string strSQL = $@"
            ...
            where DayStatisticsTime>='{entity.StartDate.ToString("yyyy-MM-dd")}'
              and DayStatisticsTime<='{entity.EndDate.ToString("yyyy-MM-dd HH:mm:ss")}'
            {(OrderType == "0" ? "" : $@" and ThrowGood in({OrderType})")}
            --and OrderModel=0
            group by HouseID ,Year,Month
                          ) as a2
             left join (
                select HouseID,sum(case when OrderModel=0 then Piece else -Piece end) as PrevPiece--,Year 
from Tbl_Cargo_OrderDayStatistics as a
...
{(OrderType != "0" ? $@" and ThrowGood in({OrderType})" : "")} 
 {(entity.SuppClientNum != 0 ? $@" and p.SuppClientNum='{entity.SuppClientNum}'" : "")}
)
, OrderStats as (
    select
        TypeID,
        ...
        SUM(case when OrderModel=1 then -a.Piece else a.Piece end) as UniqueClientNum
    from BaseOrders as a
    inner join Tbl_WX_Order wo on wo.OrderNo=a.WXOrderNo
    where a.OrderType = 4
    group by TypeID, a.HouseID
)
, BigSizeStats as (
    select
        HouseID,
...
, ClickStats as (
 ...
 {(entity.SuppClientNum != 0 ? $@" and SuppClientNum='{entity.SuppClientNum}'" : "")}
    group by a.HouseID, c.TypeID
)
select
    a2.*,
    ...
    isnull(c.OverduePiece, 0) as OverduePiece,
    isnull(c.ProCountAll, 0) as ProCountAll,
    isnull(c.ProPiece, 0) as ProPiece,
    isnull(cc.GlobalProCount, 0) as GlobalProCount,
    isnull(cc.GlobalProCountAll, 0) as GlobalProCountAll,
    isnull(cc.GlobalProPiece, 0) as GlobalProPiece,
...
left join (
    select HouseID, TypeID,count(distinct ProductCode) as StockNum
...
select
    TypeID,
           count(distinct case when Piece<>0 then ProductCode end) as GlobalProCount,
           count(distinct ProductCode) as GlobalProCountAll,
           sum(Piece) as GlobalProPiece
    from (
    select b.TypeID,ProductCode,sum(Piece) Piece
    from Tbl_Cargo_Product a
    inner join Tbl_Cargo_ContainerGoods b on a.ProductID = b.ProductID
    inner join Tbl_Cargo_Container c on c.ContainerID = b.ContainerID
    inner join Tbl_Cargo_Area as d on c.AreaID = d.AreaID
    ...
    inner join Tbl_Cargo_Area as h on g.ParentID = h.AreaID
    inner join Tbl_Cargo_House as e on d.HouseID = e.HouseID
    where a.IsLockStock = '0' and a.SpecsType <> 5 and h.IsShowStock = '0'  and a.OperaType<>0  and isnull(ProductCode,'')<>'' {(entity.SuppClientNum != 0 ? $@" and SuppClientNum='{entity.SuppClientNum}'" : "")}
    group by  b.TypeID,ProductCode
              ) a2
where 1=1
    group by TypeID
) cc on a2.TypeID = cc.TypeID
...
";
                ...
                using (DataTable dt = conn.ExecuteDataTable(cmd))
                {
                    foreach (DataRow idrCount in dt.Rows)
                    {
                        result.Add(new CargoOrderDayStatisticsEntity
                        {
                            ...
                            OverduePiece = Convert.ToInt32(idrCount["OverduePiece"]),
                            ProPiece = Convert.ToInt32(idrCount["ProPiece"]),
                            GlobalProCount = Convert.ToInt32(idrCount["GlobalProCount"]),
                            GlobalProCountAll = Convert.ToInt32(idrCount["GlobalProCountAll"]),
                            GlobalProPiece = Convert.ToInt32(idrCount["GlobalProPiece"]),
        ...
        public List<CargoOrderDayStatisticsEntity> GetSalesRateDetail(CargoHouseAimEntity entity)
        {
            ...
            {
                strSQL = $@"
 select a3.TypeID,a3.TypeName,a3.HouseID,a3.HouseName,a3.ProductCode,a3.Specs,a3.ProCount,a3.ProCountAll,a3.ProPiece,isnull(a2.Piece,0) as Piece from (
     select b.TypeID, e.HouseID,e.Name HouseName,a.ProductCode,a.Specs,ty.TypeName,
           count(distinct case when b.Piece<>0 then a.ProductCode end) as ProCount,
           count(distinct a.ProductCode) as ProCountAll,
           sum(b.Piece) as ProPiece
    from Tbl_Cargo_Product a
    inner join Tbl_Cargo_ProductType ty on a.TypeID = ty.TypeID
    inner join Tbl_Cargo_ContainerGoods b on a.ProductID = b.ProductID
    inner join Tbl_Cargo_Container c on c.ContainerID = b.ContainerID
    inner join Tbl_Cargo_Area as d on c.AreaID = d.AreaID
    inner join Tbl_Cargo_Area as g on d.ParentID = g.AreaID
    ...
    where a.IsLockStock = '0' and a.SpecsType <> 5 and h.IsShowStock = '0'  {(entity.SuppClientNum != 0 ? $@" and SuppClientNum=@SuppID" : "")} 
    and e.HouseID=@HouseID and b.TypeID=@TypeID
    group by b.TypeID,ty.TypeName, e.HouseID,e.Name,a.ProductCode,a.Specs
               ) as a3
left join(
        select a.TypeID, a.HouseID, a.ProductCode, d.Specs,sum(case when OrderModel=0 then Piece else -Piece end) as Piece from Tbl_Cargo_OrderDayStatistics as a
         inner join Tbl_Cargo_ProductSpec as d on a.ProductCode = d.ProductCode
      where a.TypeID = @TypeID and a.HouseID=@HouseID {(OrderType != "0" ? $@" and ThrowGood in({OrderType})" : "")} {(entity.SuppClientNum != 0 ? $@" and a.SuppID=@SuppID" : "")}
        and DayStatisticsTime >= @StartDate and DayStatisticsTime<=@EndDate
        group by a.TypeID, a.HouseID, a.ProductCode, d.Specs
    ) as a2 on a3.ProductCode=a2.ProductCode and a3.TypeID=a2.TypeID and a3.HouseID=a2.HouseID and a3.Specs=a2.Specs
";
            ...
            {
                strSQL = $@"
select a3.TypeID,a3.TypeName,a3.ProductCode,a3.Specs,a3.ProCount,a3.ProCountAll,a3.ProPiece,isnull(a2.Piece,0) as Piece from (
     select b.TypeID,a.ProductCode,a.Specs,ty.TypeName,
           count(distinct case when b.Piece<>0 then a.ProductCode end) as ProCount,
           count(distinct a.ProductCode) as ProCountAll,
           sum(b.Piece) as ProPiece
    from Tbl_Cargo_Product a
    ...
    where a.IsLockStock = '0' and a.SpecsType <> 5 and h.IsShowStock = '0'  {(entity.SuppClientNum != 0 ? $@" and SuppClientNum=@SuppID" : "")} 
    and b.TypeID=@TypeID
    group by b.TypeID,ty.TypeName,a.ProductCode,a.Specs
               ) as a3
left join(
        select a.TypeID,  a.ProductCode, d.Specs,sum(case when OrderModel=0 then Piece else -Piece end) as Piece from Tbl_Cargo_OrderDayStatistics as a
         inner join Tbl_Cargo_ProductSpec as d on a.ProductCode = d.ProductCode
      where a.TypeID = @TypeID {(OrderType != "0" ? $@" and ThrowGood in({OrderType})" : "")} {(entity.SuppClientNum != 0 ? $@" and a.SuppID=@SuppID" : "")}
                         and DayStatisticsTime >= @StartDate and DayStatisticsTime<=@EndDate
        group by a.TypeID, a.ProductCode, d.Specs
    ) as a2 on a3.ProductCode=a2.ProductCode and a3.TypeID=a2.TypeID and a3.Specs=a2.Specs
";
            ...
            using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
            {
                ...
                var et = entity.EndDate.AddDays(1).AddMilliseconds(-1);
                conn.AddInParameter(cmd, "@EndDate", DbType.DateTime, (et));
                    ...
                    foreach (DataRow idrCount in dt.Rows)
                    {
                        ...
                        else
                        {
                            result.Add(new CargoOrderDayStatisticsEntity
                            {
                                ...
                                Specs = Convert.ToString(idrCount["Specs"]),
                                HouseName = Convert.ToString(idrCount["HouseName"]),
                                HouseID = string.IsNullOrEmpty(Convert.ToString(idrCount["HouseID"])) ? 0 : Convert.ToInt32(idrCount["HouseID"]),
                                TypeID = Convert.ToInt32(idrCount["TypeID"]),
                                TypeName = Convert.ToString(idrCount["TypeName"]),
                                Piece = Convert.ToInt32(idrCount["Piece"]),
                                //DayStatisticsCount = Convert.ToInt32(idrCount["Count"]),
...
{(entity.SuppClientNum != 0 ? $@" and SuppClientNum='{entity.SuppClientNum}' " : "")}
    GROUP BY   c.TypeID, a.ProductCode), OrderStats AS 
    (SELECT h.TypeID,
    ...
    WHERE c.CreateDate >= '{entity.StartDate.ToString("yyyy-MM-dd")}'
           ...
           {(OrderType != "0" ? $@" and c.ThrowGood in({OrderType})" : "")}
{(entity.SuppClientNum != 0 ? $@" and h.SuppClientNum='{entity.SuppClientNum}' " : "")}
    GROUP BY  h.TypeID, ProductCode )
SELECT 
         a1.TypeID,
         a1.ProductCode,
         ps.ProductName,
...
ORDER BY  a2.UniqueClientCount desc, a1.ClickCount desc; 
      ";
        ...
        public List<CargoOrderDayStatisticsEntity> GetClickConversionRateDetailV2(CargoHouseAimEntity entity)
        {
            List<CargoOrderDayStatisticsEntity> result = new List<CargoOrderDayStatisticsEntity>();
            string strSQL = string.Empty;
            var OrderType = entity.OrderType == 23 ? "23,27" : entity.OrderType.ToString();
            strSQL = $@"
select a2.*,isnull(dd.UniqueClientCount,0) as UniqueClientCount,isnull(dd.UniqueClientNum,0) as UniqueClientNum from (
    select ROW_NUMBER() OVER (ORDER BY a.ProductCode,b.Specs,b.Figure DESC) AS RowNumber,
       cc.Name as HouseName,a.HouseID, a.ProductCode, b.TypeID, c.TypeName,
       b.Specs,ltrim(rtrim(b.Figure)) as Figure, ltrim(rtrim(b.LoadIndex)) as LoadIndex,ltrim(rtrim(b.SpeedLevel)) as SpeedLevel,count(1) as clickCount,d.ID as ClientID,d.CompanyName,d.Cellphone
from Tbl_Cargo_ProductAccessDetails as a
        ...
        inner join Tbl_WX_Client as d on a.wxOpenID = d.wxOpenID
where (1 = 1) {(entity.HouseID == 0 ? "" : $@" and a.HouseID={entity.HouseID}")}  {(entity.TypeID == 0 ? "" : $@" and b.TypeID={entity.TypeID}")}
  and a.AccessTime >='{entity.StartDate.ToString("yyyy-MM-dd")}'
  and a.AccessTime <'{entity.EndDate.AddDays(1).ToString("yyyy-MM-dd")}'
 and a.ProductCode='{entity.ProductCode}' and Specs='{entity.Specs}' and Figure='{entity.Figure}'
group by cc.Name,a.HouseID,a.ProductCode, b.TypeID,c.TypeName, b.Specs, b.Figure, b.LoadIndex, b.SpeedLevel,d.ID,d.CompanyName,d.Cellphone
              ) as a2
       left join (
             SELECT h.TypeID,
         c.HouseID,
         ProductCode,
         Specs,ltrim(rtrim(Figure)) Figure,ltrim(rtrim(LoadIndex)) as LoadIndex,ltrim(rtrim(SpeedLevel)) as SpeedLevel,
         COUNT(DISTINCT c.ID) AS UniqueClientCount,
         sum(case
        WHEN OrderModel = 1 THEN
        -orderGoods.Piece
        ELSE orderGoods.Piece end) AS UniqueClientNum,wc.CompanyName,wc.ID as ClientID
    FROM Tbl_WX_Order c
    INNER JOIN Tbl_Cargo_Order d
        ON c.OrderNo = d.WXOrderNo
    INNER JOIN Tbl_Cargo_OrderGoods orderGoods
    ...
    INNER JOIN Tbl_Cargo_Product h
        ON h.ProductID = orderGoods.ProductID
    inner join Tbl_WX_Client wc on c.WXID=wc.ID
    WHERE c.CreateDate >= '{entity.StartDate.ToString("yyyy-MM-dd")}' {(OrderType != "0" ? $@" and d.ThrowGood in({OrderType})" : "")}
            AND c.CreateDate < '{entity.EndDate.AddDays(1).ToString("yyyy-MM-dd")}'
            {(entity.HouseID == 0 ? "" : $@" and c.HouseID={entity.HouseID}")}  {(entity.TypeID == 0 ? "" : $@" and h.TypeID={entity.TypeID}")}
            and ProductCode='{entity.ProductCode}' and Specs='{entity.Specs}' and Figure='{entity.Figure}'
    GROUP BY  h.TypeID, c.HouseID, ProductCode,Specs,Figure,LoadIndex,SpeedLevel,wc.ID,wc.CompanyName
) as dd on a2.ProductCode=dd.ProductCode and dd.TypeID=a2.TypeID and dd.Specs=a2.Specs and a2.HouseID=dd.HouseID and a2.Figure=dd.Figure  and a2.ClientID=dd.ClientID
order by RowNumber
";
        ...
        public List<CargoOrderDayStatisticsEntity> GetLargeSpecRatioDetail(CargoHouseAimEntity entity)
        {
            ...
            if (entity.typeStr == "1")
            {
                strSQL = $@"
                select * from (
                SELECT ProductCode,b.TypeID, b.TypeName,Specs
...
,sum(case when ISNUMERIC(HubDiameter) = 1 and cast(HubDiameter as int)>=18 then (case when OrderModel=0 then orderGoods.Piece else -orderGoods.Piece end) end) BigSizeCount
                ...
                where  c.TypeID = @TypeID and a.HouseID = @HouseID and ISNUMERIC(HubDiameter) = 1
                  and a.CreateDate >= @StartDate
                  AND a.CreateDate <@EndDate  and CheckStatus=1 and a.FinanceSecondCheck=1 and a.OrderType = '4' {(entity.SuppClientNum != 0 ? $@" and c.SuppClientNum='{entity.SuppClientNum}'" : "")}
...
SELECT b.TypeID,
       ...
       a.Specs,
       a.ProductCode,
       SUM(b.Piece) AS GlobalProPiece
FROM Tbl_Cargo_Product a
         INNER JOIN Tbl_Cargo_ContainerGoods b ON a.ProductID = b.ProductID
         INNER JOIN Tbl_Cargo_Container c ON c.ContainerID = b.ContainerID
         INNER JOIN Tbl_Cargo_Area d ON c.AreaID = d.AreaID
         INNER JOIN Tbl_Cargo_Area g ON d.ParentID = g.AreaID
         INNER JOIN Tbl_Cargo_Area h ON g.ParentID = h.AreaID
         INNER JOIN Tbl_Cargo_ProductType ee ON a.TypeID = ee.TypeID
WHERE a.IsLockStock = '0'
  AND a.SpecsType <> 5
  AND h.IsShowStock = '0'  and a.OperaType<>0
  AND b.TypeID = @TypeID   -- 提前过滤
GROUP BY b.TypeID,ee.TypeName, a.Specs, a.ProductCode
HAVING SUM(b.Piece) = 0 -- 用 HAVING 替代外层 WHERE
            order by TypeID,ProductCode
      ";
            }
            else
            {
...
WHERE a.IsLockStock = '0'
  ...
  AND h.IsShowStock = '0'  and a.OperaType<>0
  AND b.TypeID = @TypeID   -- 提前过滤
  AND a.HouseID = @HouseID -- 提前过滤
  {(entity.SuppClientNum != 0 ? $@" and SuppClientNum='{entity.SuppClientNum}' " : "")}
GROUP BY b.TypeID, a.HouseID, e.Name, ee.TypeName, a.Specs, a.ProductCode
HAVING SUM(b.Piece) = 0 -- 用 HAVING 替代外层 WHERE
            order by TypeID,ProductCode
      ";
            }
...
WHERE a.IsLockStock = '0'
  AND a.SpecsType <> 5
  AND h.IsShowStock = '0'  and a.OperaType<>0 -- and isnull(ProductCode,'')<>''
  AND b.TypeID = @TypeID   -- 提前过滤
  {(entity.SuppClientNum != 0 ? $@" and SuppClientNum='{entity.SuppClientNum}' " : "")}
GROUP BY b.TypeID, ee.TypeName, a.Specs,a.GoodsCode, a.ProductCode
HAVING SUM(b.Piece) = 0 -- 用 HAVING 替代外层 WHERE
order by TypeID,ProductCode desc
      ";
        ...
        public List<CargoOrderDayStatisticsEntity> GetAllUserCount(CargoHouseAimEntity entity)
        {
            List<CargoOrderDayStatisticsEntity> result = new List<CargoOrderDayStatisticsEntity>();
            string strSQL = $@"

select aa.HouseID,a.ID,a.Name,a.Cellphone,a.CompanyName,sum(isnull(b.UniqueClientCount,0)) as UniqueClientCount,sum(isnull(b.UniqueClientNum,0)) as UniqueClientNum
     from Tbl_WX_Client as a
     inner join Tbl_Cargo_Client as aa on aa.ClientNum=a.ClientNum
left join (
    select WXID,COUNT(DISTINCT bb.OrderNo) AS UniqueClientCount,
     sum(case
    WHEN OrderModel = 1 THEN
    -bb.Piece
    ELSE bb.Piece end) AS UniqueClientNum from Tbl_WX_Order as aa
                inner join Tbl_Cargo_Order as bb on aa.OrderNo=bb.WXOrderNo
       WHERE bb.CreateDate >= '{entity.StartDate.ToString("yyyy-MM-dd")}'
        AND bb.CreateDate < '{entity.EndDate.AddDays(1).AddMilliseconds(-1).ToString("yyyy-MM-dd HH:mm:ss")}'
             group by WXID
     ) as b on a.ID=b.WXID
where aa.HouseID={entity.HouseID}
group by aa.HouseID,a.ID,a.Name,a.Cellphone,a.CompanyName
      ";
            ...
            using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
            {
                using (DataTable dt = conn.ExecuteDataTable(cmd))
                {
                    foreach (DataRow idrCount in dt.Rows)
                    {
                        result.Add(new CargoOrderDayStatisticsEntity
                        {
                            UserName = Convert.ToString(idrCount["Name"]),
                            Cellphone = Convert.ToString(idrCount["Cellphone"]),
                            CompanyName = Convert.ToString(idrCount["CompanyName"]),
                            UniqueClientCount = Convert.ToInt32(idrCount["UniqueClientCount"]),
                            UniqueClientNum = Convert.ToInt32(idrCount["UniqueClientNum"]),
        ...
        public List<CargoOrderDayStatisticsEntity> QueryHCYC_TotalDays(CargoHouseAimEntity entity)
        {
            ...
            var OrderType = entity.OrderType == 23 ? "23,27" : entity.OrderType.ToString();
            string strSQL = $@"
            select Year,Month,Day,sum(case when OrderModel=0 then Piece else -Piece end) as Piece, isnull(AimQuantity,0) as AimQuantity
            from Tbl_Cargo_OrderDayStatistics as a
            left join (
...
group by a.HouseID
  ...
  , SaleData as (select a.HouseID,
   ...
   , InventoryData as (select e.HouseID
                       ...
                       from Tbl_Cargo_Product as a
                                ...
                                inner join Tbl_Cargo_Area as d on c.AreaID = d.AreaID
                                inner join Tbl_Cargo_House as e on d.HouseID = e.HouseID
                       where a.InCargoStatus in (1, 2) and IsLockStock = '0' AND A.SpecsType<>5
                       group by e.HouseID)
          --用户交易数据
          ,UserTransaction as (
               select Clients.HouseID, COUNT(DISTINCT wxClients.ID) AS UserUniqueClientCount
             , COUNT(DISTINCT wxClients.ClientNum) AS StoresUniqueClientCount 
                    from Tbl_Cargo_Order as a
                   inner join Tbl_WX_Order as wxOrder on wxOrder.OrderNo = a.WXOrderNo
                   inner join Tbl_WX_Client as wxClients on wxClients.ID = wxOrder.WXID
                   inner join Tbl_Cargo_Client as Clients on wxClients.ClientNum = Clients.ClientNum
                where  a.CreateDate >= @StartDate and a.CreateDate <= @EndDate  and a.OrderType = '4'  {(OrderType == "0" ? "" : $@" and a.ThrowGood  in({OrderType})")}
                group by Clients.HouseID
          )
        --数据汇总
  , ReusltData as (select orders.HouseID, count(distinct case when OrderModel = 0 then orders.OrderNo end) as OrderCount , count(distinct case when OrderModel = 0 then ProductCode end) as DayStatisticsCount
                    ...
                    where orders.CreateDate >= @StartDate and orders.CreateDate <= @EndDate  and orders.OrderType = '4'  {(OrderType == "0" ? "" : $@" and ThrowGood  in({OrderType})")}
      ...
      ";
        ...
        public List<CargoOrderDayStatisticsEntity> QueryHCYC_TypeBrowseData(CargoHouseAimEntity entity)
        {
            var OrderType = entity.OrderType == 23 ? $@"23,27" : entity.OrderType.ToString();
            List<CargoOrderDayStatisticsEntity> result = new List<CargoOrderDayStatisticsEntity>();
            string strSQL = $@"
select a2.*,isnull(dd.UniqueClientCount,0) as UniqueClientCount,isnull(dd.UniqueClientNum,0) as UniqueClientNum from (
    select ROW_NUMBER() OVER (ORDER BY a.ProductCode,b.Specs,b.Figure DESC) AS RowNumber,
       a.ProductCode, b.TypeID, c.TypeName,
       b.Specs,ltrim(rtrim(b.Figure)) as Figure, ltrim(rtrim(b.LoadIndex)) as LoadIndex,ltrim(rtrim(b.SpeedLevel)) as SpeedLevel,count(1) as clickCount
from Tbl_Cargo_ProductAccessDetails as a
         inner join Tbl_Cargo_ProductSpec as b on a.ProductCode = b.ProductCode
         inner join Tbl_Cargo_ProductType as c on b.TypeID = c.TypeID
         inner join Tbl_Cargo_House as cc on a.HouseID = cc.HouseID
where (1 = 1) {(entity.TypeID != 0 ? $@" and b.TypeID={entity.TypeID}" : "")} {(entity.HouseID != 0 ? $@" and a.HouseID=@HouseID" : "")}
  and a.AccessTime >= @StartDate
  and a.AccessTime <= @EndDate
group by a.ProductCode, b.TypeID,c.TypeName, b.Specs, b.Figure, b.LoadIndex, b.SpeedLevel
              ) as a2
       left join (
             SELECT h.TypeID,
         ProductCode,
    ...
    INNER JOIN Tbl_Cargo_Product h
        ON h.ProductID = orderGoods.ProductID
    WHERE c.CreateDate >= @StartDate
            AND c.CreateDate < @EndDate {(OrderType != "0" ? $@" and d.ThrowGood in({OrderType})" : "")}
{(entity.TypeID != 0 ? $@" and h.TypeID={entity.TypeID}" : "")}
{(entity.HouseID != 0 ? $@" and c.HouseID=@HouseID" : "")}
    GROUP BY  h.TypeID, ProductCode,Specs,Figure,LoadIndex,SpeedLevel
) as dd on a2.ProductCode=dd.ProductCode and dd.TypeID=a2.TypeID and dd.Specs=a2.Specs and a2.Figure=dd.Figure
order by RowNumber
      ...
      ";
            ...
            using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
            {
                ...
                using (DataTable dt = conn.ExecuteDataTable(cmd))
                {
                    foreach (DataRow idrCount in dt.Rows)
                    {
                        result.Add(new CargoOrderDayStatisticsEntity
                        {
                            clickCount = string.IsNullOrEmpty(Convert.ToString(idrCount["clickCount"])) ? 0 : Convert.ToInt32(idrCount["clickCount"]),
                            SpeedLevel = Convert.ToString(idrCount["SpeedLevel"]),
                            LoadIndex = Convert.ToString(idrCount["LoadIndex"]),
                            Figure = Convert.ToString(idrCount["Figure"]),
                            Specs = Convert.ToString(idrCount["Specs"]),
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public List<CargoOrderDayStatisticsEntity> QueryHCYC_BrandDataV2(CargoHouseAimEntity entity)
        {
            List<CargoOrderDayStatisticsEntity> result = new List<CargoOrderDayStatisticsEntity>();
...
;with BaseOrders as (
    ...
    inner join Tbl_Cargo_OrderGoods og on o.OrderNo = og.OrderNo
    inner join Tbl_Cargo_Product p on og.ProductID = p.ProductID
    where  o.CreateDate >= '{entity.StartDate.ToString("yyyy-MM-dd")}'  and OrderType=4
      and o.CreateDate <= '{entity.EndDate.AddDays(1).AddMilliseconds(-1).ToString("yyyy-MM-dd HH:mm:ss")}'
{(OrderType != "0" ? $@" and ThrowGood in({OrderType})" : "")} 
)
, OrderStats as (
...
, ClickStats as (
    select --a.HouseID,
           c.TypeID, count(1) as ClickCount
    from Tbl_Cargo_ProductAccessDetails a
    inner join Tbl_WX_Client b on a.wxOpenID = b.wxOpenID
    inner join Tbl_Cargo_ProductSpec c on a.ProductCode = c.ProductCode
    where  a.AccessTime >= '{entity.StartDate.ToString("yyyy-MM-dd")}'
      and a.AccessTime <= '{entity.EndDate.AddDays(1).AddMilliseconds(-1).ToString("yyyy-MM-dd HH:mm:ss")}'
    group by c.TypeID--a.HouseID,
)
select
    a2.*,
    isnull(d.StockNum, 0) as StockNum,
...
from (
    ...
    {(entity.SuppClientNum != 0 ? $@" and a.SuppID=@SuppID" : "")}
{(OrderType != "0" ? $@" and ThrowGood in({OrderType})" : "")} 
    group by a.TypeID, b.TypeName--, c.Name, a.HouseID
) a2
left join (
    select --HouseID,
           TypeID, count(distinct ProductCode) as StockNum
    from Tbl_Cargo_SafeStock
    group by  TypeID--HouseID,
) d on a2.TypeID = d.TypeID --and a2.HouseID = d.HouseID
left join (
...
select
    ...
    inner join Tbl_Cargo_Area as h on g.ParentID = h.AreaID
--     inner join Tbl_Cargo_House as e on d.HouseID = e.HouseID
    where a.IsLockStock = '0' and a.SpecsType <> 5 and h.IsShowStock = '0'  and a.OperaType<>0  and isnull(ProductCode,'')<>''
    group by  b.TypeID,ProductCode
              ) a2
where 1=1
    group by TypeID
