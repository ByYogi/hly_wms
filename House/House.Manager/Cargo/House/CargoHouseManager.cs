...
left join Tbl_Cargo_Area as b on a.AreaID=b.AreaID where a.ContainerType=@ContainerType and b.HouseID=@HouseID";
        ...
        public int SaveStockTake(CargoStockTakeEntity entity, string genType)
        {
            ...
            if (!isFull) { strSQL += " where a.Take_DATE IS NULL OR a.Take_DATE < COALESCE(a.Piece_DATE, a.OP_DATE)"; }
            ...
            string strTag = "select " + StockID + ",a.ProductID,g.TagCode,a.ContainerID from Tbl_Cargo_ContainerGoods as a inner join Tbl_Cargo_Container as b on a.ContainerID = b.ContainerID and a.Piece > 0 inner join Tbl_Cargo_Area as c on b.AreaID = c.AreaID ";
            ...
            if (!isFull) { strTag += " where a.Take_DATE IS NULL OR a.Take_DATE < COALESCE(a.Piece_DATE, a.OP_DATE)"; }
            ...
            using (DbCommand cmdTag = conn.GetSqlStringCommond(strTagInsert + strTag))
            {
