...
namespace House.Manager.Cargo
{
    ...
    public class CargoRealFactoryPurchaseOrderManager
    {
        ...
        public void AddRealPurchaseOrder(CargoRealFactoryPurchaseOrderEntity entity)
        {
            ...
            string strSQL = "INSERT INTO Tbl_Cargo_RealFactoryPurchaseOrder(PurOrderNo, Piece, ReplyNum, TransportFee, OtherFee, TotalCharge, WhetherTax, CheckStatus, Remark, PurchaserID, DeliveryAddress, DeliveryTelephone, DeliveryBoss, DeliveryCellphone, DeliveryCity, DeliveryCountry, DeliveryProvince, PurchaseType, PurchaseInStoreType, CreateAwbID, CreateAwb, CreateDate, OP_ID, OP_DATE, ApplyID, ApplyName, ApplyDate, NextCheckID, NextCheckName,  ApplyStatus,PurDepartID,PurDepart,BusinessID,PaymentMethod,TransferAccount) VALUES (@PurOrderNo, @Piece, @ReplyNum, @TransportFee, @OtherFee, @TotalCharge, @WhetherTax, @CheckStatus, @Remark, @PurchaserID, @DeliveryAddress, @DeliveryTelephone, @DeliveryBoss, @DeliveryCellphone, @DeliveryCity, @DeliveryCountry, @DeliveryProvince, @PurchaseType, @PurchaseInStoreType, @CreateAwbID, @CreateAwb, @CreateDate, @OP_ID, @OP_DATE, @ApplyID, @ApplyName, @ApplyDate, @NextCheckID,@NextCheckName,  @ApplyStatus,@PurDepartID,@PurDepart,@BusinessID,@PaymentMethod,@TransferAccount) SELECT @@IDENTITY";
            #region 订单保存
            entity.EnSafe();
