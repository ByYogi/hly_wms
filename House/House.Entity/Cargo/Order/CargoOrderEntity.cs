...
{
    /// <summary>
    /// 订单数据实体1.4.1.Tbl_Cargo_Order（订单表）
    /// </summary>
    [Serializable]
    public class CargoOrderEntity
    {
        public string HouseCellphone { get; set; }
        /// <summary>
        /// 原订单仓库ID
        /// </summary>
        public int OrignHouseID { get; set; }
        public string OrignHouseName { get; set; }
        /// <summary>
        /// 共享仓库ID
        /// </summary>
        ...
        /// </summary>
        [Description("马牌商品金额")]
        public decimal ContiOrderAmount { get; set; }
        /// <summary>
        /// 使用返利总金额
        /// </summary>
        [Description("返利抵扣")]
        public decimal BateAmount { get; set; }
        /// <summary>
        /// 在线支付金额
        /// </summary>
        [Description("在线支付")]
        ...
        public int BatchWeekFilter { get; set; }
        /// <summary>
        /// 产品关联实体
        /// </summary>
        ...
        /// </summary>
        [Description("改价申请")]
        public string ModifyPriceStatus { get; set; }
        /// <summary>
        /// 优惠券表ID
        /// </summary>
        [Description("优惠券ID")]
        ...
        /// 优惠券表ID数组列表
        /// </summary>
        public List<long> CouponIDList { get; set; }
        /// <summary>
        /// 是否APP商城首单 0：否1：是
        /// </summary>
        ...
        /// 推迟发货
        /// </summary>
        public string PostponeShip { get; set; }
        /// <summary>
        /// 出库完成时间
        /// </summary>
        ...
        public int PurchaseHouseID { get; set; }
        [Description("进仓单号")]
        ...
        /// </summary>
        [Description("供应商名称")]
        public string SuppClientName { get; set; }
        public string SourceName { get; set; }
        public string TakeOrderName { get; set; }
        public DateTime TakeOrderTime { get; set; }
        public string SendCarName { get; set; }
        public DateTime SendCarTime { get; set; }

        public string OpenOrderNo { get; set; }
        public string OpenOrderSource { get; set; }
       ...
       /// </summary>
        ...
        /// 是否退运费
        /// </summary>
        public int IsTransitFee { get; set; }
        ...
        /// <summary>
        /// 销售类型 0 OES ；1 大客户； 2云仓；
        /// </summary>
        public string MarketType { get; set; }
        public string proStr { get; set; }
        //public string Supplier { get; set; }
        public SystemUserEntity UserInfor { get; set; }

        public List<CargoContainerShowEntity> ContainerShowEntity { get; set; }
        public List<CargoProductEntity> productsList { get; set; }
        /// <summary>
        /// 去NULL,替换危险字符
        /// </summary>
        public void EnSafe()
        ...
        /// 马牌来货单号（临时变量）
        /// </summary>
        public string HorseFacOrderNo { get; set; }
        public int IsReserve { get; set; }
    }

    public class OrderStatusReturnEntity
    {
        public string HtmlStr { get; set; }
        public string HtmlStr2 { get; set; }
    ...
    /// 缺货列表实体
    /// </summary>
    public class ShortageListEntity
    {
        [Description("表主键")]
        ...
        public DateTime StartDate { get; set; }
        public DateTime EndDate { get; set; }
        public string PermissionHouseID { get; set; }
        /// <summary>
        /// 去NULL,替换危险字符
        /// </summary>
        public void EnSafe()
    ...
    /// 好来运出货计划明细实体
    /// </summary>
    public class HLYAddPlanOutOrderDetails
    {
        /// <summary>
        /// 供应商代码 固定DLQF
        /// </summary>
    ...
    /// 好来运出货计划实体
    /// </summary>
    public class HLYAddPlanOutOrder
    {
        /// <summary>
        /// 部门编码
        /// </summary>
        ...
        /// 客户编码
        /// </summary>
        public int ToGuestID { get; set; }
        /// <summary>
        /// 收货单位
        /// </summary>
        public string ToGuestName { get; set; }
        /// <summary>
        /// 收货人
        /// </summary>
        ...
        /// 订单详情
        /// </summary>
        public List<HLYAddPlanOutOrderDetails> details { get; set; }
    }
    /// <summary>
    /// 好来运出货计划返回实体
    /// </summary>
    public class HLYAddPlanOutOrderReturn
    {
        public bool State { get; set; }
        public string Errcode { get; set; }
        public string Errmsg { get; set; }
        public HLYAddPlanOutOrderReturnData data { get; set; }
    }
    public class HLYAddPlanOutOrderReturnData
    {
        public string PlanOrderNo { get; set; }
        public string Awbno { get; set; }
    }
    public class HLYgetByOrderNoReturn
    {
        public bool State { get; set; }
        public string Errcode { get; set; }
        public string Errmsg { get; set; }
    }
    public class HLYAddAwbnoForCargo
    {

    }
    public class HLYAddAwbnoForCargoSubawb
    {
        /// <summary>
        /// 订单号
        /// </summary>
        public string AwbnoClient { get; set; }
        /// <summary>
        /// 订单号
        /// </summary>
        public string AgentAwbno { get; set; }
        /// <summary>
        /// 出发站
        /// </summary>
        public string FDep { get; set; }
        ...
        /// 金额大写
        /// </summary>
        public string GrossCap { get; set; }
        /// <summary>
        /// 操作人姓名
        /// </summary>
        public string FrmGuestName { get; set; }
        /// <summary>
        /// 操作人姓名
        /// </summary>
    ...
    public class HLYAddAwbnoForCargoSubawbDetailProducts
    {
        /// <summary>
        /// 产品名称小类+大类
        /// </summary>
    ...
    public class HLYAddAwbnoForCargoWHOutOrder
    {
        /// <summary>
        /// 订单来源 : 0 普通来货单 1调拨来货单 2预留单 3退货单默认0
        /// </summary>
        public int OrderSourceID { get; set; }
        /// <summary>
        /// 仓储类型 0=生产仓储 1=售后仓储默认1
        /// </summary>
        public int StoreType { get; set; }
        /// <summary>
        /// 仓库代码
        ...
        public string OrderNo { get; set; }
        /// <summary>
        /// 开单方式 0=直接开单 1=计划单生成 2=PDA备货开单默认3
        /// </summary>
        public string InputType { get; set; }
        /// <summary>
        /// 订单类型 0=正常订单，1=紧急订单默认0
        /// </summary>
        public string OrderType { get; set; }
        /// <summary>
        /// 客户订单类型 固定ZS01
        ...
        /// 客户订单名称 固定售后常规销售订单
        /// </summary>
        public string COrderTypeName { get; set; }
        /// <summary>
        /// 当前时间
        /// </summary>
    ...
    public class HLYAddAwbnoForCargoWHOutOrderDetails
    {
        /// <summary>
        /// 件数
        /// </summary>
    ...
    public class HLYAddReceipt
    {
        ...
        /// 仓库ID
        /// </summary>
        public int CargoHouseID { get; set; }
        /// <summary>
        /// 仓库代码
        /// </summary>
        public string HouseCode { get; set; }
        ...
        /// 预计收货日期
        /// </summary>
        public string ReceiptDatePlan { get; set; }
        /// <summary>
        /// 产品来源
        /// </summary>
        ...
        /// 来货详情
        /// </summary>
        public List<HLYAddReceiptDetails> details { get; set; }
    }
    /// <summary>
    /// 好来运来货导入详细实体
    /// </summary>
    public class HLYAddReceiptDetails
    {
        /// <summary>
        /// 货品代码
        /// </summary>
    ...
    public class HLYAddReceiptReturn
    {
        public bool State { get; set; }
        public string Errcode { get; set; }
        public string Errmsg { get; set; }
        public HLYAddReceiptReturnData data { get; set; }
    }
    public class HLYAddReceiptReturnData
    {
        public List<HLYAddReceiptReturnDataDetails> details { get; set; }
    }
    public class HLYAddReceiptReturnDataDetails
    {
    ...
    public class CargoReturnOrderEntity: CargoOrderEntity
    {
    ...
    [Serializable]
    public class ReserveCargoOrderEntity
    {
