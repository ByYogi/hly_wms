<%@ Page Title="系统管理" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SystemSet.aspx.cs" Inherits="House.SystemSet" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#dg').datagrid({
                ...
                toolbar: '#toolbar',
                columns: [[
                  { title: '', field: 'HouseID', checkbox: true, width: '30px' },
                  { title: '系统名称', field: 'HouseName', width: '150px' },
                  { title: '系统代码', field: 'HouseCode', width: '80px' },
                  { title: '系统联系人', field: 'Person', width: '120px' },
                  { title: '联系人电话', field: 'Cellphone', width: '120px' },
                  { title: 'QQ号', field: 'QQ', width: '120px' },
                  { title: '微信号', field: 'Weixin', width: '120px' },
                  { title: '邮箱地址', field: 'Email', width: '100px' },
                  { title: '备注', field: 'Remark', width: '100px' },
                  {
        ...
        function dosearch() {
            ...
            gridOpts.url = 'sysService.aspx?method=QueryHouse';
            $('#dg').datagrid('load', {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div id="saPanel" class="easyui-panel" title="" data-options="iconCls:'icon-search'">
                    <table>
                        <tr>
                            <td style="text-align: right;">系统名称:
                            </td>
                            <td>
                                <input id="HouseName" class="easyui-textbox" data-options="prompt:'请输入系统名称'" style="width: 100px">
                            </td>
                            <td style="text-align: right;">系统代码:
                            </td>
                            <td>
                                <input id="HouseCode" class="easyui-textbox" data-options="prompt:'请输入系统代码'" style="width: 100px">
                            </td>
                ...
                <div id="dlg" class="easyui-dialog" style="width: 450px; height: 400px; padding: 10px 10px"
                    ...
                    <form id="fm" class="easyui-form" method="post">
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <input name="HouseName" class="easyui-textbox" data-options="prompt:'请输入系统名称',required:true"
                                        style="width: 250px;">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input name="HouseCode" class="easyui-textbox" data-options="prompt:'请输入系统代码'" style="width: 250px;">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input name="Person" class="easyui-textbox" data-options="prompt:'请输入系统联系人'" style="width: 250px;">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="text-align: right;">QQ号:
                                </td>
                                <td>
                                    <input name="QQ" class="easyui-textbox" data-options="prompt:'请输入QQ号'" style="width: 250px;">
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: right;">微信号:
                                </td>
                                <td>
                                    <input name="Weixin" class="easyui-textbox" data-options="prompt:'请输入微信号'" style="width: 250px;">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input name="Email" class="easyui-textbox" data-options="prompt:'请输入邮箱地址'" style="width: 250px;">
                                </td>
                            </tr>
                            <tr>
    ...
    <script type="text/javascript">
        //新增系统数据信息
        function addItem() {
            $('#dlg').dialog('open').dialog('setTitle', '新增系统数据');
            $('#fm').form('clear');
        ...
        function saveHouse() {
            $('#fm').form('submit', {
                url: 'sysService.aspx?method=saveHouse',
                onSubmit: function () {
        ...
        function editItem() {
            ...
            if (row) {
                $('#dlg').dialog('open').dialog('setTitle', '修改系统数据');
                $('#fm').form('load', row);
                $('#DelFlag').combobox('textbox').bind('focus', function () { $('#DelFlag').combobox('showPanel'); });
            }
        }
        ...
        function DelItem() {
            ...
            $.messager.confirm('<%= House.Common.GetSystemNameAndVersion()%>', '确定删除？', function (r) {
                if (r) {
                    ...
                    $.ajax({
                        url: 'sysService.aspx?method=DelHouse',
