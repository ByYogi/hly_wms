<%@ Page Title="仓库退货明细" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HouseReturnDetails.aspx.cs" Inherits="Supplier.Report.HouseReturnDetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            columns.push({
                title: '退货单号', field: 'FacOrderNo', width: '8%', formatter: function (value) {
            ...
            columns.push({
                title: '退仓数量', field: 'Piece', width: '8%', formatter: function (value) {
                    return "<span title='" + value + "'>" + value + "</span>";
                }
            });
            columns.push({
                title: '成本单价', field: 'CostPrice', width: '8%', formatter: function (value) {
                    return "<span title='" + value + "'>" + value + "</span>";
                }
            });
            columns.push({
                title: '成本金额', field: 'CostPrices', width: '8%', formatter: function (value, row) {
                    return "<span title='" + row.CostPrice * row.Piece + "'>" + row.CostPrice * row.Piece + "</span>";
                }
            });
            columns.push({
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="saPanel" name="SelectDiv1" class="easyui-panel" title="" data-options="iconCls:'icon-search'" style="width: 100%">
        <table>
            <tr>
                <td style="text-align: right;">退仓单号:
                </td>
                <td>
                    <input id="AFacOrderNo" class="easyui-textbox" data-options="prompt:'请输入退仓单号'" style="width: 100px" />
                </td>
