<%@ Page Title="次日达退货明细" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NextDayReturnDetails.aspx.cs" Inherits="Supplier.Report.NextDayReturnDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#dg').datagrid({
                ...
                columns: [[
                    ...
                    { title: '时间', field: 'OP_DATE', width: '130px', formatter: DateTimeFormatter },
                    {
                        title: '客户名称', field: 'AcceptUnit', width: '180px', formatter: function (value) {
                    ...
                    {
                        title: '所在仓库', field: 'HouseName', width: '100px', formatter: function (value) {
                            return "<span title='" + value + "'>" + value + "</span>";
                        }
                    },
                    {
                    ...
                    { title: '数量', field: 'Piece', width: '80px', },
                    { title: '成本单价', field: 'CostPrice', width: '90px', },//CostPrice
                    { title: '总成本', field: 'TotalCostPrice', width: '80px', },//CostPrice * Piece
                    { title: '销售单价', field: 'SalePrice', width: '90px', },
                    { title: '销售额', field: 'ActSalePrice', width: '80px', },
                ]],
        ...
        function dosearch() {
            ...
            gridOpts.url = 'reportApi.aspx?method=QueryNextDayReturnDetails';
            $('#dg').datagrid('load', {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function exportData() {
            ...
            $.ajax({
                url: "reportApi.aspx?method=QueryNextDayOrderDetailsExport&SID=" + $("#ASID").combobox('getValue') +
