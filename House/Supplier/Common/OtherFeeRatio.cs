...
namespace Supplier
{
    ...
    public class OtherFeeRatio
    {
        ...
        public static double Ratio(int id)
        {
            ...
            try
            {
                ...
                {
                    return ratioModel?.OtherRatio ?? 0.025;
                }
        ...
        public static double RatioName(string name)
        {
            string dutyRosterJson = RedisHelper.GetString("OtherFeeRatio");
            ...
            try
            {
                ...
                RatioItemModel matchedItem = ratioModel.Data.Find(item => item.Name == name);
                return matchedItem != null ? matchedItem.Ratio : ratioModel.OtherRatio;
            }
            catch (Exception ex)
            {
