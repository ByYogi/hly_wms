...
namespace HLYEagle
{
    ...
    public static class CookiesHelper
    {
        ...
        public static void SingIn(SystemUserEntity user, bool IsRememberPwd)
        {
            try
            {
                HttpCookie clientCookie = new HttpCookie("UserInfo");
                clientCookie.Values.Add("UserID", user.LoginName.Trim());
                clientCookie.Values.Add("UserName", user.UserName.Trim());
