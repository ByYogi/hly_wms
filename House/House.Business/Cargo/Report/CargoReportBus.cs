...
namespace House.Business.Cargo
{
    ...
    public class CargoReportBus
    {
        ...
        {
            return man.QueryReportCityAgeingSet(pIndex, pNum, entity);
        }
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void DelReportCityAgeingSet(List<CargoReportCityAgeingSetEntity> entity, LogEntity log)
        {
            LogWrite<CargoReportCityAgeingSetEntity> lw = new LogWrite<CargoReportCityAgeingSetEntity>();
            //使用事务
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required))
            {
                try
                {
                    man.DelReportCityAgeingSet(entity);
                    foreach (var it in entity)
                    {
                        log.Memo = "作废时效配置：出发省：" + it.DepProvince + "，出发城市：" + it.DepCity + "，到达省：" + it.DestProvince + "，到达城市：" + it.DestCity;
                        lw.WriteLog(log);
                    }
                    scope.Complete();
                }
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void AddReportCityAgeingSet(CargoReportCityAgeingSetEntity entity, LogEntity log)
        {
            LogWrite<CargoReportCityAgeingSetEntity> lw = new LogWrite<CargoReportCityAgeingSetEntity>();
            //使用事务
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required))
            {
                try
                {
                    man.AddReportCityAgeingSet(entity);
                    log.Memo = "新增时效配置：出发省：" + entity.DepProvince + "，出发城市：" + entity.DepCity + "，到达省：" + entity.DestProvince + "，到达城市：" + entity.DestCity;
                    lw.WriteLog(log);
                    scope.Complete();
                }
                catch (ApplicationException ex)
        ...
        public void UpdateReportCityAgeingSet(CargoReportCityAgeingSetEntity entity, LogEntity log)
        {
            LogWrite<CargoReportCityAgeingSetEntity> lw = new LogWrite<CargoReportCityAgeingSetEntity>();
            //使用事务
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required))
            {
                try
                {
                    man.UpdateReportCityAgeingSet(entity);
                    log.Memo = "修改时效配置：出发省：" + entity.DepProvince + "，出发城市：" + entity.DepCity + "，到达省：" + entity.DestProvince + "，到达城市：" + entity.DestCity;
                    lw.WriteLog(log);
                    scope.Complete();
                }
                catch (ApplicationException ex)
        ...
        public List<CargoOrderDayStatisticsEntity> QueryHCYC_BrandData(CargoHouseAimEntity entity)
        {
            ...
            List<CargoOrderDayStatisticsEntity> List = new List<CargoOrderDayStatisticsEntity>();
            if (entity.typeStr == "0")
            {
                List = man.QueryHCYC_BrandData(entity);
            }
            else
            {
                List = man.QueryHCYC_BrandDataV2(entity);
            }
            ...
            foreach (var item in List)
            {
                ...
                if (item.ProPiece > 0 && item.OverduePiece > 0)
                    item.OverdueProCountRate = Math.Round((Convert.ToDouble(item.OverduePiece)) / Convert.ToDouble(item.ProPiece) * 100, 1);
            }
            #endregion
        ...
        public List<CargoOrderDayStatisticsEntity> GetClickConversionRateDetailV2(CargoHouseAimEntity entity)
        {
            ...
            List<CargoOrderDayStatisticsEntity> List = man.GetClickConversionRateDetailV2(entity);
            return List;
            #endregion
        }
        ...
        public List<CargoOrderDayStatisticsEntity> GetAllUserCount(CargoHouseAimEntity entity)
        {
            ...
            List<CargoOrderDayStatisticsEntity> List = man.GetAllUserCount(entity);
            return List;
            #endregion
        }
        ...
        public List<CargoOrderDayStatisticsEntity> QueryHCYC_TypeBrowseData(CargoHouseAimEntity entity)
        {
            ...
            List<CargoOrderDayStatisticsEntity> List = man.QueryHCYC_TypeBrowseData(entity);
