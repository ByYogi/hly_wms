...
namespace House.Business.Cargo
{
    ...
    public class CargoProductBus
    {
        ...
        /// 查询产品数据
        /// </summary>
        /// <param name="productIDs">产品ID数组</param>
        /// <returns></returns>
        public List<CargoProductEntity> QueryProductByIDs(long[] productIDs)
        {
            return man.QueryProductByIDs(productIDs);
        }

        /// <summary>
        /// 查询产品数据
        /// </summary>
        /// <param name="productIDs">产品Code数组</param>
        /// <returns></returns>
        public List<CargoProductEntity> QueryProductByCodes(string[] productCodes)
        {
            return man.QueryProductByCodes(productCodes);
        }
        #region 集采上架
