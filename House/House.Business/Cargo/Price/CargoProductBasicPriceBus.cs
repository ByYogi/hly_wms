...
namespace House.Business.Cargo
{
    public class CargoProductBasicPriceBus
    {
        ...
        public void SaveProductBasicPriceData(List<CargoProductBasicPriceEntity> entity, LogEntity log)
        {
            ...
            //{
            //    Timeout = TimeSpan.FromMinutes(5) // 根据实际SQL调整
            //};
        ...
        /// <param name="entity"></param>
        /// <param name="log"></param>
        public void SynchronizePriceBasic(List<CargoProductBasicPriceEntity> entity, LogEntity log, bool IsSyncLocalWarehouse = false)
        {
            LogWrite<CargoProductBasicPriceEntity> lw = new LogWrite<CargoProductBasicPriceEntity>();
            //var options = new TransactionOptions
            //{
            ...
            try
            {
                ...
                man.SynchronizePriceBasic(entity, IsSyncLocalWarehouse);
        ...
        {
            man.BatchUpPrice(entity);
        }

        public CargoProductBasicPriceEntity QueryBasicPriceData(CargoProductBasicPriceEntity priceEntity)
        {
