...
Page({
  ...
  async getUserApiInfo() {
    ...
    if (res.code == 0) {
      ...
      _data.nick = res.data._base.nick
      _data.mobile=res.data._base.mobile
      _data.avatarUrl = res.data._base.avatarUrl
      if (!res.data._base.gender) {
        _data.gender = '未知'
      }
      if (res.data._base.gender == 1) {
        _data.gender = '男性'
      }
      if (res.data._base.gender == 2) {
        _data.gender = '女性'
      }
