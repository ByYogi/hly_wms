<%@ Page Language="C#" Title="即日达退货明细" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ToDayReturnDetails.aspx.cs" Inherits="Supplier.Report.ToDayReturnDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        function dosearch() {
            ...
            gridOpts.url = 'reportApi.aspx?method=QueryToDayReturnDetails';
            $('#dg').datagrid('load', {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function exportData() {
            ...
            $.ajax({
                url: "reportApi.aspx?method=QueryToDayOrderDetailsExport&SID=" + $("#ASID").combobox('getValue') +
