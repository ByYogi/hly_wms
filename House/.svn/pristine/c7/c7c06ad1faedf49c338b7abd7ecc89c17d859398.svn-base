...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="saPanel" name="SelectDiv1" class="easyui-panel" title="" data-options="iconCls:'icon-search'" style="width: 100%">
        <table id="saPanelTab">
            <tr>
                ...
                <td>
                    <select class="easyui-combobox" id="StockType" style="width: 80px;" panelheight="auto">
            ...
            <tr>
                ...
                <td>
                    <select class="easyui-combobox" id="OrderHandleType" style="width: 80px;" panelheight="auto">
                        <option value="-1">全部</option>
    ...
    <div id="toolbar">
        ...
        <a href="#" class="easyui-linkbutton" iconcls="icon-application_view_list" plain="false" onclick="saveExter()" id="btnSaveExter">&nbsp;生成清单列表&nbsp;</a>&nbsp;&nbsp;
