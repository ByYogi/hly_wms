...
{
    public partial class HouseReturnDetails : BasePage
    {
        ...
        protected void btnDerived_Click(object sender, EventArgs e)
        {
            ...
            table.Columns.Add("退仓单号", typeof(string));
            ...
            table.Columns.Add("退仓数量", typeof(string));
            ...
            ToExcel.DataTableToExcel(table, "", "退仓单明细" + DateTime.Now.ToString("yyyyMMdd"));
        }
    }
}