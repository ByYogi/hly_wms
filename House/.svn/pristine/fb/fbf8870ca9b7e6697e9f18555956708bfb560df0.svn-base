<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qyOrderSign.aspx.cs" Inherits="Cargo.QY.qyOrderSign" %>
        ...
        <div class="weui-pay-m">
            <li class="weui-pay-order">
                <dl class="weui-pay-line">
                    <dd class="weui-pay-name" style="text-align: center; font-size: 17px;">上传订单签收照片</dd>
                ...
                <dl class="weui-pay-line">
                    <dt class="weui-pay-label">条 数：</dt>
                    <dd class="weui-pay-e">
                        <asp:Literal ID="ltlPiece" runat="server"></asp:Literal>&nbsp;&nbsp;条</dd>
                </dl>
                <dl class="weui-pay-line">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#btnSubmit').on('click', function () {
                ...
                $.showLoading();
                $.ajax({
                    url: 'qyServices.aspx?method=AddOrderSign',
                    type: 'post', dataType: 'json', data: { "OrderID": "<%=order.OrderID%>", "OrderNo": "<%=order.OrderNo%>", "MediaID": her.iid.toString() },
