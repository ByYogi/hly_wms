...
{
    public partial class NextDayReturnDetails : BasePage
    {
        /// <summary>
        /// 导出次日达退货明细
        /// </summary>
        ...
        {
            if (QueryNextDayReturnDetailsList.Count <= 0) { return; }
            ...
            int i = 0;
            foreach (var it in QueryNextDayReturnDetailsList)
            {
                i++;
            ...
            ToExcel.DataTableToExcel(table, "", "次日达退货明细明细数据表" + DateTime.Now.ToString("yyyyMMdd"));
        }
