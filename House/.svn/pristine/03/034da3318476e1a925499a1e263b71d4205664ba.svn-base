...
namespace House.Manager.Cargo
{
    ...
    public class CargoHouseManager
    {
        ...
        {
            entity.EnSafe();
            string strSQL = @"UPDATE Tbl_Cargo_House SET LogisFee=@LogisFee,TwoLogisFee=@TwoLogisFee,ThreeLogisFee=@ThreeLogisFee Where HouseID=@HouseID";
            using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
            {
                conn.AddInParameter(cmd, "@LogisFee", DbType.Decimal, entity.LogisFee);
                conn.AddInParameter(cmd, "@TwoLogisFee", DbType.Decimal, entity.TwoLogisFee);
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void saveHouseOrderPermiss(CargoHouseEntity entity)
        {
            entity.EnSafe();
            string strSQL = @"UPDATE Tbl_Cargo_House SET IsCassAutoOrder=@IsCassAutoOrder,IsContiAutoOrder=@IsContiAutoOrder,IsTuhuAutoOrder=@IsTuhuAutoOrder,IsSanAutoOrder=@IsSanAutoOrder,IsTMaoAutoOrder=@IsTMaoAutoOrder Where HouseID=@HouseID";
            using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
            {
                conn.AddInParameter(cmd, "@IsContiAutoOrder", DbType.String, entity.IsContiAutoOrder);
                conn.AddInParameter(cmd, "@IsTuhuAutoOrder", DbType.String, entity.IsTuhuAutoOrder);
                conn.AddInParameter(cmd, "@IsCassAutoOrder", DbType.String, entity.IsCassAutoOrder);
                conn.AddInParameter(cmd, "@IsSanAutoOrder", DbType.String, entity.IsSanAutoOrder);
                conn.AddInParameter(cmd, "@IsTMaoAutoOrder", DbType.String, entity.IsTMaoAutoOrder);
                conn.AddInParameter(cmd, "@HouseID", DbType.Int32, entity.HouseID);
                conn.ExecuteNonQuery(cmd);
            }
        }
                    ...
                    using (DataTable dd = conn.ExecuteDataTable(command))
                    {
                        foreach (DataRow idr in dd.Rows)
                        {
                            result.Add(new CargoHouseEntity
                            {
                                ...
                                IsCassAutoOrder = Convert.ToString(idr["IsCassAutoOrder"]),
                                IsContiAutoOrder = Convert.ToString(idr["IsContiAutoOrder"]),
                                IsTuhuAutoOrder = Convert.ToString(idr["IsTuhuAutoOrder"]),
                                IsSanAutoOrder = Convert.ToString(idr["IsSanAutoOrder"]),
                                IsTMaoAutoOrder = Convert.ToString(idr["IsTMaoAutoOrder"]),
        ...
        public List<CargoCityEntity> QueryCityData(CargoCityEntity entity)
        {
            ...
            if (!string.IsNullOrEmpty(entity.City)) { strSQL += " and City=@City"; }
                ...
                using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
                {
                    using (DataTable dt = conn.ExecuteDataTable(cmd))
                    {
                        foreach (DataRow idrCount in dt.Rows)
                        {
                            ...
                            result.IsCassAutoOrder = Convert.ToString(idrCount["IsCassAutoOrder"]);
                            result.IsContiAutoOrder = Convert.ToString(idrCount["IsContiAutoOrder"]);
                            result.IsTuhuAutoOrder = Convert.ToString(idrCount["IsTuhuAutoOrder"]);
                            result.IsSanAutoOrder = Convert.ToString(idrCount["IsSanAutoOrder"]);
                            result.IsTMaoAutoOrder = Convert.ToString(idrCount["IsTMaoAutoOrder"]);
                        }
                    }
                }
            }
        ...
        public List<CargoAreaEntity> QueryAreaByAreaIDs(int[] areaIDs)
        {
            List<CargoAreaEntity> result = new List<CargoAreaEntity>();
...
;
";
                string strSQL = @"SELECT * from Tbl_Cargo_Area a
INNER JOIN ##IDs IDS ON a.AreaID = IDS.ID";
                List<SqlParameter> sqlParameters = new List<SqlParameter>();
                int batchSize = 1000;
                if (!areaIDs.Any()) { return result; }

                var groupedPrdctIDs = areaIDs.Select((row, index) => new { row, index })
...
";
        ...
        {
            List<CargoAreaEntity> result = new List<CargoAreaEntity>();
            string strSQL = $@"SELECT HouseID,AreaID,Name,Code,Longitude,Latitude,Address FROM Tbl_Cargo_Area WHERE (DelFlag=0 or DelFlag is null) 
        ...
        public List<CargoContainerEntity> QueryAreaByContainer(int[] containerIDs)
        {
...
INSERT INTO ##containerIDs (ID)
Values @{tempTblVals}
;
";
                string strSQL = @"
SELECT * FROM Tbl_Cargo_Container c 
LEFT JOIN ##containerIDs IDS ON c.ContainerID = IDS.ID";
                int index = 1;
                List<string> tempTblVals = new List<string>();
                List<SqlParameter> sqlParameters = new List<SqlParameter>();
                ...
                if (containerIDs.Any())
                {
                    ...
                    {
                        tempTblVals.Add($"(@ID{index})");
                        sqlParameters.AddRange(new List<SqlParameter>
                            {
                                new SqlParameter($"@ID{index}", id)
                            });
                        index++;
                    }
                    createIDsTempTblSQL = createIDsTempTblSQL.Replace("@{tempTblVals}", string.Join("," + Environment.NewLine, tempTblVals));
                }
                else
                {
                    return result;
                ...
                using (DbCommand cmd = conn.GetSqlStringCommond(createIDsTempTblSQL + strSQL))
                {
...
left join Tbl_Cargo_Area as b on a.AreaID=b.AreaID where a.ContainerType=@ContainerType and b.HouseID=@HouseID";
        ...
        public CargoContainerEntity QueryContainerEntityByID(int containerID)
        {
            ...
            try
            {
                string strSQL = @"select (a.MaxPiece-a.InPiece) as allowPiece, a.*,b.HouseID from Tbl_Cargo_Container as a left join Tbl_Cargo_Area as b on a.AreaID=b.AreaID where ContainerID=@ContainerID";
                using (DbCommand command = conn.GetSqlStringCommond(strSQL))
                {
                    conn.AddInParameter(command, "@ContainerID", DbType.Int32, containerID);
                    using (DataTable dd = conn.ExecuteDataTable(command))
                    {
                        foreach (DataRow idr in dd.Rows)
                        {
                ...
                using (DbCommand command = conn.GetSqlStringCommond(strSQL))
                {
                    ...
                    using (DataTable dd = conn.ExecuteDataTable(command))
                    {
                        foreach (DataRow idr in dd.Rows)
                        {
                            ...
                            result.WholesalePrice = Convert.ToDouble(idr["WholesalePrice"]);//批发价
        ...
        public List<CargoContainerShowEntity> QueryHouseStockDataMiniPro(int pIndex, int pNum, CargoContainerShowEntity entity)
        {
            ...
            if (entity.HouseID.Equals(101))
            {
                ...
                strSQL += "  case when a.TypeID=648 then 0 when a.TypeID=582 then 1 when a.TypeID=539 then 1 else 2 end asc,a.SalePrice asc, a.AccessCount desc ";
            }
                ...
                using (DataTable dt = conn.ExecuteDataTable(cmdAdd))
                {
                    foreach (DataRow idr in dt.Rows)
                    {
                        result.Add(new CargoContainerShowEntity
                        {
                            ...
                            ProductName = Convert.ToString(idr["ProductName"]),
                            TypeParentID = Convert.ToInt32(idr["TypeParentID"]),
                            NextDayPrice = Convert.ToDecimal(idr["NextDayPrice"]),//云仓二批客户次日达价
                        });
                    }
                }
            }
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public List<CargoContainerShowEntity> QueryRerserveListedDataMiniPro(int pIndex, int pNum, CargoContainerShowEntity entity)
        {
            List<CargoContainerShowEntity> result = new List<CargoContainerShowEntity>();
            ...
            if (!string.IsNullOrWhiteSpace(entity.Specs))
            {
                ...
                if (res.Length > 3 && res.Length <= 5)
                {
                    strSQL += " and (d.Specs like '%" + res.Substring(0, 3) + "/" + res.Substring(3, res.Length - 3) + "%' or d.Specs like '%" + res.Substring(0, 3) + "R" + res.Substring(3, res.Length - 3) + "%')";
                }
                if (res.Length > 5)
                {
                    strSQL += " and (d.Specs like '%" + res.Substring(0, 3) + "/" + res.Substring(3, 2) + "R" + res.Substring(5, res.Length - 5) + "%' or d.Specs like '%" + res.Substring(0, 3) + "/" + res.Substring(3, 2) + "RF" + res.Substring(5, res.Length - 5) + "%' or d.Specs like '%" + res.Substring(0, 3) + "/" + res.Substring(3, 2) + "ZR" + res.Substring(5, res.Length - 5) + "%' or d.Specs like '%" + res.Substring(0, 3) + "/" + res.Substring(3, 2) + "ZRF" + res.Substring(5, res.Length - 5) + "%' or d.Specs like '%" + res.Substring(0, 3) + "R" + res.Substring(3, res.Length - 3) + "%' or d.Specs like '" + entity.Specs + "')";
                }
            }
            ...
            if (!entity.HouseID.Equals(0)) { strSQL += " and a.HouseID=" + entity.HouseID; }
            //if (!entity.BatchYear.Equals(0)) { strSQL += " and b.BatchYear=" + entity.BatchYear; }
            if (!entity.SalePrice.Equals(0)) { strSQL += " and a.ProductPrice>" + entity.SalePrice; }
            if (!string.IsNullOrEmpty(entity.HouseIDStr)) { strSQL += " and a.HouseID in (" + entity.HouseIDStr + ")"; }
            //锁定库存
            //if (!string.IsNullOrEmpty(entity.SpecsType)) { strSQL += " and b.SpecsType='" + entity.SpecsType + "'"; }
            //if (!string.IsNullOrEmpty(entity.IsLockStock)) { strSQL += " and b.IsLockStock='" + entity.IsLockStock + "'"; }
            if (!string.IsNullOrEmpty(entity.ProductCode)) { strSQL += " and a.ProductCode='" + entity.ProductCode + "'"; }
            if (!string.IsNullOrEmpty(entity.GoodsCode)) { strSQL += " and d.GoodsCode='" + entity.GoodsCode + "'"; }
            //znf 250904
            if (!string.IsNullOrEmpty(entity.NoType))
            {
                var noTypes = entity.NoType.Split(',');
                ...
                using (DataTable dt = conn.ExecuteDataTable(cmdAdd))
                {
                    foreach (DataRow idr in dt.Rows)
                    {
                        result.Add(new CargoContainerShowEntity
                        {
                            ...
                            ProductName = Convert.ToString(idr["ProductName"]),
                            TypeParentID = Convert.ToInt32(idr["TypeParentID"]),
                            minPurchase = string.IsNullOrEmpty(Convert.ToString(idr["minPurchase"])) ? 1 : Convert.ToInt32(idr["minPurchase"]),
                        });
                    }
                }
            }
        ...
        /// </summary>
        /// <param name="entity"></param>
        public long saveOutCargoData(List<CargoContainerShowEntity> entity)
        {
            try
            {
                long id = 0;
                foreach (var it in entity)
                {
                    ...
                    using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
                    {
                        ...
                        id = Convert.ToInt64(conn.ExecuteScalar(cmd));
                    }
                }
                return id;
            }
...
WHERE b.SpecsType != 5 @{conditions}
GROUP BY b.TypeID, b.HouseID, b.ProductCode; 
");
...
SELECT
    t.HouseID,
    t.ProductCode,
    SUM(t.SaleNum)   AS SaleNum,
    SUM(t.WXSaleNum) AS WXSaleNum
INTO #tempOrderStats
FROM (
    -- 历史销量
    SELECT
        a.HouseID,
        a.ProductCode,
        SUM(a.Piece)   AS SaleNum,
        SUM(a.WXPiece) AS WXSaleNum
    FROM Tbl_Cargo_DailySaleStatic a
    INNER JOIN Tbl_Cargo_ProductType d
        ON a.TypeID = d.TypeID
    WHERE (1=1) @{conditions}
    GROUP BY a.HouseID, a.ProductCode
    ...
    SELECT
        ts.HouseID,
        ts.ProductCode,
        SUM(ts.Piece)   AS SaleNum,
        SUM(ts.WXPiece) AS WXSaleNum
    FROM #tempTodaySale ts
    GROUP BY ts.HouseID, ts.ProductCode
) t
GROUP BY t.HouseID, t.ProductCode;

CREATE UNIQUE INDEX IX_#tempOrderStats
ON #tempOrderStats(ProductCode,HouseID)
...
");
            ...
            if (entity.StartDate != default)
                conditions.Add($"a.SalesDate >= '{entity.StartDate:yyyy-MM-dd}'");
            if (entity.EndDate != default)
                conditions.Add($"a.SalesDate < '{entity.EndDate.AddDays(1):yyyy-MM-dd}'");
            if (entity.TypeID != 0)
                conditions.Add($"d.TypeID = {entity.TypeID}");
            if (entity.ParentID != 0)
...
FROM (
    ...
    SELECT
        ts.ProductCode,
        SUM(ts.Piece) AS Piece
    FROM #tempTodaySale ts
    GROUP BY ts.ProductCode
) t
GROUP BY t.ProductCode;

CREATE UNIQUE INDEX IX_#tempTotalSalePiece
ON #tempTotalSalePiece(ProductCode)
INCLUDE(Piece);
");
            conditions = new List<string>();
            // 制单日期范围
            ...
            #endregion
            #region Tbl_Cargo_MoveOrderGood 和 Tbl_Cargo_FactoryOrder 在途库存 (拆分为采购在途和移库在途)
            strBld.Append(@"
PRINT('------------ 采购在途库存 ------------');
-- 采购在途：来自采购订单
SELECT
    fo.ProductCode,
    fo.HouseID,
    SUM(ReplyNumber - fo.InPiece) AS Piece
INTO #tempPurchaseITI
FROM Tbl_Cargo_FactoryOrder fo
WHERE (1 = 1)
    AND (fo.InCargoStatus = 0 OR fo.InCargoStatus = 2)
    AND fo.OrderType <> 2 --筛除退货单
    AND ISNULL(fo.ProductCode, '') <> ''
GROUP BY fo.ProductCode, fo.HouseID;

CREATE UNIQUE INDEX IX_#tempPurchaseITI
ON #tempPurchaseITI(ProductCode, HouseID)
INCLUDE(Piece);
...
CREATE UNIQUE INDEX IX_#tempTransferITI
ON #tempTransferITI(ProductCode, HouseID)
INCLUDE(Piece);
");
            conditions = new List<string>();
            ...
            if (!string.IsNullOrEmpty(entity.HouseID))
            {
                conditions.Add($"HouseID IN ({entity.HouseID})");
            }
...
SELECT 
    ProductCode,
    HouseID,
    SUM(SumLast3Months) AS TotalPiece,       -- 最近3个月总销量
    (SUM(WeightedMonthSale)) AS AvgMonthSale  -- 加权月均销量
    INTO #tempAvgSale
FROM Tbl_Cargo_MonthSaleStatic a
WHERE YearMonth = DATEADD(MONTH, DATEDIFF(MONTH, 0, GETDATE()) - 1,0) @{conditions}
GROUP BY ProductCode,  HouseID;
CREATE UNIQUE INDEX IX_#tempAvgSale
ON #tempAvgSale(ProductCode,HouseID)
...
SELECT
    ...
    ISNULL(pms.Piece, 0) AS PurchaseMoveNum,
    ISNULL(tms.Piece, 0) AS TransferMoveNum,
    CAST(ISNULL(avs.AvgMonthSale, 0) AS INT) AS AvgSaleNum,
    CASE
        WHEN s.StockNum - ISNULL(cs.Piece, 0) - ISNULL(pms.Piece, 0) - ISNULL(tms.Piece, 0) <= 0 THEN 0
        ELSE s.StockNum - ISNULL(cs.Piece, 0) - ISNULL(pms.Piece, 0) - ISNULL(tms.Piece, 0)
    END AS LessNum
FROM Tbl_Cargo_SafeStock AS s
INNER JOIN (SELECT MAX(SID) SID FROM Tbl_Cargo_SafeStock GROUP BY ProductCode, HouseID) s2  --去重复
    ON s.SID = s2.SID
...
LEFT JOIN #tempALLWhsPiece AS tw ON s.ProductCode = tw.ProductCode
...
LEFT JOIN #tempTotalSalePiece AS tos
   ON s.ProductCode = tos.ProductCode

LEFT JOIN #tempPurchaseITI AS pms
    ON s.HouseID = pms.HouseID
   AND s.ProductCode = pms.ProductCode

LEFT JOIN #tempTransferITI AS tms
    ON s.HouseID = tms.HouseID
   AND s.ProductCode = tms.ProductCode
...
ORDER BY s.HouseID ASC, s.StockNum - ISNULL(cs.Piece, 0) DESC;");
            ...
            if (!string.IsNullOrWhiteSpace(entity.Specs))
            {
                ...
                {
                    conditions.Add($"s.Specs LIKE '%{res}%'");
                }
                else if (res.Length > 3 && res.Length <= 5)
                {
                    conditions.Add($"(s.Specs LIKE '%{res.Substring(0, 3)}/{res.Substring(3)}%' OR s.Specs LIKE '%{res.Substring(0, 3)}R{res.Substring(3)}%')");
                }
                else if (res.Length > 5)
                {
                    ...
                    conditions.Add($@"
            (s.Specs LIKE '%{part1}/{part2}R{part3}%'
            OR s.Specs LIKE '%{part1}/{part2}RF{part3}%'
            OR s.Specs LIKE '%{part1}/{part2}ZR{part3}%'
            OR s.Specs LIKE '%{part1}/{part2}ZRF{part3}%'
            OR s.Specs LIKE '%{part1}R{res.Substring(3)}%'
            OR s.Specs LIKE '{entity.Specs}')");
                }
            }
            ...
            using (DbCommand command = conn.GetSqlStringCommond(strSQL))
            {
                ...
                using (DataTable dd = conn.ExecuteDataTable(command))
                {
                    foreach (DataRow idr in dd.Rows)
                    {
                        ...
                        var curNum = idr.Field<int>("CurNum"); //在库库存

                        int doi = 0; //库存度天数
                        double dayAvgSaleDouble = avgSaleNum == 0 ? 0 : avgSaleNum / 30d;
                        int dayAvgSaleNum = Convert.ToInt32(Math.Round(dayAvgSaleDouble)); //日均销量

                        if (curNum > 0 && dayAvgSaleDouble > 0)
                        {
                            doi = Convert.ToInt32(Math.Round((double)(curNum / dayAvgSaleDouble), 0));
                            doi = Math.Max(1, doi); // 苏老师：0表示该货品未启用状态，所以最少显示1天
                        }

                        int lessNum = 0;
                        int excessNum = 0;
                        int purchaseMoveNum = idr.Field<int>("PurchaseMoveNum");
                        int transferMoveNum = idr.Field<int>("TransferMoveNum");
                        int moveNum = purchaseMoveNum + transferMoveNum;  // 合计在途 = 采购在途 + 移库在途
                        int minStock = idr.Field<int>("MinStock");
                        int maxStock = idr.Field<int>("MaxStock");
                        int stockNum = idr.Field<int>("StockNum");
                        ...
                        result.Add(new CargoSafeStockEntity
                        {
                            ...
                            HouseID = idr.Field<int>("HouseID").ToString(),
                            ...
                            LessNum = lessNum,    //相差数 （补货数
                            CurNum = curNum,    //实际库存数
                            MoveNum = moveNum,    //在途库存数(合计) = 采购在途 + 移库在途
                            PurchaseMoveNum = purchaseMoveNum,    //采购在途数
                            TransferMoveNum = transferMoveNum,    //移库在途数
                            ...
                            DayAvgSaleNum = dayAvgSaleNum, //日均销量
                            ...
                            REStock = idr.Field<int?>("REStock"),   //RE库存数
...
VALUES
  (
    ...
    @ControlStock
            ...
            try
            {
                var AvgSaleNum = entity.AvgSaleNum;
                var MaxStockDay = entity.MaxStockDay;
                int? maxStock = 0;
                int minStock = 0;
                ...
                using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
                {
                    ...
                    conn.AddInParameter(cmd, "@StockNum", DbType.Int32, safeNum);
                    conn.AddInParameter(cmd, "@OPID", DbType.String, entity.OPID);
                    conn.AddInParameter(cmd, "@OP_DATE", DbType.DateTime, DateTime.Now);
                    conn.AddInParameter(cmd, "@MaxStock", DbType.Int32, maxStock);
                    conn.AddInParameter(cmd, "@MinStock", DbType.Int32, minStock);
                    conn.AddInParameter(cmd, "@ProductCode", DbType.String, entity.ProductCode);

                    conn.AddInParameter(cmd, "@MinStockDay", DbType.Int32, entity.MinStockDay.HasValue ? (object)entity.MinStockDay.Value : DBNull.Value);
                    conn.AddInParameter(cmd, "@MaxStockDay", DbType.Int32, entity.MaxStockDay.HasValue ? (object)entity.MaxStockDay.Value : DBNull.Value);
                    ...
                    conn.AddInParameter(cmd, "@REStock", DbType.Int32, entity.REStock.HasValue ? (object)entity.REStock.Value : DBNull.Value);
...
WHERE
  SID = @SID";
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void UpdateOrAddSafeStockData(List<ModifySafeStockDto> listData)
        {
            string createTempTblSql = @"
IF OBJECT_ID('tempdb..##tempSS') IS NOT NULL
    DROP TABLE ##tempSS;
CREATE TABLE ##tempSS(
    HouseID INT,
    AreaID INT,
    ...
    LoadIndex NVARCHAR(50),
    SpeedLevel NVARCHAR(50),
    StockNum INT,
    OPID NVARCHAR(50),
    OP_DATE DATETIME,
    MaxStock INT,
...
";
            string strSQL = @"
MERGE INTO Tbl_Cargo_SafeStock AS target
USING ##tempSS AS source
ON target.HouseID = source.HouseID AND target.ProductCode = source.ProductCode
WHEN MATCHED THEN
UPDATE
SET
  ...
  target.GoodsCode = source.GoodsCode,
  target.LoadIndex = source.LoadIndex,
  target.SpeedLevel = source.SpeedLevel,
  target.StockNum = source.StockNum,
  target.OPID = source.OPID,
  target.OP_DATE = source.OP_DATE,
  target.MaxStock = source.MaxStock,
  target.MinStock = source.MinStock,
  target.ProductCode = source.ProductCode,
  target.MinStockDay = source.MinStockDay,
  target.MaxStockDay = source.MaxStockDay,
  target.HCYCStock = source.HCYCStock,
  target.OEStock = source.OEStock,
  target.REStock = source.REStock,
  target.IsolatedStock = source.IsolatedStock,
  target.ControlStock = source.ControlStock
...
";
            ...
            {
                //去重
                listData = listData.GroupBy(x => new { x.HouseID, x.ProductCode }).Select(g => g.First()).ToList();
                foreach (var entity in listData)
                {
                    ...
                    if (AvgSaleNum.HasValue && MaxStockDay.HasValue)
                    {
                        maxStock = (int)Math.Floor((double)entity.AvgSaleNum / 30 * (double)entity.MaxStockDay);
                        minStock = (int)Math.Floor((double)entity.AvgSaleNum / 30 * (double)entity.MinStockDay);
                    }
                ...
                using (DbCommand cmd = conn.GetSqlStringCommond(createTempTblSql))
                {
                    cmd.Connection.Open();
                    cmd.ExecuteNonQuery();
                    conn.BulkInsertData(listData, "##tempSS");
...
INNER JOIN Tbl_Cargo_Container AS d ON a.ContainerID = d.ContainerID
WHERE b.SpecsType != 5 @{conditions}
GROUP BY b.HouseID, b.ProductCode;
");
...
WHERE a.ThrowGood != 25
    AND a.OrderModel = 0 
    AND c.SpecsType != 5
    AND CAST(a.CreateDate AS DATE) >= DATEADD(MONTH,-2,GETDATE()) @{conditions}
GROUP BY c.HouseID, c.ProductCode;
CREATE UNIQUE INDEX IX_#tempOrderStats
ON #tempOrderStats(ProductCode,HouseID)
");
            conditions = new List<string>();
...
SELECT
  ...
  ISNULL(tms.Piece, 0) AS TransferMoveNum,
  cs.Piece AS CurNum,
  cs.Piece + ISNULL(pms.Piece, 0) + ISNULL(tms.Piece, 0) - f.StockNum AS LessNum,
  CAST(ISNULL(avs.AvgMonthSale, 0) AS INT) AS WeightedAvgSaleNum,
  CAST(ISNULL(avs.TotalPiece, 0) / 3  AS INT) AS AvgSaleNum
FROM
  ...
  LEFT JOIN #tempPurchaseITI AS pms
   ON  f.HouseID = pms.HouseID  -- 采购在途数量
   AND f.ProductCode = pms.ProductCode
  LEFT JOIN #tempTransferITI AS tms
   ON  f.HouseID = tms.HouseID  -- 移库在途数量
   AND f.ProductCode = tms.ProductCode
  ...
  LEFT JOIN Tbl_Cargo_ProductType AS j ON f.TypeID = j.TypeID
    LEFT JOIN #tempAvgSale AS avs
       ON f.HouseID = avs.HouseID
       AND f.ProductCode = avs.ProductCode
WHERE
  (1 = 1)
  AND cs.Piece + ISNULL(pms.Piece, 0) + ISNULL(tms.Piece, 0) - f.StockNum < 0
");
            conditions = new List<string>();
                    ...
                    foreach (DataRow idr in dd.Rows)
                    {
                        if (Convert.ToInt32(idr["LessNum"]) < 0)
                        {
                            ...
                            result.Add(new CargoSafeStockEntity
                            {
                                ...
                                WeightedAvgSaleNum = Convert.ToInt32(idr["WeightedAvgSaleNum"]),
                                AvgSaleNum = Convert.ToInt32(idr["AvgSaleNum"]),
        ...
        public List<CargoProductEntity> QueryProductDataBasic(CargoProductEntity entity)
        {
            ...
            {
                string strSQL = $@"
select a.*,c.TypeName,c.ParentID,c.TypeParentName from Tbl_Cargo_ProductSpec as a
 inner join Tbl_Cargo_ProductType as c on a.TypeID=c.TypeID
where 1=1
";
                if (!string.IsNullOrEmpty(entity.GoodsCode))
                {
        ...
        public int[] SaveStockTake(CargoStockTakeEntity entity, string genType)
        {
            ...
            int SplitThreshold = entity.SplitThreshold.GetValueOrDefault();
            bool needSplit = !isFull && SplitThreshold > 1;
            ...
            {
                entity.TakeType = 1;
                StockID2 = AddStockTake(entity);
            }
            string stcontInsertSqlStr1 = "";
            string stcontInsertSqlStr2 = "";
            string strSQL = @"
    INSERT INTO
	Tbl_Cargo_StockTakeContainer(ContainerID, ContainerCode, StockNum, StockID)
    SELECT
	    a.ContainerID,
	    b.ContainerCode,
	    SUM(a.Piece) AS StockNum,
	    @{StockID}
    FROM
	Tbl_Cargo_ContainerGoods AS a
	INNER JOIN Tbl_Cargo_Container AS b ON a.ContainerID = b.ContainerID
	INNER JOIN Tbl_Cargo_Product p ON a.ProductID = p.ProductID
	INNER JOIN Tbl_Cargo_Area AS c ON b.AreaID = c.AreaID";
            if (!entity.TypeID.Equals(0)) { strSQL += " and a.TypeID = " + entity.TypeID; }
            if (!entity.HouseID.Equals(0)) { strSQL += " and c.HouseID = " + entity.HouseID; }
            if (!entity.SecondAreaID.Equals(0)) { strSQL += " and c.AreaID=" + entity.SecondAreaID; }
            ...
            if (needSplit)
            {
                //盘点数量小于等于阈值的，放在一个盘点单里
                //盘点数量大于阈值的，放在一个盘点单里
                stcontInsertSqlStr1 = strSQL + " HAVING SUM(a.Piece) <= " + SplitThreshold;
                stcontInsertSqlStr2 = strSQL + " HAVING SUM(a.Piece) > " + SplitThreshold;

                stcontInsertSqlStr1 = stcontInsertSqlStr1.Replace("@{StockID}", StockID.ToString());
                stcontInsertSqlStr2 = stcontInsertSqlStr2.Replace("@{StockID}", StockID2.ToString());
                using (DbCommand cmd = conn.GetSqlStringCommond(stcontInsertSqlStr1))
                {
                    conn.ExecuteNonQuery(cmd);
                    cmd.CommandText = stcontInsertSqlStr2;
                    conn.ExecuteNonQuery(cmd);
                }
            }
            else
            {
                strSQL = strSQL.Replace("@{StockID}", StockID.ToString());
                using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
                {
                    conn.ExecuteNonQuery(cmd);
                }
            ...
            //------------ 插入盘点标签数据 ---------------
            string stcTagInsertSqlStr1 = "";
            string stcTagInsertSqlStr2 = "";

            string strTagInsertSql = "INSERT INTO Tbl_Cargo_StockTakeTag(StockID, ProductID, TagCode, ContainerID) ";
            string strTagSelectSql = @"
SELECT
	@{StockID},
	a.ProductID,
	g.TagCode,
...
FROM
	...
	INNER JOIN Tbl_Cargo_Product p ON a.ProductID = p.ProductID
	INNER JOIN Tbl_Cargo_Area AS c ON b.AreaID = c.AreaID";
            if (!entity.TypeID.Equals(0)) { strTagSelectSql += " and a.TypeID = " + entity.TypeID; }
            if (!entity.HouseID.Equals(0)) { strTagSelectSql += " and c.HouseID = " + entity.HouseID; }
            if (!entity.SecondAreaID.Equals(0)) { strSQL += " and c.AreaID=" + entity.SecondAreaID; }
            strTagSelectSql += " inner join Tbl_Cargo_Area as d on c.ParentID = d.AreaID";
            if (!entity.AreaID.Equals(0)) { strTagSelectSql += " and d.AreaID=" + entity.AreaID; }
            strTagSelectSql += " inner join Tbl_Cargo_Area as f on d.ParentID = f.AreaID ";
            if (!entity.HeadHouseID.Equals(0)) { strTagSelectSql += " and f.AreaID=" + entity.HeadHouseID; }
            strTagSelectSql += " inner join Tbl_Cargo_ProductTag as g on a.ProductID = g.ProductID and g.OutCargoStatus = 0 and a.ContainerID = g.ContainerID";
            strTagSelectSql += " @{innerJoin}";


            strTagSelectSql += " where (1=1) and p.SpecsType <> 5  and a.Piece > 0 ";
            if (!isFull) { strTagSelectSql += " AND a.Piece_DATE IS NOT NULL AND a.Piece_DATE >= DATEADD(HOUR, 18, CAST(CONVERT(date, GETDATE() - 1) AS DATETIME)) AND a.Piece_DATE < DATEADD(HOUR, 18, CAST(CONVERT(date, GETDATE()) AS DATETIME))"; }

            //判断是否有需要盘点的标签数据
            string queryTagSqlStr = strTagSelectSql.Replace("@{StockID}", StockID.ToString()).Replace("@{innerJoin}", "");
            using (DbCommand cmdTag = conn.GetSqlStringCommond(queryTagSqlStr))
            {
            ...
            string strTagMerge = strTagInsertSql + strTagSelectSql;

            if (needSplit)
            {
                string innerjoinSqlStr = " INNER JOIN Tbl_Cargo_StockTakeContainer AS cg ON cg.StockID = @{StockID} AND a.ContainerID = cg.ContainerID";
                strTagMerge = strTagMerge.Replace("@{innerJoin}", innerjoinSqlStr);
                stcTagInsertSqlStr1 = strTagMerge.Replace("@{StockID}", StockID.ToString());
                stcTagInsertSqlStr2 = strTagMerge.Replace("@{StockID}", StockID2.ToString());

                using (DbCommand cmdTag = conn.GetSqlStringCommond(stcTagInsertSqlStr1))
                {
                    conn.ExecuteNonQuery(cmdTag);
                    cmdTag.CommandText = stcTagInsertSqlStr2;
                    conn.ExecuteNonQuery(cmdTag);
                }
            }
            else
            {
                strTagMerge = strTagMerge.Replace("@{StockID}", StockID.ToString()).Replace("@{innerJoin}", "");
            ...
            if (StockID2 > 0)
            {
                return new int[] { StockID, StockID2 };
            }
            return new int[] { StockID };
        }
        ...
        public List<int> QueryStockTakePicIDsByStockID(int StockID)
        {
            string strSQL = @"SELECT ID from Tbl_Cargo_StockTakeFile Where StockID = " + StockID;
            List<int> stPicIDs = new List<int>();
            using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
            {
                using (DataTable dt = conn.ExecuteDataTable(cmd))
                {
                    foreach (DataRow idr in dt.Rows)
                    {
                        stPicIDs.Add((int)idr.Field<long>("ID"));
                    }
                }
            }
            return stPicIDs;
...
SELECT
	@@IDENTITY";
            ...
            using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
            {
                ...
                conn.AddInParameter(cmd, "@AreaID", DbType.Int32, entity.AreaID);
                conn.AddInParameter(cmd, "@SecondAreaName", DbType.String, entity.SecondAreaName);
                conn.AddInParameter(cmd, "@SecondAreaID", DbType.Int32, entity.SecondAreaID);
                ...
                conn.AddInParameter(cmd, "@TakeType", DbType.Int32, entity.TakeType.HasValue ? entity.TakeType : 0);
                did = Convert.ToInt32(conn.ExecuteScalar(cmd));
            }
            return did;
        }
                    ...
                    using (DataTable dd = conn.ExecuteDataTable(command))
                    {
                        foreach (DataRow idr in dd.Rows)
                        {
                            result.Add(new CargoStockTakeEntity
                            {
                                ...
                                //AreaID = Convert.ToInt32(idr["AreaID"]),
                                AreaName = Convert.ToString(idr["AreaName"]),
                                SecondAreaName = Convert.ToString(idr["SecondAreaName"]),
                                HouseName = Convert.ToString(idr["HouseName"]),
                                TypeName = Convert.ToString(idr["TypeName"]),
                                ...
                                TakeType = idr.Field<byte?>("TakeType"),
                                SplitThreshold = idr.Field<int?>("SplitThreshold"),
                            });
                        }
                    }
                }
                ...
                using (DataTable dd = conn.ExecuteDataTable(command))
                {
                    foreach (DataRow idr in dd.Rows)
                    {
                        result.Add(new CargoStockTakeEntity
                        {
                            ...
                            TakeStatus = Convert.ToString(idr["TakeStatus"]),
                            StockNum = Convert.ToInt32(idr["StockNum"]),
                            TakeMode = Convert.ToByte(idr["TakeMode"]),
                ...
                using (DataTable dd = conn.ExecuteDataTable(command))
                {
                    foreach (DataRow idr in dd.Rows)
                    {
                        result.Add(new CargoStockTakeContainerEntity
                        {
                            ...
                            OP_DATE = Convert.ToDateTime(idr["OP_DATE"]),
                            TakePiece = idr.Field<int?>("TakePiece"),
                            TakeUser = idr.Field<string>("TakeUser"),
                            TakeUserName = idr.Field<string>("TakeUserName"),
                            ReviewStatus = idr.Field<byte?>("ReviewStatus"),
                            ReviewUser = idr.Field<string>("ReviewUser"),
                            ReviewUserName = idr.Field<string>("ReviewUserName"),
                            ReviewTime = idr.Field<DateTime?>("ReviewTime"),
                        });
                    }
                }
            }
        ...
        {
            List<CargoStockTakeTagEntity> result = new List<CargoStockTakeTagEntity>();
            string strSQL = "SELECT a.StockID, a.ContainerID, cc.ContainerCode, a.ScanContainerID, scc.ContainerCode AS ScanContainerCode, b.ContainerID AS OldContainerID, occ.ContainerCode AS OldContainerCode, a.ProductID, a.TagCode, a.ScanStatus, a.ScanUserName, a.ScanLoginName, a.StockStatus, a.ScanDate, a.Remark, d.TypeName, c.ProductName, c.Batch, c.Specs, c.Figure, c.LoadIndex, c.SpeedLevel, c.GoodsCode FROM Tbl_Cargo_StockTakeTag AS a INNER JOIN Tbl_Cargo_ProductTag AS b ON a.TagCode = b.TagCode LEFT JOIN Tbl_Cargo_Product AS c ON a.ProductID = c.ProductID LEFT JOIN tbl_Cargo_ProductType AS d ON c.TypeID = d.TypeID LEFT JOIN Tbl_Cargo_Container AS cc ON a.ContainerID = cc.ContainerID LEFT JOIN Tbl_Cargo_Container AS scc ON a.ScanContainerID = scc.ContainerID LEFT JOIN Tbl_Cargo_Container AS occ ON b.ContainerID = occ.ContainerID WHERE ( 1 = 1 )";
            if (!entity.StockID.Equals(0)) { strSQL += " and a.StockID=" + entity.StockID; }
            if (!string.IsNullOrEmpty(entity.QueryStockID)) { strSQL += " and a.StockID in (" + entity.QueryStockID + ")"; }
            if (!string.IsNullOrEmpty(entity.ContainerCode)) { strSQL += " and a.ContainerCode ='" + entity.ContainerCode + "'"; }
            if (!string.IsNullOrEmpty(entity.StockStatus)) { strSQL += " and a.StockStatus ='" + entity.StockStatus + "'"; }
            // strSQL += " order by b.ScanStatus asc,b.StockStatus desc";
            using (DbCommand command = conn.GetSqlStringCommond(strSQL))
            {
                using (DataTable dd = conn.ExecuteDataTable(command))
                {
                    foreach (DataRow idr in dd.Rows)
                    {
                        result.Add(new CargoStockTakeTagEntity
                        {
                            ...
                            GoodsCode = Convert.ToString(idr["GoodsCode"]),
                            ProductID = Convert.ToInt64(idr["ProductID"]),
                            ScanContainerID = Convert.ToInt32(idr["ScanContainerID"]).Equals(0) ? Convert.ToInt32(idr["ContainerID"]) : Convert.ToInt32(idr["ScanContainerID"]),
                            ScanContainerCode = Convert.ToInt32(idr["ScanContainerID"]).Equals(0) ? Convert.ToString(idr["ContainerCode"]) : Convert.ToString(idr["ScanContainerCode"]),
                            OldContainerID = Convert.ToInt32(idr["OldContainerID"]),
                            OldContainerCode = Convert.ToString(idr["OldContainerCode"]),
                        });
                    }
                }
            }
        ...
        public void AddStockTakeTag(CargoStockTakeTagEntity entity)
        {
            ...
            {
                string strSQL = "insert into Tbl_Cargo_StockTakeTag(StockID,ProductID,TagCode,ContainerID,ScanStatus,StockStatus,ScanLoginName,ScanUserName,ScanDate,Remark,ScanContainerID) values (@StockID,@ProductID,@TagCode,@ContainerID,@ScanStatus,@StockStatus,@ScanLoginName,@ScanUserName,@ScanDate,@Remark,@ScanContainerID)";
                using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
                {
                    conn.AddInParameter(cmd, "@StockID", DbType.Int32, entity.StockID);
                    conn.AddInParameter(cmd, "@ProductID", DbType.Int64, entity.ProductID);
                    ...
                    conn.AddInParameter(cmd, "@ScanContainerID", DbType.Int32, entity.ScanContainerID);
        ...
        {
            entity.EnSafe();
            string strSQL = "update Tbl_Cargo_StockTakeTag set ScanStatus=@ScanStatus,StockStatus=@StockStatus,ScanLoginName=@ScanLoginName,ScanUserName=@ScanUserName,ScanDate = @ScanDate,Remark=@Remark, ScanContainerID=@ScanContainerID where StockID = @StockID and TagCode = @TagCode";
            using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
            {
                conn.AddInParameter(cmd, "@TagCode", DbType.String, entity.TagCode);
                conn.AddInParameter(cmd, "@StockID", DbType.Int32, entity.StockID);
        ...
        {
            //能否找到相关盘点单与货位数据
            if (stockid <= 0) throw new ApplicationException($"请传入有效盘点单ID。stockTakeID:{stockid}");
            var stockTakeData = QueryStockTake(new CargoStockTakeEntity() { StockID = stockid });
            bool existStockTake = (stockTakeData?.StockID ?? 0) > 0;
            if (!existStockTake) throw new ApplicationException($"未找到相关盘点单。stockTakeID:{stockid}");

            if (!containerIds.Any())
            {
                throw new ApplicationException($"未传入任何库位ID");
            }
            var containerList = QueryCargoStockTakeContainerList(new CargoStockTakeContainerEntity() { StockID = stockid });
            var containerFiltered = containerList.Where(c => containerIds.Contains(c.ContainerID)).ToList();
            if (!containerFiltered.Any())
            {
                throw new ApplicationException($"未找到任何相关库位数据。stockTakeID:{stockid},ContainerIDs:{string.Join(",", containerIds)}");
            }

            //判断是否为大盘点单
            if (stockTakeData.TakeMode != 1)
            {
                throw new ApplicationException($"当前盘点单不是大盘点单，无法审核。stockTakeID:{stockid},TakeMode:{stockTakeData.TakeMode}");
            }

            //判断是否有提交盘点数据，有提交才能审核。StockStatus=1
            containerFiltered = containerList.Where(c => c.StockStatus == "1").ToList();
            if (!containerFiltered.Any())
            {
                throw new ApplicationException($"所选库位中没有任何已提交盘点数据，无法审核。stockTakeID:{stockid},ContainerIDs:{string.Join(",", containerIds)}");
            }

            //过滤审核状态为已审核的
            containerFiltered = containerFiltered.Where(c => c.ReviewStatus != 1).ToList();
            if (!containerFiltered.Any())
            {
                throw new ApplicationException($"所选库位中没有任何可审核的库位，可能已全部审核通过。stockTakeID:{stockid},ContainerIDs:{string.Join(",", containerIds)}");
            }

            //判断库存数量必须与盘点数量一致
            var hasUnmatchedContainers = containerFiltered.Any(c => c.StockNum != c.TakePiece);
            if (hasUnmatchedContainers)
            {
                throw new ApplicationException($"所选库位中存在盘点数量与库存数量不一致的库位，无法审核。stockTakeID:{stockid},ContainerIDs:{string.Join(",", containerIds)}");
            }

            //修改盘点库位审核状态为 1（已审核）
            string stCntnrStrSQL = @"
UPDATE
	Tbl_Cargo_StockTakeContainer
SET
	ReviewStatus = 1,
...
WHERE
	StockID = @StockID
	AND ContainerID IN @{ContainerIDs}
";
            var ContainerIDsFiltered = containerFiltered.Select(c => c.ContainerID).ToArray();
            stCntnrStrSQL = stCntnrStrSQL.Replace("@{ContainerIDs}", "(" + string.Join(",", ContainerIDsFiltered) + ")");
            using (DbCommand cmd = conn.GetSqlStringCommond(stCntnrStrSQL))
            {
                conn.AddInParameter(cmd, "@ReviewUser", DbType.String, userid);
                conn.AddInParameter(cmd, "@ReviewUserName", DbType.String, username);
                conn.AddInParameter(cmd, "@StockID", DbType.String, stockid);
                int effected = conn.ExecuteNonQuery(cmd);
                if (effected != ContainerIDsFiltered.Length)
                {
                    throw new ApplicationException($"审核库位时影响行数与预期不符，实际影响行数{effected}，预期影响行数{ContainerIDsFiltered.Length}。stockTakeID:{stockid},ContainerIDs:{string.Join(",", containerIds)}");
                }
            }
...
WHERE
	...
	AND ContainerID IN @{ContainerIDs}
";
            stTagStrSQL = stTagStrSQL.Replace("@{ContainerIDs}", "(" + string.Join(",", ContainerIDsFiltered) + ")");
            using (DbCommand cmd = conn.GetSqlStringCommond(stTagStrSQL))
            {
                conn.AddInParameter(cmd, "@StockID", DbType.String, stockid);
                conn.ExecuteNonQuery(cmd);
            }
...
(select TOP 100 PERCENT p.HouseID,h.Name,p.TypeID,pt.TypeName,p.Specs,p.Figure,p.GoodsCode,p.LoadIndex,p.SpeedLevel,SUM( og.Piece)as Piece from Tbl_Cargo_OrderGoods og inner join Tbl_Cargo_Product p on og.ProductID=p.ProductID inner join Tbl_Cargo_ProductType pt on p.TypeID=pt.TypeID inner join Tbl_Cargo_House h on p.HouseID=h.HouseID where DateDiff(mm,og.OP_DATE,getdate())<=12 and pt.ParentID=1 and og.HouseID=9 group by p.HouseID,h.Name,p.TypeID,pt.TypeName,p.Specs,p.Figure,p.GoodsCode,p.LoadIndex,p.SpeedLevel order by Piece desc)a12 left join(select TOP 100 PERCENT p.HouseID,h.Name,p.TypeID,pt.TypeName,p.Specs,p.Figure,p.GoodsCode,p.LoadIndex,p.SpeedLevel,SUM( og.Piece)as Piece from Tbl_Cargo_OrderGoods og inner join Tbl_Cargo_Product p on og.ProductID=p.ProductID inner join Tbl_Cargo_ProductType pt on p.TypeID=pt.TypeID inner join Tbl_Cargo_House h on p.HouseID=h.HouseID where DateDiff(mm,og.OP_DATE,getdate())<=6 and pt.ParentID=1 and og.HouseID=9 group by p.HouseID,h.Name,p.TypeID,pt.TypeName,p.Specs,p.Figure,p.GoodsCode,p.LoadIndex,p.SpeedLevel order by Piece desc)a6 on a12.HouseID=a6.HouseID and a12.TypeID=a6.TypeID and a12.Specs=a6.Specs and a12.Figure=a6.Figure and a12.GoodsCode=a6.GoodsCode and a12.LoadIndex=a6.LoadIndex and a12.SpeedLevel=a6.SpeedLevel left join(select TOP 100 PERCENT p.HouseID,h.Name,p.TypeID,pt.TypeName,p.Specs,p.Figure,p.GoodsCode,p.LoadIndex,p.SpeedLevel,SUM( og.Piece)as Piece from Tbl_Cargo_OrderGoods og inner join Tbl_Cargo_Product p on og.ProductID=p.ProductID inner join Tbl_Cargo_ProductType pt on p.TypeID=pt.TypeID inner join Tbl_Cargo_House h on p.HouseID=h.HouseID where DateDiff(mm,og.OP_DATE,getdate())<=3 and pt.ParentID=1 and og.HouseID=9 group by p.HouseID,h.Name,p.TypeID,pt.TypeName,p.Specs,p.Figure,p.GoodsCode,p.LoadIndex,p.SpeedLevel order by Piece desc)a3 on a6.HouseID=a3.HouseID and a6.TypeID=a3.TypeID and a6.Specs=a3.Specs and a6.Figure=a3.Figure and a6.GoodsCode=a3.GoodsCode and a6.LoadIndex=a3.LoadIndex and a6.SpeedLevel=a3.SpeedLevel left join (select TOP 100 PERCENT p.HouseID,h.Name,p.TypeID,pt.TypeName,p.Specs,p.Figure,p.GoodsCode,p.LoadIndex,p.SpeedLevel,SUM( og.Piece)as Piece from Tbl_Cargo_OrderGoods og inner join Tbl_Cargo_Product p on og.ProductID=p.ProductID inner join Tbl_Cargo_ProductType pt on p.TypeID=pt.TypeID inner join Tbl_Cargo_House h on p.HouseID=h.HouseID where DateDiff(mm,og.OP_DATE,getdate())=0 and pt.ParentID=1 and og.HouseID=9 group by p.HouseID,h.Name,p.TypeID,pt.TypeName,p.Specs,p.Figure,p.GoodsCode,p.LoadIndex,p.SpeedLevel order by Piece desc)a1 on a3.HouseID=a1.HouseID and a3.TypeID=a1.TypeID and a3.Specs=a1.Specs and a3.Figure=a1.Figure and a3.GoodsCode=a1.GoodsCode and a3.LoadIndex=a1.LoadIndex and a3.SpeedLevel=a1.SpeedLevel where (1=1) ";
        ...
        {
            entity.EnSafe();
            string strSQL = @"update Tbl_Cargo_HouseBrandShare set MainHouseID=@MainHouseID,BrandID=@BrandID,UpPriceType=@UpPriceType,FixMoney=@FixMoney,RatePrice=@RatePrice where ID=@ID;";
            try
            {
                using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
                {
        ...
        public List<CargoHouseBrandShareEntity> QueryHouseShareList(CargoHouseBrandShareEntity entity)
        {
            ...
            string strSQL = $@"select  a.*,b.Name MainHouseName,c.Name as ShareHouseName,d.TypeName as BrandName,UpPriceType,FixMoney,RatePrice from Tbl_Cargo_HouseBrandShare as a
                              ...
                              where ShareHouseID=@ShareHouseID and a.DelFlag=0 ";

            if (entity.MainHouseID != 0)
            {
                strSQL += $@" and MainHouseID={entity.MainHouseID}";
            }
            if (entity.BrandID != 0)
            {
                strSQL += $@" and BrandID={entity.BrandID}";
            }
            strSQL += $@" order by OP_DATE desc";
            using (DbCommand command = conn.GetSqlStringCommond(strSQL))
            {
                conn.AddInParameter(command, "@ShareHouseID", DbType.String, entity.ShareHouseID);
                using (DataTable dt = conn.ExecuteDataTable(command))
                {
                    foreach (DataRow idr in dt.Rows)
                    {
        ...
        {
            List<CargoAreaEntity> result = new List<CargoAreaEntity>();
            string strSQL = $@"select * from Tbl_Cargo_Area where CassHouseCode is not null ";
            try
            {
                using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
                {
                    using (DataTable dt = conn.ExecuteDataTable(cmd))
                    {
                        foreach (DataRow idrCount in dt.Rows)
                        {
                            result.Add(new CargoAreaEntity
                            {
                                ...
                                Longitude = Convert.ToString(idrCount["Longitude"]),
                                Latitude = Convert.ToString(idrCount["Latitude"]),
                                CassHouseCode = Convert.ToString(idrCount["CassHouseCode"]),
                                Address = Convert.ToString(idrCount["Address"])
                            });
                        }
                    }
        ...
        public List<CargoProductSpecEntity> GetCassProDucts()
        {
            ...
            string strSQL = $@"select a.CassCode,c.TypeName, b.* from Tbl_Cargo_ProductMapping as a
                    ...
                    using (DataTable dt = conn.ExecuteDataTable(cmd))
                    {
                        foreach (DataRow idrCount in dt.Rows)
                        {
                            result.Add(new CargoProductSpecEntity
                            {
                                ...
                                CarModel = Convert.ToString(idrCount["Model"]),
                                CassCode = Convert.ToString(idrCount["CassCode"]),
        ...
        public List<CargoContainerShowEntity> GetInventoryList(int type = 1)
        {
            CargoProductManager pro = new CargoProductManager();
            List<CargoContainerShowEntity> result = new List<CargoContainerShowEntity>();
            try
...
from (select sum(b.Piece)                 as Piece,Born
           , f.TypeName , f.TypeParentName , a.TypeID , a.Model , a.GoodsCode , a.Specs , ltrim(rtrim(Figure)) as Figure , a.LoadIndex , a.SpeedLevel   , a.Supplier , isnull(a.ProductCode,'') as ProductCode , max(a.WholesalePrice) as WholesalePrice , max(a.NextDayPrice) as NextDayPrice , max(a.InHousePrice) as InHousePrice , max(b.InHouseTime) as InHouseTime , max(l.OutHouseTime) as OutHouseTime , min(ISNULL(e.OverDayNum, 0)) as OverDayNum , max(TradePrice) as TradePrice , max(SalePrice) as SalePrice  , h.StatisHouseCode , h.StatisHouseName
from Tbl_Cargo_Product as a
         ...
         inner join Tbl_Cargo_Container as c on b.ContainerID = c.ContainerID
         ...
         left join Tbl_Cargo_Client AS r on a.SuppClientNum = r.ClientNum
              left join (select max(OutHouseTime) as OutHouseTime,ProductID from Tbl_Cargo_OutContainerGoods
group by ProductID ) as l on a.ProductID = l.ProductID
      where (1 = 1)
        and b.Piece <> 0
        and f.ParentID = 1
        and a.IsLockStock = '0'   and h.IsShowStock = '0'
        and a.SpecsType <> '5'
        and SuppClientNum in (891524, 130453, 542207, 551098)
      group by TypeParentName, a.TypeID, TypeName, ProductCode, GoodsCode, Specs, Model, Born, ltrim(rtrim(Figure)),
               LoadIndex, SpeedLevel, Supplier, h.StatisHouseCode, h.StatisHouseName) as a2
...
group by ProductID ) as l on a.ProductID = l.ProductID
      where (1 = 1)
        ...
        and a.SpecsType <> '5'
        and SuppClientNum in (891524, 130453, 542207, 551098)
      group by TypeParentName, a.TypeID, TypeName, ProductCode, GoodsCode, Specs, Model,Born, ltrim(rtrim(Figure)), LoadIndex, SpeedLevel, Batch, Supplier, h.StatisHouseCode, h.StatisHouseName) as a2
...
group by ProductID ) as l on a.ProductID = l.ProductID
      where (1 = 1)
        ...
        and a.SpecsType <> '5'
        and SuppClientNum in (891524, 130453, 542207, 551098)
     group by TypeParentName, a.TypeID, TypeName, ProductCode, GoodsCode, Specs, Model,Born, ltrim(rtrim(Figure)), LoadIndex, SpeedLevel, GoodsClass, Supplier, h.StatisHouseCode, h.StatisHouseName) as a2
...
from (select sum(b.Piece)                 as Piece,Born
           , f.TypeName , f.TypeParentName , a.TypeID , a.Model , a.GoodsCode , a.Specs , ltrim(rtrim(Figure)) as Figure , a.LoadIndex , a.SpeedLevel , a.Batch  , a.Supplier , isnull(a.ProductCode,'') as ProductCode , a.GoodsClass , max(a.WholesalePrice) as WholesalePrice , max(a.NextDayPrice) as NextDayPrice , max(a.InHousePrice) as InHousePrice , max(b.InHouseTime) as InHouseTime , max(l.OutHouseTime) as OutHouseTime , min(ISNULL(e.OverDayNum, 0)) as OverDayNum , max(TradePrice) as TradePrice , max(SalePrice) as SalePrice  , h.StatisHouseCode , h.StatisHouseName
      from Tbl_Cargo_Product as a
               inner join Tbl_Cargo_ContainerGoods as b on a.ProductID = b.ProductID
               left join Tbl_Cargo_ProductSource as m on a.Source = m.Source
         inner join Tbl_Cargo_Container as c on b.ContainerID = c.ContainerID
...
group by ProductID ) as l on a.ProductID = l.ProductID
      where (1 = 1)
        ...
        and a.SpecsType <> '5'
        and SuppClientNum in (891524, 130453, 542207, 551098)
      group by TypeParentName, a.TypeID, TypeName, ProductCode, GoodsCode, Specs, Model,Born, ltrim(rtrim(Figure)), LoadIndex, SpeedLevel, Batch, GoodsClass, Supplier, h.StatisHouseCode, h.StatisHouseName) as a2
...
";
                        ...
                        foreach (DataRow idr in dt.Rows)
                        {
                            ...
                            else if (type == 3)
                            {
                                result.Add(new CargoContainerShowEntity
                                {
                                    ...
                                    SalePrice = string.IsNullOrEmpty(Convert.ToString(idr["SalePrice"])) ? 0 : Convert.ToDecimal(idr["SalePrice"]),
                                    InHousePrice = string.IsNullOrEmpty(Convert.ToString(idr["InHousePrice"])) ? 0 : Convert.ToDecimal(idr["InHousePrice"]),
                                    minBatch = Convert.ToString(idr["minBatch"]),
                                    maxBatch = Convert.ToString(idr["maxBatch"]),
                                    Supplier = Convert.ToString(idr["Supplier"]),
                                    GoodsClass = Convert.ToString(idr["GoodsClass"]),
                                    combinedName = Convert.ToString(idr["combinedName"]),
                                    StatisHouseCode = Convert.ToString(idr["StatisHouseCode"]),
        ...
        {
            string strSQL = @"insert into Tbl_Cargo_StockDownload(filename, filepath, op_date) values (@filename, @filepath, @op_date);";
            try
            {
                using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
                {
        ...
        public void delFileLog()
        {
            string strSQL = @"delete from Tbl_Cargo_StockDownload where OP_DATE<DATEADD(month, -1, GETDATE());";
            try
            {
                using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
                {
        ...
        public Hashtable QueryStockFile(int pIndex, int pNum, CargoStockDownloadEntity entity)
        {
            ...
            List<CargoStockDownloadEntity> result = new List<CargoStockDownloadEntity>();
            string strSQL = $@"select top {pNum} * from(select ROW_NUMBER() OVER (ORDER BY OP_DATE DESC) AS RowNumber,* from Tbl_Cargo_StockDownload where 1=1";
            if (!string.IsNullOrEmpty(entity.FileName))
            {
                strSQL += $@" and FileName like '%{entity.FileName}%' ";
            }
            if ((entity.StartDate.ToString("yyyy-MM-dd") != "0001-01-01" && entity.StartDate.ToString("yyyy-MM-dd") != "1900-01-01"))
            {
            ...
            try
            {
                using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
                {
                    using (DataTable dt = conn.ExecuteDataTable(cmd))
                    {
                        foreach (DataRow idrCount in dt.Rows)
                        {
                            result.Add(new CargoStockDownloadEntity
                            {
                                ID = Convert.ToInt64(idrCount["ID"]),
                                FileName = Convert.ToString(idrCount["FileName"]),
                                //FilePath = Convert.ToString(idrCount["FilePath"]),
                ...
                string countSQL = $@"select Count(*) as TotalCount from Tbl_Cargo_StockDownload where 1=1";
                if (!string.IsNullOrEmpty(entity.FileName))
                {
                    countSQL += $@" and FileName like '%{entity.FileName}%' ";
                }
                if ((entity.StartDate.ToString("yyyy-MM-dd") != "0001-01-01" && entity.StartDate.ToString("yyyy-MM-dd") != "1900-01-01"))
                {
                    countSQL += " and OP_DATE>='" + entity.StartDate.ToString("yyyy-MM-dd") + "'";
                }
                if ((entity.EndDate.ToString("yyyy-MM-dd") != "0001-01-01" && entity.EndDate.ToString("yyyy-MM-dd") != "1900-01-01"))
                {
                    countSQL += " and OP_DATE<'" + entity.EndDate.AddDays(1).ToString("yyyy-MM-dd") + "'";
                }

                using (DbCommand cmd = conn.GetSqlStringCommond(countSQL))
                {
                    using (DataTable idrCount = conn.ExecuteDataTable(cmd))
                    {
                        if (idrCount.Rows.Count > 0)
                        {
                            hashtable["total"] = Convert.ToInt32(idrCount.Rows[0]["TotalCount"]);
                        }
                    }
                }
            }
        ...
        public List<CargoInterfaceEntity> QueryHouseStock(CargoInterfaceEntity entity)
        {
...
select DISTINCT ROW_NUMBER() OVER (ORDER BY a.TypeID, a.HouseID,ProductCode DESC) AS RowNumber,a.ProductID,Batch,BatchWeek, a.TypeID, a.GoodsCode,ProductCode, a.Specs, a.Figure, a.HouseID, a.Model,b.Piece,
                d.Name as HouseName,e.TypeName
from Tbl_Cargo_Product as a
         inner join Tbl_Cargo_ContainerGoods as b on a.ProductID = b.ProductID
         left join Tbl_Cargo_Container as c on b.ContainerID = c.ContainerID
inner join Tbl_Cargo_House as d on a.HouseID=d.HouseID
inner join Tbl_Cargo_ProductType as e on a.TypeID=e.TypeID
 Where a.InCargoStatus='1' and a.IsLockStock=0 and b.Piece<>0  and SpecsType='4'  and SuppClientNum='{entity.SuppClientNum}'
and Specs='{entity.Specs}' and GoodsCode='{entity.GoodsCode}' and ProductCode='{entity.ProductCode}' 
and Figure='{entity.Figure}' and a.TypeID='{entity.TypeID}' 
";
            try
            {
                using (DbCommand cmd = conn.GetSqlStringCommond(strSQL))
        ...
        public CargoStockDownloadEntity GetFileData(string ID)
        {
            ...
            try
            {
                string strSQL = $@"select * from Tbl_Cargo_StockDownload where ID={ID}";
                using (DbCommand cmdAdd = conn.GetSqlStringCommond(strSQL))
                {
                    using (DataTable dt = conn.ExecuteDataTable(cmdAdd))
                    {
                        foreach (DataRow idr in dt.Rows)
                        {
                            result = new CargoStockDownloadEntity
                            {
                                ID = Convert.ToInt64(idr["ID"]),
                                FilePath = Convert.ToString(idr["FilePath"]),
                                FileName = Convert.ToString(idr["FileName"]),
        ...
        public List<CargoContainerShowEntity> QueryToTMallStockData(CargoContainerShowEntity entity)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(entity.IsShowStock)) { strSQL += " and h.IsShowStock='" + entity.IsShowStock + "'"; }
                if (!entity.SuppClientNum.Equals(0)) { strSQL += " and a.SuppClientNum=" + entity.SuppClientNum; }
                strSQL += $@" group by a.HouseID, a.ProductCode, a.TypeID,GoodsCode";
                using (DbCommand cmdAdd = conn.GetSqlStringCommond(strSQL))
                {
                    if (!entity.HouseID.Equals(0)) { conn.AddInParameter(cmdAdd, "@HouseID", DbType.Int32, entity.HouseID); }
                    if (!string.IsNullOrEmpty(entity.ContainerCode))
        ...
        public List<operateNoticeResultPo> QueryTMallOrderExport(CargoTMallEntity entity)
        {
            CargoProductManager pro = new CargoProductManager();
            List<operateNoticeResultPo> result = new List<operateNoticeResultPo>();
            try
            {
                string strSQL = $@" select a.noticeCreateTime,CargoOrderNo,OriginBillNo,SkuOrderCode,SkuName,needOutboundNum,consigneeContacts,consigneePhone,consigneeDetail
          ,consigneeProvinceName,consigneeCityName,consigneeCountyName from Tbl_Cargo_TMallOrder as a
          inner join Tbl_Cargo_TMallOrderGoods as b on a.Id=b.PID
          where 1=1 ";
                if (!string.IsNullOrEmpty(entity.originBillNo)) { strSQL += "and a.originBillNo='" + entity.originBillNo + "'"; }
                if (!string.IsNullOrEmpty(entity.customerName)) { strSQL += "and a.customerName='" + entity.customerName + "'"; }
                if (!string.IsNullOrEmpty(entity.InCreateStatus) && entity.InCreateStatus != "-1") { strSQL += "and a.InCreateStatus='" + entity.InCreateStatus + "'"; }
                if (!string.IsNullOrEmpty(entity.consigneeContacts)) { strSQL += " and a.consigneeContacts like '%" + entity.consigneeContacts + "%'"; }
                ...
                strSQL += $@" order by noticeCreateTime";
                using (DbCommand cmdAdd = conn.GetSqlStringCommond(strSQL))
                {
                    using (DataTable dt = conn.ExecuteDataTable(cmdAdd))
                    {
                        foreach (DataRow idr in dt.Rows)
                        {
                            result.Add(new operateNoticeResultPo
                            {
                                // 新增字段（处理 DBNull 避免转换异常）
                                CargoOrderNo = idr["CargoOrderNo"] == DBNull.Value ? string.Empty : Convert.ToString(idr["CargoOrderNo"]),
                                consigneeCityName = idr["consigneeCityName"] == DBNull.Value ? string.Empty : Convert.ToString(idr["consigneeCityName"]),
                                consigneeContacts = idr["consigneeContacts"] == DBNull.Value ? string.Empty : Convert.ToString(idr["consigneeContacts"]),
                                consigneeCountyName = idr["consigneeCountyName"] == DBNull.Value ? string.Empty : Convert.ToString(idr["consigneeCountyName"]),
                                consigneeDetail = idr["consigneeDetail"] == DBNull.Value ? string.Empty : Convert.ToString(idr["consigneeDetail"]),
                                consigneePhone = idr["consigneePhone"] == DBNull.Value ? string.Empty : Convert.ToString(idr["consigneePhone"]),
                                consigneeProvinceName = idr["consigneeProvinceName"] == DBNull.Value ? string.Empty : Convert.ToString(idr["consigneeProvinceName"]),
                                needOutboundNum = idr["needOutboundNum"] == DBNull.Value ? 0 : Convert.ToInt32(idr["needOutboundNum"]),
                                noticeCreateTime_Actual = idr["noticeCreateTime"] == DBNull.Value ? DateTime.MinValue : Convert.ToDateTime(idr["noticeCreateTime"]),
                                originBillNo = idr["OriginBillNo"] == DBNull.Value ? string.Empty : Convert.ToString(idr["OriginBillNo"]),
                                skuName = idr["SkuName"] == DBNull.Value ? string.Empty : Convert.ToString(idr["SkuName"]),
                                skuOrderCode = idr["SkuOrderCode"] == DBNull.Value ? string.Empty : Convert.ToString(idr["SkuOrderCode"])
                            });
                        }
                    }
                }
