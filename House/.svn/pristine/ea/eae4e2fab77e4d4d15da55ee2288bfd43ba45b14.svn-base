        ...
        $(function () {
            ...
            $('#dgBrandConverRate').datagrid({
                ...
                columns: [[
                    ...
                    { title: '成交量', field: 'OrderPiece', width: '70px' },
                    { title: '转化率', field: 'OrderNum', width: '60px', align: 'right' },
                ]],
                onClickRow: function (index, row) {
            ...
            $('#dgClientConverRate').datagrid({
                ...
                rownumbers: true,
                columns: [[
                    { title: '门店名称', field: 'ClientName', width: '150px' },
                    { title: '月浏览量', field: 'BrowseNum', width: '70px' },
                    { title: '成交量', field: 'OrderPiece', width: '70px' },
                    { title: '转化率', field: 'OrderNum', width: '60px', align: 'right' },
                ]],
 ...
 <a href="#" class="easyui-linkbutton" iconcls="icon-cancel" onclick="javascript:$('#dlgFeedBack').dialog('close')">&nbsp;&nbsp;取&nbsp;消&nbsp;&nbsp;</a>
    ...
    <script type="text/javascript">
        ...
        function RELOAD() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#ReturnOrderMonthPiece").text(newData.Order.ReturnOrderMonthPiece)
                    $("#OESSaleOrderMonthPiece").text(newData.Order.OESSaleOrderMonthPiece)
                    ...
                    $("#OESSaleOrderMonthCharge").text((newData.Order.OESSaleOrderMonthCharge / 10000).toFixed(2))
            ...
            $.ajax({
                type: 'post',
                url: "reportApi.aspx?method=QueryHCYC_BrandNum",
                data: {
                    HouseID: $('#HouseID').combobox('getValue'),
                    StartDate: $('#StartDate').datebox('getValue'),
                    EndDate: $('#EndDate').datebox('getValue'),
                ...
                success: function (dt) {
                    var data = eval(dt);
                    $('#dgBrand').datagrid('loadData', data);
                    var brandLabels = [];
            ...
            $.ajax({
                type: 'post',
                url: "reportApi.aspx?method=QueryHCYC_BrandConverRate",
                data: {
                    HouseID: $('#HouseID').combobox('getValue'),
                    StartDate: $('#StartDate').datebox('getValue'),
                    EndDate: $('#EndDate').datebox('getValue'),
                ...
                success: function (dt) {
                    var data = eval(dt);
                    $('#dgBrandConverRate').datagrid('loadData', data);
            ...
            $.ajax({
                type: 'post',
                url: "reportApi.aspx?method=QueryHCYC_ClientConverRate",
                data: {
                    HouseID: $('#HouseID').combobox('getValue'),
                    StartDate: $('#StartDate').datebox('getValue'),
                    EndDate: $('#EndDate').datebox('getValue'),
        ...
        function QueryHCYC_KeyWordNum() {
            $.ajax({
                type: 'post',
                url: "reportApi.aspx?method=QueryHCYC_KeyWordNum",
                data: {
                    HouseID: $('#HouseID').combobox('getValue'),
                    StartDate: $('#StartDate').datebox('getValue'),
                    EndDate: $('#EndDate').datebox('getValue'),
