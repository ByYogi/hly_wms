...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //一次获取所有库存数据，每次显示库存详情给到ParentID选项用
            $.getJSON('houseApi.aspx?method=QueryALLHouse', function (data) {
                allHouseData = data; // 缓存数据
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="toolbar">
        ...
        <a href="#" class="easyui-linkbutton" iconcls="icon-lock_edit" plain="false" onclick="OrderPermissSet()">权限设置</a>&nbsp;&nbsp;
    </div>
    <div id="dlg" class="easyui-dialog" style="width: 980px; height: 620px; padding: 0px"
            ...
            <div id="saPanel">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="BelongHouse" id="eBelongHouse" editable="false" style="width: 250px;"
                    ...
                    <tr>
                        <td style="text-align: right;">上级仓库:
                        </td>
                        <td>
                            <input name="ParentID" class="easyui-combobox" style="width: 250px;" id="ParentID-cmbx" />
                        </td>
                        <td style="text-align: right;"></td>
                        <td>
                            <input name="" class="easyui-textbox" style="width: 250px;" />
                        </td>
                    </tr>
                    <tr>
    ...
    <%-- 品牌共享 --%>
    <div id="dlgGX" class="easyui-dialog" style="width: 830px; height: 380px; padding: 0px"
        ...
        <form id="fmGX" class="easyui-form" method="post">
            ...
            <div style="padding: 10px; background-color: #f5f5f5; border-bottom: 1px solid #ddd;">
                <table style="width: 100%;">
                    <tr>
                        <td style="text-align: right; width: 80px;">品牌筛选:</td>
                        <td style="width: 200px; padding-right: 20px;">
                            <input id="FilterBrandID" name="FilterBrandID" class="easyui-combobox" style="width: 100%;" />
                        </td>
                        <td style="text-align: right; width: 80px;">前置仓筛选:</td>
                        <td style="width: 200px;">
                            <input id="FilterMainHouseID" name="FilterMainHouseID" class="easyui-combobox" style="width: 100%;" />
                        </td>
                        <td style="padding-left: 20px;">
                            <a href="#" class="easyui-linkbutton" iconcls="icon-search" onclick="filterHouseShare()">筛选</a>
                            <a href="#" class="easyui-linkbutton" iconcls="icon-reload" onclick="clearHouseShareFilter()">重置</a>
                        </td>
                    </tr>
                </table>
            </div>
    ...
    <div id="dlgGX-buttons">
        <a href="#" class="easyui-linkbutton" iconcls="icon-arrow_refresh" onclick="ShareHouseSynchronization()">同步</a>&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div id="dlgGXDetail" class="easyui-dialog" style="width: 320px; height: 280px; padding: 0px"
        ...
        <form id="fmGXDetail" class="easyui-form" method="post">
            ...
            <table>
                <tr>
                    <td style="text-align: right;">主仓:</td>
                    <td>
                        <input id="ShareHouseID" name="ShareHouseID" class="easyui-combobox" readonly disabled style="width: 100%;" />
                    </td>
                ...
                <tr>
                    <td style="text-align: right;">前置仓:</td>
                    <td>
                        <input id="MainHouseID" name="MainHouseID" data-options="required:true" class="easyui-combobox" style="width: 100%;" />
    ...
    <div id="dlgOrder" class="easyui-dialog" style="width: 900px; height: 350px; padding: 2px 2px" closed="true" buttons="#dlgOrder-buttons">
        <form id="fmOrder" class="easyui-form" method="post">
            <input type="hidden" name="HouseID" />

            <fieldset>
                <legend><span style="font-size: 14px; font-weight: bolder;">自动开单设置</span></legend>
                <div id="saPanel">
                    <table style="width: 100%;">
                        <tr>
                            <td style="text-align: right;">开思自动开单:
                            </td>
                            <td>
                                <input name="IsCassAutoOrder" id="IsCassAutoOrder0" type="radio" value="0" />
                                <label for="IsCassAutoOrder0" style="font-size: 15px;">关闭</label>
                                <input name="IsCassAutoOrder" id="IsCassAutoOrder1" type="radio" value="1" />
                                <label for="IsCassAutoOrder1" style="font-size: 15px;">开启</label>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right;">马牌自动开单:
                            </td>
                            <td>
                                <input name="IsContiAutoOrder" id="IsContiAutoOrder0" type="radio" value="0" />
                                <label for="IsContiAutoOrder0" style="font-size: 15px;">关闭</label>
                                <input name="IsContiAutoOrder" id="IsContiAutoOrder1" type="radio" value="1" />
                                <label for="IsContiAutoOrder1" style="font-size: 15px;">开启</label>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right;">天猫自动开单:
                            </td>
                            <td>
                                <input name="IsTMaoAutoOrder" id="IsTMaoAutoOrder0" type="radio" value="0" />
                                <label for="IsTMaoAutoOrder0" style="font-size: 15px;">关闭</label>
                                <input name="IsTMaoAutoOrder" id="IsTMaoAutoOrder1" type="radio" value="1" />
                                <label for="IsTMaoAutoOrder1" style="font-size: 15px;">开启</label>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right;">途虎自动开单:
                            </td>
                            <td>
                                <input name="IsTuhuAutoOrder" id="IsTuhuAutoOrder0" type="radio" value="0" />
                                <label for="IsTuhuAutoOrder0" style="font-size: 15px;">关闭</label>
                                <input name="IsTuhuAutoOrder" id="IsTuhuAutoOrder1" type="radio" value="1" />
                                <label for="IsTuhuAutoOrder1" style="font-size: 15px;">开启</label>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right;">三头六臂自动开单:
                            </td>
                            <td>
                                <input name="IsSanAutoOrder" id="IsSanAutoOrder0" type="radio" value="0" />
                                <label for="IsSanAutoOrder0" style="font-size: 15px;">关闭</label>
                                <input name="IsSanAutoOrder" id="IsSanAutoOrder1" type="radio" value="1" />
                                <label for="IsSanAutoOrder1" style="font-size: 15px;">开启</label>
                            </td>
                        </tr>
    ...
    <div id="dlgOrder-buttons">
        <a href="#" class="easyui-linkbutton" iconcls="icon-ok" onclick="saveHouseOrderPermiss()">&nbsp;保&nbsp;存&nbsp;</a>&nbsp;&nbsp;
    ...
    <script type="text/javascript">
        ...
        //保存数据
        function saveHouseOrderPermiss() {
            $.messager.progress({ msg: '请稍后,正在保存中...' });
            $('#fmOrder').form('submit', {
                url: 'houseApi.aspx?method=saveHouseOrderPermiss',
                onSubmit: function () {
                ...
                success: function (msg) {
                    ...
                    if (result.Result) {
                        ...
                        $.messager.alert('<%= Cargo.Common.GetSystemNameAndVersion()%>', '设置失败：' + result.Message, 'warning');
                    }
                }
            })
        }
        ...
        function OrderPermissSet() {
            ...
            if (row) {
                $('#dlgOrder').dialog('open').dialog('setTitle', '设置仓库：' + row.Name + ' 权限信息');
                ...
                $('#fmOrder').form('load', row);
                if (row.IsCassAutoOrder == "0") { $("#IsCassAutoOrder0").prop('checked', 'checked'); }
                else { $("#IsCassAutoOrder1").prop('checked', 'checked'); }
                if (row.IsContiAutoOrder == "0") { $("#IsContiAutoOrder0").prop('checked', 'checked'); }
                else { $("#IsContiAutoOrder1").prop('checked', 'checked'); }
                if (row.IsTuhuAutoOrder == "0") { $("#IsTuhuAutoOrder0").prop('checked', 'checked'); }
                else { $("#IsTuhuAutoOrder1").prop('checked', 'checked'); }
                if (row.IsSanAutoOrder == "0") { $("#IsSanAutoOrder0").prop('checked', 'checked'); }
                else { $("#IsSanAutoOrder1").prop('checked', 'checked'); }

                if (row.IsTMaoAutoOrder == "0") { $("#IsTMaoAutoOrder0").prop('checked', 'checked'); }
                else { $("#IsTMaoAutoOrder1").prop('checked', 'checked'); }
        ...
        function editItemByID(Did) {
            ...
            if (row) {
                ...
                //ParentID 选项筛除自身和子仓库
                const currentID = row.HouseID;
                var houseOptionsfiltered = $.grep(allHouseData, function (item) {
                    return item.HouseID != currentID && item.ParentID != currentID;
                });
                console.log("allHouseData", { allHouseData, houseOptionsfiltered })
                $('#ParentID-cmbx').combobox({
                    // url: 'houseApi.aspx?method=QueryALLHouse',
                    valueField: 'HouseID',
                    textField: 'Name',
                    data: houseOptionsfiltered
                })
        ...
        function BrandHouseShared() {
            ...
            if (row) {
                ...
                gridOpts.url = 'houseApi.aspx?method=QueryHouseShareList&ShareHouseID=' + row.HouseID;
            }
        }
        //仓库目标列表
        function showdgHouseShare() {
            $('#HouseShareTable').datagrid({
                ...
                columns: [[
                    { title: '', field: 'ID', checkbox: true, width: '30px' },
                    { title: '主仓', field: 'ShareHouseName', width: '100px' },
                    { title: '品牌', field: 'BrandName', width: '100px' },
                    { title: '前置仓', field: 'MainHouseName', width: '100px' },
                    {
        ...
        function OpenHouseShare() {
            ...
            $('#ShareHouseID').combobox('setValue', houseId);
        ...
        function ShareHouseSynchronization() {
            ...
            var json = JSON.stringify(rows)
            $.ajax({
                url: 'houseApi.aspx?method=ShareHouseSynchronization',
                type: 'post', dataType: 'json', data: { DelData: json },
                success: function (text) {
                    //var result = eval('(' + msg + ')');
                    if (text.Result == true) {
        ...
        function saveHouseShare() {
            ...
            $('#fmGXDetail').form('submit', {
                ...
                onSubmit: function (param) {
                    param.ShareHouseID = $('#ShareHouseID').combobox('getValue');
        ...
        // 筛选品牌仓库共享数据
        function filterHouseShare() {
            var houseId = $("#GXHouseID").val();
            var brandId = $('#FilterBrandID').combobox('getValue');
            var mainHouseId = $('#FilterMainHouseID').combobox('getValue');
            
            $('#HouseShareTable').datagrid('clearSelections');
            var gridOpts = $('#HouseShareTable').datagrid('options');
            gridOpts.url = 'houseApi.aspx?method=QueryHouseShareList&ShareHouseID=' + houseId +
                          (brandId ? '&BrandID=' + brandId : '') +
                          (mainHouseId ? '&MainHouseID=' + mainHouseId : '');
            $('#HouseShareTable').datagrid('reload');
        }

        // 重置筛选条件
        function clearHouseShareFilter() {
            $('#FilterBrandID').combobox('clear');
            $('#FilterMainHouseID').combobox('clear');
