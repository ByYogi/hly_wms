<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YFLogisTrack.aspx.cs" Inherits="Cargo.YFLogisTrack" %>
...
<body>
    <form id="form1" runat="server">
        <img src="CSS/image/yqft.jpg" style="height: 110px; /*display: block; */ margin: auto;" />
    <div class="cantent" style="text-align: center;">
        <p style="color: red; font-size: 20px;">一汽丰田轮胎订单跟踪状态查询</p>
        <p></p>
        <input id="ATagCode" class="easyui-textbox" data-options="prompt:'请输入贵司8位客户订单编号'" style="width: 90%; height: 75px; font-size: 45px;" />
