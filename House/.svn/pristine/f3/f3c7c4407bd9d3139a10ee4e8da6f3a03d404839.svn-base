    ...
    <script type="text/javascript">
        ...
        function dosearch() {
            ...
            $('#dg').datagrid('load', {
                ...
                OrderOwnerName: $("#OrderOwnerName").val(),
            });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="saPanel" name="SelectDiv1" class="easyui-panel" title="" data-options="iconCls:'icon-search'" style="width: 100%">
        <table id="saPanelTab">
            <tr>
                ...
                <td>
                    <input id="OrderOwnerName" class="easyui-textbox" data-options="prompt:'输入订单所属公司'" style="width: 100px" />
                </td>
    ...
    <%--此div用于导入数据--%>
    <%--此div用于查看/新增/编辑数据--%>
    <div id="dlgedit" class="easyui-dialog" style="width: 800px; height: 500px; padding: 0px"
    ...
    <script type="text/javascript">
        ...
        function showGrid() {
            ...
            columns.push({ title: '仓库名称', field: 'HouseName', width: '90px' });
            columns.push({ title: '总库存', field: 'Piece', width: '70px' });
            columns.push({ title: '周期9月内', field: 'Stock', width: '70px' });
            columns.push({ title: '周期9月外', field: 'NoStock', width: '70px' });
            columns.push({ title: '当天预计到仓数量', field: 'QtyToday', width: '110px' });
            columns.push({ title: '明天预计到仓数量', field: 'QtyTomorrow', width: '110px' });
            columns.push({ title: '后天预计到仓数量', field: 'QtyDayAfterTomorrow', width: '110px' });
