...
namespace Cargo.Interface
{
    ...
    public class MiniProSer : IHttpHandler
    {
        ...
        private void wxLogin(HttpContext context)
        {
            ...
            //oiask.openid = "oUu146_yQpj_RhzLUOTWI_GNm2Dg";
            ...
            else
            {
                ...
                weiChartData.IsShowExpedit = "1";
                weiChartData.IsShowNextDay = "1";
                double distance = 0;
        ...
        private void GetProductList(HttpContext context)
        {
            ...
            queryEntity.SalePrice = 10;//设置过滤价格低于50元的
            ...
            foreach (CargoContainerShowEntity product in list)
            {
                ...
                lstCategory.Add(new GoodsInfo
                {
                    ...
                    //minPrice = product.SpecsType.Equals("4") ? Math.Round(product.SalePrice + Common.GetHCYCTodayOrderTransitFee() + (product.SalePrice * 0.009M), MidpointRounding.AwayFromZero) : Math.Round(product.SalePrice + (product.SalePrice * 0.009M), MidpointRounding.AwayFromZero),//现价销售价
        ...
        private void CreateMiniProOrder(HttpContext context)
        {
            ...
            if (!CheckOutType.Equals(6))
            {
                try
                {
                    ...
                    Dictionary<String, String> rsp = sybService.pay(Convert.ToInt64(Convert.ToDecimal(YPTotalMoney) * 100), orderno, "W06", "慧采云仓小程序支付", YPRemark, wxUser.wxOpenID, "", "https://dlt.neway5.com/Interface/UnionPaySuccess.aspx", "");
        ...
        private void RefundApplyOrder(HttpContext context)
        {
            ...
            if (wo.ThrowGood.Equals("23") && !ints.Contains(wo.SuppClientNum))
            {
