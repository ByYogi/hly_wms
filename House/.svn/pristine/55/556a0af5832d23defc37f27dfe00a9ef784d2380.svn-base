...
{
    public partial class ChannelCustomers:BasePage
    {
        ...
        protected void btnDerived_Click(object sender, EventArgs e)
        {
            ...
            table.Columns.Add("公司负责人", typeof(string));
            ...
            //table.Columns.Add("轮胎公司", typeof(string));
