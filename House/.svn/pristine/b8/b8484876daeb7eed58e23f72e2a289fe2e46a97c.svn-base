<%@ Page Title="其他业务收款" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="financeByOtherBusinessReceive.aspx.cs" Inherits="Cargo.Finance.financeByOtherBusinessReceive" %>
        ...
        <table>
            <tr>
                <td>
                    ...
                    <a class="easyui-linkbutton" iconcls="icon-coins_add" plain="false" style="color: Red;" href="../Finance/financeByOtherBusinessReceive.aspx" target="_self">&nbsp;其它业务收款&nbsp;</a>
                </td>
            </tr>
        </table>
    </div>
            ...
            <form id="fm" class="easyui-form" method="post">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" class="easyui-linkbutton" iconcls="icon-cart_put" plain="false" onclick="save()">&nbsp;正&nbsp;常&nbsp;收&nbsp;款&nbsp;</a>&nbsp;&nbsp;
                            <a href="#" class="easyui-linkbutton" iconcls="icon-cart_put" plain="false" onclick="over()">&nbsp;强&nbsp;制&nbsp;结&nbsp;清&nbsp;</a>&nbsp;&nbsp;
                        </td>
                    </tr>
                </table>
            </form>
            ...
            $.messager.confirm('<%= Cargo.Common.GetSystemNameAndVersion()%>', '确定收款？', function (r) {
                if (r) {
                    ...
                    $.ajax({
                        ...
                        type: "post",
                        data: { data: json, ty: 13, cStarus: "0" },
            ...
            $.messager.confirm('<%= Cargo.Common.GetSystemNameAndVersion()%>', '确定强制结清？', function (r) {
                if (r) {
                    ...
                    $.ajax({
                        ...
                        url: "../Finance/financeApi.aspx?method=SaveCash&" + formjson,
                        type: "post",
                        data: { data: json, ty: 13, cStarus: "1" },
                        success: function (msg) {
                            $('#save').linkbutton('enable');
                            var result = eval('(' + msg + ')');
                            if (result.Result) {
