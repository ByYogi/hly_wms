    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if (HID == "47") {
                ...
                columns.push({
                    title: '轮胎类型', field: 'TyreModel', width: '60px', formatter: function (val, row, index) {
                        if (val == "0") { return "<span title='正常胎'>正常胎</span>"; }
                        else if (val == "1") { return "<span title='质量胎'>质量胎</span>"; }
                        else if (val == "2") { return "<span title='磨码胎'>磨码胎</span>"; }
                        else if (val == "3") { return "<span title='理赔胎'>理赔胎</span>"; }
                        else { return "<span title='正常胎'>正常胎</span>"; }
                    }
                });
                columns.push({
                ...
                columns.push({
                    title: '小程序价', field: 'SalePrice', width: '50px', align: 'right', formatter: function (value) {
                        return "<span title='" + value + "'>" + value + "</span>";
                    }
                });
                columns.push({
                ...
                columns.push({
                    title: '次日达价', field: 'NextDayPrice', width: '70px', align: 'right', formatter: function (value) {
                        return "<span title='" + value + "'>" + value + "</span>";
                    }
                });
                columns.push({
                    title: '批发价', field: 'WholesalePrice', width: '50px', align: 'right', formatter: function (value) {
                        return "<span title='" + value + "'>" + value + "</span>";
                    }
                });
                ...
                columns.push({
                    title: '来源', field: 'Source', width: '120px', formatter: function (value) {
                        return "<span title='" + GetSourceName(value) + "'>" + GetSourceName(value) + "</span>";
                    }
                });
                columns.push({
                ...
                columns.push({
                    title: '规格类型', field: 'SpecsType', width: '80px', formatter: function (val, row, index) {
                ...
                columns.push({
                    title: '归属月', field: 'BelongMonth', width: '60px', formatter: function (value) {
                        return "<span title='" + value + "'>" + value + "</span>";
                    }
                });
                columns.push({
                ...
                columns.push({
                    title: '质量问题描述', field: 'QalityRemark', width: '150px', formatter: function (value) {
                        return "<span title='" + value + "'>" + value + "</span>";
                    }
                });
                columns.push({ title: '操作时间', field: 'OP_DATE', width: '130px', formatter: DateTimeFormatter });
        ...
        function dosearch() {
            ...
            if ($('#AHouseID').combobox('getValue') != $('#HiddenHouseID').val()) {
                ...
                if ($('#AHouseID').combobox('getValue') == "47") {
                    ...
                    columns.push({
                        title: '批发价', field: 'WholesalePrice', width: '70px', align: 'right', formatter: function (value) {
                            return "<span title='" + value + "'>" + value + "</span>";
                        }
                    });
                    ...
                    columns.push({
                        title: '订单归属', field: 'BelongMonth', width: '60px', formatter: function (value) {
                            return "<span title='" + value + "'>" + value + "</span>";
                        }
                    });
                    columns.push({
            ...
            $('#dg').datagrid('load', {
                ...
                TyreModel: $("#TyreModel").combobox('getValue'),
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="saPanel" name="SelectDiv1" class="easyui-panel" title="" data-options="iconCls:'icon-search'" style="width: 100%">
        <table>
            ...
            <tr>
                ...
                <td style="text-align: right;">轮胎类型:
                </td>
                <td>
                    <select class="easyui-combobox" id="TyreModel" name="TyreModel" style="width: 80px;" panelheight="auto" editable="false">
                        <option value="-1">全部</option>
                        <option value="0">正常胎</option>
                        <option value="1">质量胎</option>
                        <option value="2">磨码胎</option>
                        <option value="3">理赔胎</option>
                    </select>
                </td>
    ...
    <div id="dlg" class="easyui-dialog" style="width: 700px; height: 550px; padding: 1px 1px"
                        ...
                        <td style="vertical-align: top">
                            <table>
                                ...
                                <tr id="Y15">
                                    ...
                                    <td>
                                        <select class="easyui-combobox" id="Assort" name="Assort" style="width: 200px;" panelheight="auto">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="easyui-combobox" name="TyreModel" style="width: 200px;" panelheight="auto">
                                            <option value="0">正常胎</option>
                                            <option value="1">质量胎</option>
                                            <option value="2">磨码胎</option>
                                            <option value="3">理赔胎</option>
