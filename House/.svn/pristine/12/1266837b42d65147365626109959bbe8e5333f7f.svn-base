    ...
    public class EventMessage : Message
    {
        ...
        public static EventMessage LoadFromXml(string xml)
        {
            ...
            if (!string.IsNullOrEmpty(xml))
            {
                ...
                {
                    em = new EventMessage();
                    em.FromUserName = element.Element(WeiXinService.FROM_USERNAME).Value;
                    em.ToUserName = element.Element(WeiXinService.TO_USERNAME).Value;
                    em.CreateTime = element.Element(WeiXinService.CREATE_TIME).Value;
