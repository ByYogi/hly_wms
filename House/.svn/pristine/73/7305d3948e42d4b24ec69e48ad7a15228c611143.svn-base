...
{
    public partial class dealerOrderManger : BasePage
    {
        ...
        protected void btnOrderInfo_Click(object sender, EventArgs e)
        {
            if (UserInfor.HouseID.Equals(82))
            {
                ...
                foreach (var it in list)
                {
                    ...
                    newRows["费用"] = it.GetType().GetProperty("TotalCharge").GetValue(it, null).ToString();
                    ...
                    TNum += Convert.ToInt32(it.GetType().GetProperty("Piece").GetValue(it, null).ToString());
                    TCharge += Convert.ToDecimal(it.GetType().GetProperty("TotalCharge").GetValue(it, null).ToString());
                }
                DataRow toRows = table.NewRow();
                toRows["出库仓库"] = "汇总：";
                toRows["数量"] = TNum.ToString();
                toRows["费用"] = TCharge.ToString("F2");

                table.Rows.Add(toRows);

                ToExcel.DataTableToExcel(table, "", "锦湖客户订单数据列表");
            }
            else if (UserInfor.HouseID.Equals(10))
            {
                ...
                table.Columns.Add("到达站", typeof(string));
                table.Columns.Add("数量", typeof(string));
                table.Columns.Add("配送费用", typeof(string));
                table.Columns.Add("客户名称", typeof(string));
                table.Columns.Add("收货人", typeof(string));
                table.Columns.Add("联系手机", typeof(string));
                table.Columns.Add("收货地址", typeof(string));
                ...
                foreach (var it in list)
                {
                    ...
                    newRows["到达站"] = it.GetType().GetProperty("Dest").GetValue(it, null).ToString();
                    newRows["数量"] = it.GetType().GetProperty("Piece").GetValue(it, null).ToString();
                    newRows["配送费用"] = it.GetType().GetProperty("TotalCharge").GetValue(it, null).ToString();
                    newRows["客户名称"] = it.GetType().GetProperty("AcceptUnit").GetValue(it, null).ToString();
                    newRows["收货人"] = it.GetType().GetProperty("AcceptPeople").GetValue(it, null).ToString();
                    newRows["联系手机"] = it.GetType().GetProperty("AcceptTelephone").GetValue(it, null).ToString();
                    newRows["收货地址"] = it.GetType().GetProperty("AcceptAddress").GetValue(it, null).ToString();
                ...
                toRows["出库仓库"] = "汇总：";
                toRows["数量"] = TNum.ToString();
                toRows["配送费用"] = TCharge.ToString("F2");

                table.Rows.Add(toRows);

                ToExcel.DataTableToExcel(table, "", "安泰路斯客户订单数据列表");
            }
            else
            {
                var List = QueryOrderInfoList["rows"];
                ...
                foreach (var it in list)
                {
                    ...
                    newRows["收入"] = it.GetType().GetProperty("TotalCharge").GetValue(it, null).ToString();
