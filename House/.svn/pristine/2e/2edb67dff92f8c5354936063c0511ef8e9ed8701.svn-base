...
namespace House.Business.Cargo
{
    ...
    public class CargoOrderBus
    {
                    ...
                    foreach (var it in entity)
                    {
                        ...
                        if (!string.IsNullOrEmpty(it.WXOrderNo))
                        {
                            ...
                            if (wxOrder != null && !wxOrder.ID.Equals(0))
                            {
                                ...
                                weixin.DeleteWeixinOrder(new WXOrderEntity { ID = wxOrder.ID });
                            }
        ...
        public void InsertDayWxOrder(string opid=null)
        {
            //当月，按天统计
            string StartMonth = DateTime.Now.ToString("yyyy-MM-01");
            string EndMonth = Convert.ToDateTime(StartMonth).AddMonths(1).AddDays(-1).ToString("yyyy-MM-dd") ;
