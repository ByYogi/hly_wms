<%@ Page Title="报销付款监督" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="financeExpensePayMonitor.aspx.cs" Inherits="Cargo.Finance.financeExpensePayMonitor" %>
            ...
            $('#dg').datagrid({
                ...
                columns: [[
                  ...
                  },
                  {
                      ...
                      formatter: function (val, row, index) { if (val == "0") { return "现金"; } else if (val == "1") { return "银行卡"; } else if (val == "2") { return "油卡"; } else { return ""; } }
                  },
                  {
                  ...
                  {
                      title: '应付', field: 'ExCharge', width: '70px', align: 'right', formatter: function (value) {
                          if (value != null && value != "") {
                              return "<span title='" + value + "'>" + value + "</span>";
                          }
                      }
                  ...
                  {
                      title: '已付', field: 'ReceivedMoney', width: '70px', align: 'right', formatter: function (value) {
                          if (value != null && value != "") {
                              return "<span title='" + value + "'>" + value + "</span>";
                          }
                      }
                  ...
                  {
                      title: '未付', field: 'UncollectMoney', width: '70px', align: 'right', formatter: function (value) {
                          if (value != null && value != "") {
                              return "<span title='" + value + "'>" + value + "</span>";
                          }
                      }
                  ...
                  { title: '付款时间', field: 'OP_DATE', width: '130px', formatter: DateTimeFormatter },
                  {
                ...
                <td>
                    <a class="easyui-linkbutton" iconcls="icon-monitor_lightning" plain="false"
                        href="../Finance/financeOrderReceiveMonitor.aspx" target="_self">&nbsp;订单收款监督&nbsp;</a>&nbsp;&nbsp; <a class="easyui-linkbutton" iconcls="icon-monitor_lightning" plain="false"
                            href="../Finance/financeExpenseReceiveMonitor.aspx" target="_self">&nbsp;报销收款监督&nbsp;</a>&nbsp;&nbsp; <a class="easyui-linkbutton" iconcls="icon-monitor_lightning" style="color: Red;" plain="false"
