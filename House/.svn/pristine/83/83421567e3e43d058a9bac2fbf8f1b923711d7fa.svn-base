            ...
            <div id="saPanel">
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="ApproveID" id="ApproveID" class="easyui-combobox" style="width: 140px;" data-options="required:true" />
                        </td>
                    </tr>
                    <tr>
...
<%--            if ($('#ApproveID').combobox('getValue') == "") {
            ...
            $.ajax({
                ...
                type: "post", data: { submitData: json, clientName: $('#ClientID').textbox('getText') },
