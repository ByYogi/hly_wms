...
namespace House.Business.Cargo
{
    ...
    public class CargoStaticBus
    {
        ...
        {
            return man.QueryCargoNoticeUser(pIndex, pNum, entity);
        }
        ...
        {
            return man.QueryUnreadMessage(entity);
        }
        ...
        {
            return man.QueryNoticeUserView(entity);
        }
        /// <summary>
        /// 新增用户查看公告消息
        /// </summary>
        /// <param name="entity"></param>
        public void AddNoticeUserView(CargoNoticeUserViewEntity entity, LogEntity log)
        {
            LogWrite<CargoNoticeUserViewEntity> lw = new LogWrite<CargoNoticeUserViewEntity>();
            //使用事务
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required))
            {
                try
                {
                    man.AddNoticeUserView(entity);
                    log.Memo = "新增用户查看消息 公告ID：" + entity.MessageID + ",消息标题：" + entity.Title + "消息类型 :" + entity.MessageType + ",阅读状态：" + entity.ReadStatus + ",登陆名：" + entity.LoginName;
                    lw.WriteLog(log);
                    scope.Complete();
                }
                catch (ApplicationException ex)
        ...
        /// <param name="entity"></param>
        /// <param name="log"></param>
        public void UpdateNoticeUserView(CargoNoticeUserViewEntity entity, LogEntity log)
        {
            LogWrite<CargoNoticeEntity> lw = new LogWrite<CargoNoticeEntity>();
            //使用事务
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required))
            {
                try
                {
                    man.UpdateNoticeUserView(entity);
                    log.Memo = "修改公告 公告ID：" + entity.MessageID + ",消息标题：" + entity.Title + "消息类型 :" + entity.MessageType + ",阅读状态：" + entity.ReadStatus + ",登陆名：" + entity.LoginName;
                    lw.WriteLog(log);
                    scope.Complete();
                }
                catch (ApplicationException ex)
        ...
        {
            return man.QueryCargoDailyReports(pIndex, pNum, entity);
        }
        /// <summary>
        /// 查询我的日报信息
        /// </summary>
        ...
        {
            return man.QueryDailyReportsByID(entity);
        }
        /// <summary>
        /// 查询我的可批复日报
        /// </summary>
        ...
        {
            return man.QueryCanDailyReports(entity);
        }
        /// <summary>
        /// 查询可评论人员
        /// </summary>
        ...
        {
            return man.QueryUserReportComments(entity);
        }
        /// <summary>
        /// 添加我的日报
        /// </summary>
        ...
        public void AddDailyReports(CargoDailyReportsEntity entity, LogEntity log)
        {
            LogWrite<CargoNoticeUserViewEntity> lw = new LogWrite<CargoNoticeUserViewEntity>();
            //使用事务
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required))
            {
                try
                {
                    man.AddDailyReports(entity);
                    log.Memo = "新增我的日报 日报标题：" + entity.Title + ",登陆名：" + entity.LoginName + "姓名 :" + entity.UserName + ",日报可评论姓名：" + entity.UserReportName;
                    lw.WriteLog(log);
                    scope.Complete();
                }
                catch (ApplicationException ex)
        ...
        /// <param name="entity"></param>
        /// <exception cref="ApplicationException"></exception>
        public void UpdateDailyReports(CargoDailyReportsEntity entity, LogEntity log)
        {
            LogWrite<CargoDailyReportsEntity> lw = new LogWrite<CargoDailyReportsEntity>();
            //使用事务
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required))
            {
                try
                {
                    man.UpdateDailyReports(entity);
                    log.Memo = "修改公告 日报标题：" + entity.Title + ",登陆名：" + entity.LoginName + "姓名 :" + entity.UserName + ",日报可评论姓名：" + entity.UserReportName + ",日报ID：" + entity.ID;
                    lw.WriteLog(log);
                    scope.Complete();
                }
                catch (ApplicationException ex)
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void DelCargoDailyReports(List<CargoDailyReportsEntity> entity, LogEntity log)
        {
            LogWrite<CargoDailyReportsEntity> lw = new LogWrite<CargoDailyReportsEntity>();
            //使用事务
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required))
            {
                try
                {
                    man.DelCargoDailyReports(entity);
                    log.Memo = "删除日报 ";
                    foreach (var it in entity)
                    {
                        log.Memo += "日报标题：" + it.Title + ",登陆名：" + it.LoginName + "姓名: " + it.UserName + ",日报可评论姓名：" + it.UserReportName + ",日报ID：" + it.ID;
                    }
                    lw.WriteLog(log);
                    scope.Complete();
                }
        ...
        {
            return man.QueryReportComments(entity);
        }
        /// <summary>
        /// 添加我的日报评论
        /// </summary>
        /// <param name="entity"></param>
        /// <exception cref="ApplicationException"></exception>
        public void AddReportComments(CargoReportCommentsEntity entity, LogEntity log)
        {
            LogWrite<CargoReportCommentsEntity> lw = new LogWrite<CargoReportCommentsEntity>();
            //使用事务
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required))
            {
                try
                {
                    man.AddReportComments(entity);
                    log.Memo = "新增我的日报批复 日报ID：" + entity.Report_id + ",评论内容：" + entity.Content + ",登陆名：" + entity.LoginName + "姓名 :" + entity.UserName ;
                    lw.WriteLog(log);
                    scope.Complete();
                }
                catch (ApplicationException ex)
        ...
        /// </summary>
        /// <param name="entity"></param>
        public void DelCargoReportCommentsByReportId(List<CargoReportCommentsEntity> entity, LogEntity log)
        {
            LogWrite<CargoReportCommentsEntity> lw = new LogWrite<CargoReportCommentsEntity>();
            //使用事务
            using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required))
            {
                try
                {
                    man.DelCargoReportCommentsByReportId(entity);
                    log.Memo = "删除我的日报批复 ";
                    foreach (var it in entity)
                    {
                        log.Memo += "批复ID：" + it.ID + " 日报ID：" + it.Report_id  + ",登陆名：" + it.LoginName + "姓名 :" + it.UserName;
                    }
                    lw.WriteLog(log);
                    scope.Complete();
                }
        ...
        {
            return man.QueryCargoFeedBack(pIndex, pNum, entity);
        }
        /// <summary>
        /// 新增客户回访
        /// </summary>
        /// <param name="entity"></param>
        public void AddCargoFeedBack(CargoFeedBackEntity entity, LogEntity log)
        {
            LogWrite<CargoFeedBackEntity> lw = new LogWrite<CargoFeedBackEntity>();
            try
            {
                man.AddCargoFeedBack(entity);

                log.Memo = "新增客户回访：门店名称：" + entity.CompanyName.ToString() + "，客户名：" + entity.Name.Trim() + "，所属仓库：" + entity.HouseName + ",回访人：" + entity.FeedBackName + ",回访结果:" + entity.FeedBackResult + ",结果类型:" + entity.ResultType + "，回访时间:" + entity.FeedBackTime.ToString("yyyy-MM-dd HH:mm:ss");
                lw.WriteLog(log);
            }
            catch (ApplicationException ex)
            {
