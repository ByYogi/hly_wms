...
namespace House.Entity.Cargo
{
    ...
    public class CargoRealFactoryPurchaseOrderEntity
    {
        ...
        /// 采购明细条数
        /// </summary>
        public int PurGoodsCount { get; set; }
        ...
        public DateTime ETATimeStart { get; set; }
        ...
        public string BHouseID { get; set; }
    ...
    public class CargoReserveParam
    {
        public List<string> ReserveOrderNo { get; set; }
        public bool isReserver { get; set; } = false;
    }
}