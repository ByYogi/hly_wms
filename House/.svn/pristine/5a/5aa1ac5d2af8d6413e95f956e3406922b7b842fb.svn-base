        ...
        $(document).ready(function () {
            $('#dg').datagrid({
                ...
                columns: [[
                    ...
                    {
                        title: '最小库存', field: 'MinStock', align: 'right', width: '100px'
                    },
                    {
                        title: '最大库存', field: 'MaxStock', align: 'right', width: '100px'
                    },
                    {
                        title: '安全库存', field: 'StockNum', align: 'right', width: '100px'
                    },
                    {
                        title: '在库库存', field: 'CurNum', align: 'right', width: '100px'
                    },
                    {
                        title: '销售数量', field: 'SaleNum', align: 'right', width: '100px'
                    },
                    {
                        title: '补货数量', field: 'LessNum', align: 'right', width: '100px'
                    },
            ...
            <div id="saPanel">
                <table>
                  ...
                  required:true,prompt:'点击右侧图标查询产品信息',iconWidth: 22,
                    ...
                    <tr>
                        <td style="text-align: right;">安全库存:
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right;">最小库存:
                        </td>
                        <td>
                            <input name="MinStock" class="easyui-numberbox" data-options="min:0,precision:0,required:true" style="width: 250px;" validtype="length[0,5]" />
                        </td>
                        <td style="text-align: right;">最大库存:
                        </td>
                        <td>
                            <input name="MaxStock" class="easyui-numberbox" data-options="min:0,precision:0,required:true" style="width: 250px;" validtype="length[0,5]" />
                        </td>
                    </tr>
                </table>
            </div>
