...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            columns.push({
                title: '仓库', field: 'HouseName', width: '100px', formatter: function (value) {
                    return "<span title='" + value + "'>" + value + "</span>";
                }
            });
            columns.push({
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dlg" class="easyui-dialog" style="width: 1000px; height: 590px; padding: 1px 1px"
...
<%--            <div id="dlg-buttonsImport">
    ...
    <script type="text/javascript">
        ...
        function Export() {
            ...
            $.ajax({
                url: 'productApi.aspx?method=QueryProductReserverShelvesForExport',
                data: { GoodsCode: GoodsCode, Specs: Specs, Model: Model, Figure: Figure, PID: PID, SID: SID, ProductName: ProductName, onShelves: onShelves },
