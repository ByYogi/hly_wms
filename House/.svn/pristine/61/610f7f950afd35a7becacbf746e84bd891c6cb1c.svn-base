        ...
        $(function () {
            ...
            $('#dgClientConverRate').datagrid({
                ...
                columns: [[
                    ...
                    { title: '联系人', field: 'Boss', width: '90px' },
                    { title: '联系电话', field: 'Cellphone', width: '90px' },
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 100%; height: 100%;" id="ChartBox">
        ...
        <div style="width: 100%; display: flex; align-items: center;">
            ...
            <div style="width: 25%;" id="pn22" class="easyui-panel" title="门店月浏览成交转化率" data-options="tools:'#tl01'">
                <table id="dgClientConverRate" class="easyui-datagrid">
                </table>
            </div>
            <div id="tl01">
                <a href="javascript:void(0)" class="icon-reload" onclick="QueryHCYC_ClientConverRate()" title="刷新"></a>
                        <a href="javascript:void(0)" class="icon-application_get" onclick="HCYC_ClientConverRateExport()" title="导出"></a>
            </div>
            <%-- <div style="width: 25%;">
                <table id="dgClientConverRate" class="easyui-datagrid">
                </table>
 ...
 <a href="#" class="easyui-linkbutton" iconcls="icon-cancel" onclick="javascript:$('#dlgFeedBack').dialog('close')">&nbsp;&nbsp;取&nbsp;消&nbsp;&nbsp;</a>
    ...
    <form runat="server" id="fm1">
        <asp:Button ID="btnClientConverRate" runat="server" Style="display: none;" Text="导出" OnClick="btnClientConverRate_Click" />
    ...
    <script type="text/javascript">
        ...
        function QueryHCYC_ClientConverRate() {
            //门店月销售转化率
            $.ajax({
                type: 'post',
                url: "reportApi_v2.aspx?method=QueryHCYC_ClientConverRate",
        ...
        //门店月浏览成交转化率 导出
        function HCYC_ClientConverRateExport() {
            ...
            $.ajax({
                ...
                success: function (dt) {
                    ...
                    var row = data.rows[0];
                    if (row == null) { $.messager.alert('<%= Cargo.Common.GetSystemNameAndVersion()%>', '没有数据可以进行导出，请重新查询！', 'warning'); return; }
                    var obj = document.getElementById("<%=btnClientConverRate.ClientID %>"); obj.click();
                }
            });
