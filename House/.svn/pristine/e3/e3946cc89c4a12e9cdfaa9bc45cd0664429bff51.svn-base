<%@ Page Language="C#" Title="销售备货明细" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SaleStockUpDetails.aspx.cs" Inherits="Supplier.Report.SaleStockUpDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#dg').datagrid({
                ...
                columns: [[
                    ...
                    { title: '销售数量', field: 'Piece', width: '80px', },
                    { title: '平均销售价格', field: 'AvgSalePrice', width: '100px', },
                    { title: '销售总额', field: 'ActSalePrice', width: '80px', },
                    { title: '销售价', field: 'SalePrice', width: '80px', },
                    { title: '库存', field: 'InHousePiece', width: '80px', },
                    { title: '库存金额', field: 'InHouseTotalPrice', width: '80px', },
                    { title: '最近成本价', field: 'CostPrice', width: '90px', },
                    { title: '最近入库时间', field: 'InHouseTime', width: '130px', formatter: DateTimeFormatter },
                ]],
        ...
        function dosearch() {
            ...
            gridOpts.url = 'reportApi.aspx?method=QueryOrderSaleStockUpDetailsInfo';
            $('#dg').datagrid('load', {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function exportData() {
            ...
            $.ajax({
                url: "reportApi.aspx?method=QueryOrderSaleStockUpDetailsInfoExport&SID=" + $("#ASID").combobox('getValue') + "&ProductCode=" + $("#AProductCode").val() + 
